...
namespace CargoFlash.SoftwareFactory.Data
{
    ...
    public sealed class SqlHelper
    {
        ...
        /// by a user defined name (probably the actual table name)
        /// </param>
        public static void FillDataset(SqlConnection connection, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames) { FillDataset(connection, commandType, commandText, dataSet, tableNames, null); }
        ...
        /// An array of SqlParamters used to execute the command
        /// </param>
        public static void FillDataset(SqlConnection connection, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters) { FillDataset(connection, null, commandType, commandText, dataSet, tableNames, commandParameters); }
        ...
        /// by a user defined name (probably the actual table name)
        /// </param>
        public static void FillDataset(SqlTransaction transaction, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames) { FillDataset(transaction, commandType, commandText, dataSet, tableNames, null); }
        ...
        /// An array of SqlParamters used to execute the command
        /// </param>
        public static void FillDataset(SqlTransaction transaction, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params SqlParameter[] commandParameters) { FillDataset(transaction.Connection, transaction, commandType, commandText, dataSet, tableNames, commandParameters); }
        ...
        /// </summary>
        /// <param name="tr"></param>
        public static void RollbackSqlTransaction(SqlTransaction tr)
        {
            if (tr.Connection!= null && tr.Connection.State == ConnectionState.Open)
            {
                tr.Rollback();
            }
        }
        ...
        public static void FillDataset(string p1, CommandType commandType, string p2, DataSet ds, string p3, SqlParameter[] Parameters)
        {
    ...
    {
        // Since this class provides only static methods, make the default constructor private to prevent 
        // instances from being created with "new CfiSqlHelperParameterCache()"
        ...
        /// </returns>
        public static SqlParameter[] GetSpParameterSet(string connectionString, string spName) { return GetSpParameterSet(connectionString, spName, false); }
        ...
        /// An array of SqlParameters
        /// </returns>
        public static SqlParameter[] GetSpParameterSet(SqlConnection connection, string spName) { return GetSpParameterSet(connection, spName, false); }
        ...
        private static SqlParameter[] GetSpParameterSetInternal(SqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            ...
            if (cachedParameters != null)
            {
                ...
                {
                    if (cachedParameters[i].SqlDbType == SqlDbType.Structured)
                    {
                        cachedParameters[i].TypeName = cachedParameters[i].TypeName.ToLower().Replace(connection.Database.ToLower() + ".", "");
                    }
                }
            }
            if (cachedParameters == null)
            {
                ...
                {
                    if (spParameters[i].SqlDbType == SqlDbType.Structured)
                    {
                        spParameters[i].TypeName = spParameters[i].TypeName.ToLower().Replace(connection.Database.ToLower() + ".", "");
                    }
                }
