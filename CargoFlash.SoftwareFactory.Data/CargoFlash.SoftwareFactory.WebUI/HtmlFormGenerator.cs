    ...
    public class HtmlFormGenerator : IDisposable
    {
        ...
        public StringBuilder InstantiateIn(string TargetModuleName = "", string TargetAppID = "", string TargetFormAction = "", bool ValidateOnSubmit = true, bool IsSubModule = false, int TotalParentCol = 1)
        {
            ...
            if (subprocessname != "")
            {
                ...
                foreach (DataRow dr in drProcessXMLPage)
                {
                    ...
                    {
                        if (this._FORM_ACTION == "SEARCH")
                            MyDivArea.Append("<table width='100%'><td class='formSection'>Search</td><tr></tr></table><table cfi-aria-search='search' id='" + tblId + "'>" + MakeSearchBody() + "</table>");
                        else
                        {
                            if (TotalParentCol == 1)
            ...
            if (bool.Parse(CurrentRow.Element("VISIBLE").Value.ToString()) == true)
            {
                ...
                if (CurrentRow.Element("DATA_FIELDNAME").Value.ToString().Length > 0)
                {
                    if (CurrentRow.Element("DATA_FIELDNAME").Value.ToString().StartsWith("##"))
                    {
                        ...
                        {
                            controlText = "<a href='javascript:void(0);' id='ahref_" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "' title='" + CurrentRow.Element("LABEL_CELL_TEXT").Value.ToString() + "'" + (IsTrans == true ? (" recname='Alt" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'") : "") + "><span class='" + this._DATA_FIELD_CSSCLASS + "'   id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  " + extraAttribute + " " + (IsTrans == true ? (" recname='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'") : "") + ">" + CurrentRow.Element("LABEL_CELL_TEXT").Value.ToString() + "</span></a>";
                        }
                        else
                        {
        ...
        private string CreateFileUploadControl(XElement CurrentRow, bool IsTrans = false, bool IsMultiControl = false)
        {
            ...
            if (bool.Parse(CurrentRow.Element("VISIBLE").Value.ToString()) == true)
            {
                ...
                {
                    if (false)
                        controlText = "<input type='file' class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " style='width:" + (CurrentRow.Element("WIDTH").Value.ToString() == "" ? "80" : CurrentRow.Element("WIDTH").Value.ToString()) + "px;' " + textAttribute + "  maxlength='" + CurrentRow.Element("MAXLENGTH").Value.ToString() + "'    value='" + CurrentPage.Request.Form[CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + (this.objIndex > 0 ? "_" + (this.objIndex - 1).ToString() : "")] + "' />";
                    else
                        controlText = "<input type='file' class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " style='width:" + (CurrentRow.Element("WIDTH").Value.ToString() == "" ? "80" : CurrentRow.Element("WIDTH").Value.ToString()) + "px;' " + textAttribute + "  maxlength='" + CurrentRow.Element("MAXLENGTH").Value.ToString() + "' value='" + GetBindFieldValue(CurrentRow.Element("DATA_FIELDNAME").Value.ToString()) + "' />";
                }
                else
        ...
        private string CreateDropDownControl(XElement CurrentRow, bool IsTrans = false, bool IsMultiControl = false)
        {
            ...
            if (bool.Parse(CurrentRow.Element("VISIBLE").Value.ToString()) == true)
            {
                ...
                {
                    if (false)
                        controlText = "<input type='text'" + tabIndex + " class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " value='" + CurrentPage.Request.Form[CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + (this.objIndex > 0 ? "_" + (this.objIndex - 1).ToString() : "")] + "' />";
                    else
                        controlText = "<input type='text'" + tabIndex + "  class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " value='" + GetBindFieldValue(CurrentRow.Element("DATA_FIELDNAME").Value.ToString()) + "' />";
                }
                else
        ...
        private string CreateButttonControl(XElement CurrentRow, bool IsMultiControl = false, string btnCss = "")
        {
            ...
            if (bool.Parse(CurrentRow.Element("VISIBLE").Value.ToString()) == true)
            {
                ...
                if (CurrentRow.Element("DATA_FIELDNAME").Value.ToString().Length > 0)
                {
                    ...
                    if (false)
                        controlText = "<input type='button'" + tabIndex + " class='" + (this._DATA_FIELD_CSSCLASS==string.Empty?CurrentRow.Element("ONCLICK_HANDLER").Value.ToString():this._DATA_FIELD_CSSCLASS) + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "' style='width:" + (CurrentRow.Element("WIDTH").Value.ToString() == "" ? "80" : CurrentRow.Element("WIDTH").Value.ToString()) + "px;' value='" + CurrentRow.Element("LABEL_CELL_TEXT").Value.ToString() + "'" + onclickevent + " " + disable + " />";
                    else
                        controlText = "<input type='button'" + tabIndex + "  class='" + (btnCss != "" ? btnCss : this._DATA_FIELD_CSSCLASS) + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "' style='width:" + (CurrentRow.Element("WIDTH").Value.ToString() == "" ? "80" : CurrentRow.Element("WIDTH").Value.ToString()) + "px;' value='" + CurrentRow.Element("LABEL_CELL_TEXT").Value.ToString() + "'" + onclickevent + " " + disable + " />";
                }
                else
                    controlText = "&nbsp;";
            }
                ...
                if (CurrentRow.Element("TEXT_TYPE").Value.ToString().Length > 0)
                {
                    ...
                    foreach (var Name in nameArr)
                    {
                        ...
                        if (false)
                        {
                            ...
                            if (false)
                                controlText = controlText + "<input type='radio'" + tabIndex + "  class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  checked='checked' id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " value='" + value.ToString() + "'" + (Name == nameArr[nameArr.Length - 1] ? textAttribute : "") + " " + onclickevent + "/>" + TheName.Replace("_", " ") + "";
                            else
                                controlText = controlText + "<input type='radio'" + tabIndex + "  class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " value='" + value.ToString() + "'" + (Name == nameArr[nameArr.Length - 1] ? textAttribute : "") + " " + onclickevent + "/>" + TheName.Replace("_", " ") + "";
                        }
                        else
                        {
                            if (false)
                                ...
                                controlText = controlText + " " + "<input type='radio'" + tabIndex + "  class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "' " + b + " id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " value='" + value.ToString() + "'" + (Name == nameArr[nameArr.Length - 1] ? textAttribute : "") + " " + onclickevent + "/>" + TheName.Replace("_", " ") + "";
        ...
        private string CreateRadioButtonControl(XElement CurrentRow, bool IsTrans = false, bool IsMultiControl = false)
        {
            ...
            if (bool.Parse(CurrentRow.Element("VISIBLE").Value.ToString()) == true)
            {
                ...
                {
                    if (false)
                        controlText = "<input type='radio'" + tabIndex + " class='" + this._DATA_FIELD_CSSCLASS + "' name='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'  id='" + CurrentRow.Element("HTML_CONTROL_ID").Value.ToString() + "'" + (IsTrans == true ? (" recname='" + CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + "'") : "") + " value='" + CurrentPage.Request.Form[CurrentRow.Element("DATA_FIELDNAME").Value.ToString() + (this.objIndex > 0 ? "_" + (this.objIndex - 1).ToString() : "")] + "' " + onclickevent + "  />";
                    else
