...
{
    public class DutyAreaManagementWebUI : BaseWebUISecureObject
    {
        public object GetRecordDutyArea()
        {
        ...
        public DutyAreaManagementWebUI(Page PageContext)
        {
            try
            {
        ...
        public DutyAreaManagementWebUI()
        {
            try
            {
                this.MyModuleID = "Roster";
        ...
        public StringBuilder BuildFormView(string DisplayMode, StringBuilder container)
        {
            try
            {
                using (HtmlFormAdapter htmlFormAdapter = new HtmlFormAdapter(MyModuleID))
                {
                    ...
                    htmlFormAdapter.HeadingColumnName = "AreaName";
                    switch (DisplayMode)
                    {
        ...
        private StringBuilder CreateGrid(StringBuilder Container)
        {
            try
            {
                ...
                {
                    g.CommandButtonNewText = "New Duty Area";
                    g.FormCaptionText = "Duty Area";
                    ...
                    g.Column.Add(new GridColumn { Field = "AreaName", Title = "Duty Area", DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "Text_TerminalSno", Title = "Terminal", DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "ColorName", Title = "Color Name", DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "Text_HashColorCodeSno", Title = "Hash Color Code", DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "Export", Title = "Type", DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "DutyAreaName", Title = "Duty Area Name", DataType = GridDataType.String.ToString() });
        ...
        public override void DoPostBack()
        {
            ...
            switch (OperationMode)
            {
                ...
                case DisplayModeUpdate:
                    ...
                    UpdateDutyArea(System.Web.HttpContext.Current.Request.QueryString["RecID"]);
                    if (string.IsNullOrEmpty(ErrorMessage))
        ...
        private void SaveDutyArea()
        {
            try
            {
                ...
                var DutyArea = new DutyArea
                {
                    ...
                    //IsActive=Convert.ToBoolean( FormElement["IsActive"]),
                    ...
                    IsExport = (FormElement["IsExport"] == "0") ? false : true,//not null
