...
{
    public class FlightOpenManagementWebUI : BaseWebUISecureObject
    {
        int SNo = 0;

        public FlightOpenManagementWebUI()
        {
            try
            {
                this.MyModuleID = "Schedule";
                this.MyAppID = "FlightOpen";
        ...
        public StringBuilder BuildFormView(string DisplayMode, StringBuilder container)
        {
            try
            {
                using (HtmlFormAdapter htmlFormAdapter = new HtmlFormAdapter(MyModuleID))
                {
                    ...
                    container.Append(@"<table class='WebFormTable'><tr><td class'formActiontitle' align='center'><input type='button' value='Open Flight' text='Generate' class='btn btn-success' onClick='FlightOpen()' id='btnGenerate'> </td></tr></table>" +
                    ...
                    "<div >&nbsp;&nbsp;</div><table id='tblFlightOpen'></table><div style=height:10px' /><div >&nbsp;&nbsp;</div><table id='tblFlightAlreadyOpen'></table><div style=height:50px' /><div style=height:20px' />" +
