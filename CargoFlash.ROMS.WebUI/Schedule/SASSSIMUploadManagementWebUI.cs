...
{
    public class SASSSIMUploadManagementWebUI : BaseWebUISecureObject
    {
        ...
        public SASSSIMUploadManagementWebUI(Page PageContext)
        {
            try
            {
        ...
        public SASSSIMUploadManagementWebUI()
        {
            try
            {
                this.MyModuleID = "Schedule";
                ...
                using (HtmlFormAdapter htmlFormAdapter = new HtmlFormAdapter(MyModuleID))
                {
                    ...
                    switch (DisplayMode)
                    {
                        ...
                        case DisplayModeNew:
                            ...
                            container.Append("<div id='Maindiv' style='overflow:auto; margin-top:10px; margin:bottom:10px; boorder:1px solid #4297d7; max-height:430px;'><table border='1' margin:0px; padding:0px; cellspacing='0' cellpadding='0'  class='appendGrid ui-widget' id='tblSSIMpreview'></table><br/></div>");
                            break;
//                            < input type = 'button' id =\"Submit\" class=\"btn btn-success\"  value='Submit'>
//< input type = 'button' id =\"Submit1\" class=\"btn btn-success\"  value='Submit'><span id=\"spnMsg\" style=\"Color:green;font-weight:bold\" ></span>
