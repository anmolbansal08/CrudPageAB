...
{
    public class EDIMasterWebUI : BaseWebUISecureObject
    {
        public EDIMasterWebUI()
        {
        ...
        public EDIMasterWebUI(Page PageContext)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public object GetRecordEDIMaster()
        {
            object city = null;
            ...
            try
            {
                ...
                if (!DisplayMode.ToLower().Contains("new"))
                {
                    ...
                    {
                        EDIMaster cityList = new EDIMaster();
                ...
                using (HtmlFormAdapter htmlFormAdapter = new HtmlFormAdapter(MyModuleID))
                {
                    ...
                    switch (DisplayMode)
                    {
                        case DisplayModeReadView:
                            ...
                            htmlFormAdapter.objFormData = GetRecordEDIMaster();
        ...
        private StringBuilder CreateGrid(StringBuilder Container)
        {
            ...
            try
            {
                using (Grid g = new Grid())
                {
                    ...
                    g.CommandButtonNewText = "New EDIMaster";
                    g.FormCaptionText = "EDIMaster";
                    ...
                    g.Column.Add(new GridColumn { Field = "Age", Title = "Age", DataType = GridDataType.String.ToString() });
            ...
            try
            {
                ...
                switch (OperationMode)
                {
                    ...
                    case DisplayModeUpdate:
                        UpdateEDIMaster(System.Web.HttpContext.Current.Request.QueryString["RecID"]);
                        if (string.IsNullOrEmpty(ErrorMessage))
        ...
        /// </summary>
        private void SaveEDIMaster()
        {
            try
            {
                List<EDIMaster> listEDIMaster = new List<EDIMaster>();
                var FormElement = System.Web.HttpContext.Current.Request.Form;
                var EDIMaster = new EDIMaster
                {
                ...
                listEDIMaster.Add(EDIMaster);
                object datalist = (object)listEDIMaster;
        ...
        private void UpdateEDIMaster(string RecordID)
        {
            try
            {
                List<EDIMaster> listCity = new List<EDIMaster>();
                var FormElement = System.Web.HttpContext.Current.Request.Form;
                var EDIMaster = new EDIMaster
                {
