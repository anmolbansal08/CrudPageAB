...
{
  public class CrudPageABManagementWebUI : BaseWebUISecureObject
    {
        public CrudPageABManagementWebUI()
        {

            try
            {
                this.MyModuleID = "Master";
                this.MyAppID = "CrudPageAB";
        ...
        private StringBuilder CreateGrid(StringBuilder Container)
        {
            try
            {
                ...
                {
                    g.CommandButtonNewText = "New CrudPageAB";
                    g.FormCaptionText = "CrudPageAB";
                ...
                using (HtmlFormAdapter htmlFormAdapter = new HtmlFormAdapter(MyModuleID))
                {
                    ...
                    switch (DisplayMode)
                    {
                        case DisplayModeNew:
                            ...
                            break;
                        case DisplayModeEdit:
                            htmlFormAdapter.objFormData = GetRecordCrudPageAB();
        ...
        public override void DoPostBack()
        {
            ...
            switch (OperationMode)
            {
                ...
                case DisplayModeUpdate:
                    UpdateCrudPageABDetail(System.Web.HttpContext.Current.Request.QueryString["RecID"]);
                    if (string.IsNullOrEmpty(ErrorMessage))
                        System.Web.HttpContext.Current.Response.Redirect(MyPageName + "?" + GetWebURLString("INDEXVIEW", false, 2001), false);
                    break;
                case DisplayModeDelete:
                    DeleteCrudPageAB(System.Web.HttpContext.Current.Request.QueryString["RecID"]);
                    if (string.IsNullOrEmpty(ErrorMessage))
        ...
        /// </summary>
        private void SaveCrudPageABDetail()
        {
            try
            {
                List<CrudPageAB> listCrudPageAB = new List<CrudPageAB>();
                var FormElement = System.Web.HttpContext.Current.Request.Form;
                var CrudPageAB = new CrudPageAB
                {
                ...
                listCrudPageAB.Add(CrudPageAB);
                object datalist = (object)listCrudPageAB;
        ...
        public object GetRecordCrudPageAB()
        {
            object CrudPageAB = null;
            try
            {
                if (!string.IsNullOrEmpty(HttpContext.Current.Request.QueryString["RecID"]))
                {
                    CrudPageAB CrudPageABList = new CrudPageAB();
                    object obj = (object)CrudPageABList;
                    //retrieve Entity from Database according to the record
                    IDictionary<string, string> qString = new Dictionary<string, string>();
                    qString.Add("UserSNo", ((Model.UserLogin)(HttpContext.Current.Session["UserDetail"])).UserSNo.ToString());
                    CrudPageAB = DataGetRecordService(HttpContext.Current.Request.QueryString["RecID"], obj, MyModuleID, "", "", qString);
        ...
        private void UpdateCrudPageABDetail(string RecordID)
        {
            try
            {
                List<CrudPageAB> listCrudPageAB = new List<CrudPageAB>();
        ...
        private void DeleteCrudPageAB(string RecordID)
        {
            try
            {
