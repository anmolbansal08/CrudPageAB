...
{
  public class RatePriorityMasterManagementWebUI : BaseWebUISecureObject
    {
        public RatePriorityMasterManagementWebUI()
        {
            try
            {
                this.MyModuleID = "Master";
                this.MyAppID = "RatePriorityMaster";
        ...
        public RatePriorityMasterManagementWebUI(Page PageContext)
        {
            try
            {
                this.MyModuleID = "Master";
