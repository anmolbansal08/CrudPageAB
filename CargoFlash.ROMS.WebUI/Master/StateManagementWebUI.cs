...
{
   public class StateManagementWebUI : BaseWebUISecureObject
    {
        public  StateManagementWebUI()
        {
        ...
        public StateManagementWebUI(Page PageContext)
        {
            try
            {
            ...
            try
            {
                ...
                if (!DisplayMode.ToLower().Contains("new"))
                {
                    if (!string.IsNullOrEmpty(System.Web.HttpContext.Current.Request.QueryString["RecID"]))
                    {
                        ...
                        object obj = (object)StateList;
                        IDictionary<string, string> qString = new Dictionary<string, string>();
                        qString.Add("UserSNo", ((Model.UserLogin)(HttpContext.Current.Session["UserDetail"])).UserSNo.ToString());
                        State = DataGetRecordService(System.Web.HttpContext.Current.Request.QueryString["RecID"], obj, MyModuleID, "", "", qString);
        ...
        public StringBuilder BuildFormView(string DisplayMode, StringBuilder container)
        {
            try
            {
                using (HtmlFormAdapter htmlFormAdapter = new HtmlFormAdapter(MyModuleID))
                {
                    ...
                    htmlFormAdapter.HeadingColumnName = "StateName";
                    switch (DisplayMode)
                    {
                        case DisplayModeReadView:
                            htmlFormAdapter.DisplayMode = DisplayModeType.ReadOnly;
                            htmlFormAdapter.objFormData = GetRecordState();
        ...
        /// <summary>
        /// Generate State web page from XML
        /// e.g from ~/HtmlForm/WebFormDefinitionState.xml
        /// </summary>
        /// <param name="container"></param>
        ...
        private StringBuilder CreateGrid(StringBuilder Container)
        {
            try
            {
                ...
                {
                    g.CommandButtonNewText = "New State";
                    g.FormCaptionText = "State";
                    ...
                    g.Column.Add(new GridColumn { Field = "StateCode", Title = "State Code", DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "StateName", Title = "State Name", DataType = GridDataType.String.ToString() });
            ...
            try
            {
                ...
                switch (OperationMode)
                {
                    ...
                    case DisplayModeUpdate:
                        UpdateState(System.Web.HttpContext.Current.Request.QueryString["RecID"]);
                        if (string.IsNullOrEmpty(ErrorMessage))
                    ...
                    case DisplayModeDelete:
                        DeleteState(System.Web.HttpContext.Current.Request.QueryString["RecID"]);
                        if (string.IsNullOrEmpty(ErrorMessage))
        ...
        /// <summary>
        /// Save State record into the database 
        ...
        private void SaveState()
        {
            try
            {
                ...
                var State = new State
                {
                    ...
                    StateCode = FormElement["StateCode"],
                    StateName = FormElement["StateName"],
                ...
                listState.Add(State);
                object datalist = (object)listState;
        ...
        /// <summary>
        /// Update State record into the database 
        ...
        private void UpdateState(string RecordID)
        {
            try
            {
                List<State> listState = new List<State>();
        ...
        private void DeleteState(string RecordID)
        {
            try
            {
