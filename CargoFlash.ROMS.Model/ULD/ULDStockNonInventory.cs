...
namespace CargoFlash.Cargo.Model.ULD
{
    ...
    /*
	*****************************************************************************
	Class Name:		ULDStockNonInventory  
	...
	*/
    #endregion
    [KnownType(typeof(ULDStockNonInventory))]
    public class ULDStockNonInventory
    {
       ...
       //public int ULDStockNonInventorySNo {get;set;}
    ...
    [KnownType(typeof(ULDStockNonInventoryGrid))]
    public class ULDStockNonInventoryGrid
    {
        public int SNo { get; set; }
        public string ULDType { get; set; }
        public string ULDNo { get; set; }
        ...
        public string IsScrape { get; set; }
