...
{
    [KnownType(typeof(ImportFWBGridData))]
    public class ImportFWBGridData
    {
    ...
    public class NotifyDetails
    {
        ...
        [Order(3)]
        public string NotifyCityCode { get; set; }
        [Order(4)]
        ...
        [Order(7)]
        public string NotifyPlace { get; set; }
        [Order(8)]
        public string NotifyPostalCode { get; set; }
        [Order(9)]
        ...
        [Order(12)]
        public string NotifyMobile2 { get; set; }
    }
    ...
    {
        [Order(1)]
        public string NominyName { get; set; }
        [Order(2)]
        public string NominyAddress { get; set; }
    ...
    [KnownType(typeof(GetFDimemsionsAndULDNew))]
    public class GetFDimemsionsAndULDNew
    {
    ...
    [KnownType(typeof(GetFDimemsionsAndULDRate))]
    public class GetFDimemsionsAndULDRate
    {
        public int SNo { get; set; }
        public int AWBSNo { get; set; }
        public string WeightCode { get; set; }
    ...
    [KnownType(typeof(GetFAWBOtherChargeData))]
    public class GetFAWBOtherChargeData
    {
        public int SNo { get; set; }
        public int AWBSNo { get; set; }
