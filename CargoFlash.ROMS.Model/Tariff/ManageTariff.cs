...
namespace CargoFlash.Cargo.Model.Tariff
{
    ...
    public class TariffSlab
    {
        ...
        public decimal MinimumSlab { get; set; }
    }
    [KnownType(typeof(RevenueSharingSlab))]
    public class RevenueSharingSlab
    {
        public int SNo { get; set; }
        public decimal RevenueSharing { get; set; }
        public string RevenueSharingCustomer { get; set; }
        public int HdnRevenueSharingCustomer { get; set; }
        public int isRevenueSharingAmount { get; set; }
