...
{
    [System.Runtime.Serialization.KnownType(typeof(SegregationReportRequestModel))]
    public class SegregationReportRequestModel
    {
    ...
    [System.Runtime.Serialization.KnownType(typeof(SegregationReport))]
    public class SegregationReport
    {
        ...
        public string MAWBCount { get; set; }      
