...
namespace CargoFlash.Cargo.Model.Inventory
{
	...
	*/
    #endregion
    [KnownType(typeof(InventoryStockList))]
    public class InventoryStockList
    {
       ...
       //public int UldStockSNo {get;set;}
        ...
        public string ConsumableEquipmentNo { get; set; }
        public string ConsumablesStockTransSno { get; set; }
        public string isCrt { get; set; }
    ...
    [KnownType(typeof(InventoryStockListGrid))]
    public class InventoryStockListGrid
    {
        public int SNo { get; set; }
        public string ULDType { get; set; }
        public string ULDNo { get; set; }
