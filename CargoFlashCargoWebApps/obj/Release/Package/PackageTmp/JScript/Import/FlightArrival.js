...
function BindSLIDimensionEvents() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoComplete("PackingTypeSNo", "PackingName", "IrregularityPacking", "SNo", "PackingName", ["PackingName"], null, "contains");
...
function BindULDLocation() {
    $.ajax({
        ...
        success: function (result) {
            ...
            //var DimUnit = dimuldData.Table1;
            //var uldArray = dimuldData.Table2;
            cfi.AutoComplete("Location", "LocationNo", "Warehouselocation", "SNo", "LocationNo", ["LocationNo"], null, "contains");
            //cfi.makeTrans("sli_slidimension", null, null, null, null, null, dimArray);
...
function BindFlightInfo() {
    cfi.AutoComplete("Origin", "AirportCode", "Airport", "SNo", "AirportName", ["AirportCode", "AirportName"], null, "contains");
...
function InstantiateSearchControl(cntrlId) {
    ...
    cfi.AutoComplete("SearchAirlineSNo", "AirlineCode,AirlineName", "VGetInventoryAirline", "SNo", "AirlineName", null, null, "contains");
