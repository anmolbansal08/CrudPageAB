...
function BindPaymentDetails() {
    ...
    function onLoad() {
        ...
        if (PageType == "READ") {
            cfi.AutoComplete("AWBSNo", "sno,awbno", "getallawbnoforlist", "sno", "awbno", ["awbno"], null, "contains");
            $("#__SpanHeader__").hide();
    ...
    function SaveReturntoShipper() {
        ...
        var Array = {
            ...
            TotalCharges: $("#Text_TotalCharges").val(),
        ...
        if (AWBSNo != "") {
            $.ajax({
                ...
                data: JSON.stringify({ SaveReturnShipment: ReturnList }),
                success: function (result) {
                    ...
                    if (result == 0) {
                        ...
                        ShowMessage('success', 'Success - Return to Shipment !', "Return to Shipment Save Successfully");
        ...
        if (PageType == "NEW") {
            ...
            if (AwbSno != "") {
                $.ajax({
                    ...
                    data: JSON.stringify({ AwbSno: AwbSno, UpdatedBy: userContext.UserSNo }),
                    success: function (result) {
                        ...
                        if (GetSucessResult != undefined) {
                            ...
                            if (GetSucessResult.Table0.length > 0) {
                                ...
                                $("span#Product").text(GetSucessResult.Table0[0].ProductName);
                                $("span#Agent").text(GetSucessResult.Table0[0].Name);
                                ...
                                $("span#NatureofGoods").text(GetSucessResult.Table0[0].CommodityDescription);
                                ...
                                if (GetSucessResult.Table1.length > 0) {
                                    ...
                                    tbl += " <tr>"
                                    tbl += "<td class='bc formlabel' >Board Point</td>"
                                    tbl += "<td class='bc formlabel' >Off Point</td>"
                                    tbl += "<td class='bc formlabel'>Flight Date</td>"
                                    tbl += "<td class='bc formlabel'>Flight No.</td>"
                    ...
                    success: function (result) {
                        ...
                        if (GetSucessResult != undefined) {
                            ...
                            if (GetSucessResult.Table0.length > 0) {
                                ...
                                $("#Text_CustomRefNo").val(GetSucessResult.Table0[0].CustomRefNo);
                                $("#Text_NOCRefNo").val(GetSucessResult.Table0[0].NOCRefNo);
                                $("#Text_Reason").val(GetSucessResult.Table0[0].Reason);
