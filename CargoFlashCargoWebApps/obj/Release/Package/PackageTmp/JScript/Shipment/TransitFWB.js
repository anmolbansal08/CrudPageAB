...
function MasterAcceptance() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#__divfwbsearch__ table:first").find("tr>td:first").text("Transit FWB");
...
function BindReservationSection() {
    ...
    $.ajax({
        url: "Services/Shipment/FWBService.svc/GetTransitAcceptanceInformation?AWBSNo=" + awbSNo, async: false, type: "get", dataType: "json", cache: false,
        contentType: "application/json; charset=utf-8",
        success: function (result) {
            ...
            $("div[id$='divareaTrans_shipment_tfwbshipmentitinerary']").find("[id='areaTrans_shipment_tfwbshipmentitinerary']").each(function () {
                ...
                $(this).find("input[id^='FlightNo']").each(function () {
                    cfi.AutoComplete($(this).attr("name"), "FlightNo", "v_DailyFlight_FWB", "SNO", "FlightNo", ["FlightNo"], null, "contains");
                });
