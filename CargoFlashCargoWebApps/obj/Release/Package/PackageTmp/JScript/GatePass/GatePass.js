...
function fn_SearchManifst(GPSNo) {
    ...
    var FlightSNo = $("#searchFlightNoNew").val() == "" ? "A~A" : $("#searchFlightNoNew").val();
...
function SaveGatePass(mode) {
    ...
    if (chkcount == 0) {
        ShowMessage('warning', 'Warning ', "Please select atleast one checkbox ", "bottom-right");
    }
...
function LoadGatePassControl()
{
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            //cfi.AutoComplete("SearchAirlineCarrierCode1", "CarrierCode,AirlineName", "airline", "CarrierCode", "AirlineName", ["CarrierCode", "AirlineName"], null, "contains");
            cfi.AutoComplete("searchFlightNo", "FlightNo", "vwFlightDetail", "FlightNo", "FlightNo", ["FlightNo"], null, "contains");
            cfi.AutoComplete("searchBoardingPoint", "AirportCode", "Airport", "SNo", "AirportCode", ["AirportCode", "AirportName"]);
            cfi.AutoComplete("searchEndPoint", "AirportCode", "Airport", "SNo", "AirportCode", ["AirportCode", "AirportName"]);
...
function GatepassSearch()
{
    ...
    var FromFlightDate = "2017-03-25";
    var ToFlightDate = $("#ToFlightDate").val();
    ...
    {
        cfi.ShowIndexView("divFlightDetails", "Services/GatePass/GatePassService.svc/GetFlightGridData/GATEPASS/Shipment/GatePass/" + BoardingPoint + "/" + EndPoint + "/" + FlightNo + "/" + SearchAirlineCarrierCode1 + "/" + FromFlightDate + "/" + ToFlightDate + "/" + userContext.AirportCode + "/" + FlightStatus, "Scripts/maketrans.js?" + Math.random());
    }
...
function GetManifestReportData(FlightSNo, Type, GatePassSNo) {
    ...
    (cur_hour < 12) ? time_t = "AN" : time_t = "PM";
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (msgCheck[0] == 1) {
                    ...
                    Tabl += '<td align="left" style="font: bold;padding-left: 5px;width: 25%;">ARR: </td></tr>'
                    Tabl += '<tr><td align="left" style="font: bold;padding-left: 5px;width: 25%;">PK-G: </td>';
                    Tabl += '<td align="left" style="font: bold;padding-left: 5px;width: 25%;">AIRLINE: ' + es.Table1[0].airlinename + '</td>';
                    Tabl += '<td align="left" style="font: bold;padding-left: 5px;width: 25%;">ETD: ' + es.Table0[0].ETD + '</td>';
                    Tabl += '<td align="left" style="font: bold;padding-left: 5px;width: 25%;">DATE: ' + currentDate() + '</td></tr>';
                    Tabl += '</tbody>';
                    //table 3
                    Tabl += '</table></td>';
                    Tabl += '</tr><tr align="center"><td colspan="2" class="grdTableHeader">No</td>';
                    Tabl += '<td colspan="2" class="grdTableHeader"> ULD Serial No</td><td colspan="2" class="grdTableHeader">Category</td>';
                    Tabl += '<td colspan="2" class="grdTableHeader">Destination</td><td colspan="2" class="grdTableHeader">Weight</td></tr>';
                    ...
                    Tabl += '<td colspan="3">WAREHOUSE TERMINAL</td><td colspan="3">OPERATER</td>';
                    ...
                    Tabl += '<tr align="right" style="height: 20px;"><td colspan="11">&nbsp;</td></tr>'
                    Tabl += '<tr align="right" class="grdTableRow" id="PrintTr"><td colspan="9"><input id="btnPrint" type="button" value="Print" class="no-print"></td></tr>';
                    Tabl += '</tbody>';
                    Tabl += '</table>'
                    $("#divContentDetail").show();
...
function FlightSearch()
{
    ...
    var FromFlightDate = "2017-03-25";//cfi.CfiDate("FromFlightDate") == "" ? cfi.CfiDate("ToFlightDate") : cfi.CfiDate("FromFlightDate");

    var ToFlightDate = "2017-03-25";//cfi.CfiDate("ToFlightDate") == "" ? "0" : cfi.CfiDate("ToFlightDate");


    var FlightStatus = "PRE";// $("#searchFlightStatus").val() == "" ? "" : $("#searchFlightStatus").val();
