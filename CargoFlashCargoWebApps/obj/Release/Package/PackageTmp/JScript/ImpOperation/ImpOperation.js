        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataTableobj.Table1.length > 0) {
                    ...
                    var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:50%;' >SHARJAH AVIATION SERVICES</td><td></td><td align=\"center\" style='width:50%;'><b>IMPORT PROCESS MONITORING <br/>" + prefix + " </b></td></tr><tr><td colspan='2' align='LEFT' nowarap>From " + Fdt + " To " + Tdt + "</td></tr></table> "
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataTableobj.Table0.length > 0) {
                    ...
                    var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:50%;' >SHARJAH AVIATION SERVICES</td><td></td><td align=\"center\" style='width:50%;'><b>IMPORT PROCESS MONITORING <br/>" + prefix + " </b></td></tr><tr><td colspan='2' align='LEFT' nowrap>From " + Fdt + " To " + Tdt + "</td></tr></table> "
