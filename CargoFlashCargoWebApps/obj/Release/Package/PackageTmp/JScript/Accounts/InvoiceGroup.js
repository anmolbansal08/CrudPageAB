...
$(document).ready(function () {
    cfi.ValidateForm();
    cfi.AutoComplete("AccountSNo", "Name", "vwInvoiceGroupAgents", "SNo", "Name", ["Name"], GetInvoiceDateOnSelect, "contains");
    ...
    $("input[name=Type]:radio").click(function () {
        if ($(this).attr("value") == "0") {
            ...
            var data = GetDataSource("AccountSNo", "vwInvoiceGroupAgents", "SNo", "Name", ["Name"], null);
            ...
            cfi.ResetAutoComplete("AccountSNo");
            var data = GetDataSource("AccountSNo", "vwInvoiceGroupAirline", "SNo", "AirlineName", ["CarrierCode", "AirlineName"], null);
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoComplete("ChargeSNo", "GroupCode,GroupName", "InvoiceGroup", "SNo", "GroupCode", ["GroupCode", "GroupName"], null, "contains", ",");
...
function BindAutoCompleteFor(elem, mainElem) {
    ...
    $(elem).find("input[id^='ChargeSNo']").each(function () {
        cfi.AutoComplete($(this).attr("name"), "GroupCode,GroupName", "InvoiceGroup", "SNo", "GroupCode", ["GroupCode", "GroupName"], null, "contains", ",");
    });
