...
$(function () {
    ...
    $('#tblIrregularityIncident').appendGrid({
        ...
        columns: [{ name: 'SNo', type: 'hidden' },
            // (pageType == "READ") ? "label" : 
       { name: 'SubCategoryCode', display: 'SubCategory Code', type: pageType == "NEW" || pageType == "DUPLICATE" || pageType == "EDIT" ? "text" : "label", ctrlCss: { width: '150px' }, ctrlAttr: { maxlength: 50, controltype: pageType == "NEW" || pageType == "DUPLICATE" || pageType == "EDIT" ? "text" : "" }, isRequired: false },
...
function GetSubCategoryData()
{
    ...
    $("#hdnFormData").val($('#tblIrregularityIncident').appendGrid('getStringJson'));
}