$(document).ready(function () {
    cfi.ValidateForm();
    cfi.AutoComplete("TeamSNo", "Name", "vwTeamID", "SNo", "Name", ["Name"], null, "contains");
    cfi.AutoComplete("DutyAreaSNo", "AreaName", "vwDutyArea", "SNo", "AreaName", ["AreaName"], null, "contains");
    ...
    if (getQueryStringValue("FormAction").toUpperCase() == "NEW") {
        ...
        $('#tbl' + ManageTeam).appendGrid({
            ...
            columns: [
                      ...
                      { name: 'ShiftSNo', display: 'Shift Name', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '200px' }, isRequired: false, tableName: 'vShift', textColumn: 'ShiftName', keyColumn: 'ShiftSNo', filterCriteria: "contains" }
