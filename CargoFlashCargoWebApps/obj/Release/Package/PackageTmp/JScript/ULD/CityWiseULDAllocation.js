$(document).ready(function () {
    ...
    cfi.AutoComplete("Airport", "AirportCode,AirportName", "vGetAirpotName", "SNo", "AirportCode", ["AirportCode", "AirportName"], BlankOfficeAndAirline, "contains");

    cfi.AutoComplete("Airline", "CarrierCode,AirlineName", "vGetAirline", "OfficeAirlineTransSNo", "AirlineCode", ["CarrierCode", "AirlineName"], BkankGrid, "contains");

    //if (getQueryStringValue("FormAction").toUpperCase() == "NEW") {
    // cfi.AutoComplete("Airport", "SNo,AirportCode", "vGetAirpotName", "SNo", "AirportCode", ["AirportName"], SetBasis, "contains");
    // cfi.AutoComplete("Airline", "OfficeAirlineTransSNo,AirlineCode", "vGetAirline", "OfficeAirlineTransSNo", "AirlineCode", ["AirlineName"], null, "contains");
    cfi.AutoComplete("Office", "SNo,Name", "vGetOffice", "SNo", "Name", ["Name"], BkankAirline, "contains");
    SelectULDAllocation();
        ...
        if (cfi.IsValidSubmitSection()) {
            ...
            if (cfi.IsValidSubmitSection()) {
                ...
                if (strData == "[]" || strData == false || strData == undefined) {
                    alert("ULD Allocation can not be blank");
                    return false;
                }
                else {
                    $("#hdnFormData").val(JSON.stringify(JSON.parse(strData)));
                    return true;
                }
            }
        }
    ...
    $('#tbl' + ULDAllocationTrans).appendGrid({
        ...
        columns: [
                 ...
                 //{ name: 'OfficeSNo', type: 'hidden', value: $('#hdnofficSNo').val() },
                 {
                     ...
                     }, isRequired: true, tableName: 'vGetUldName', textColumn: 'UldNameContainerType', keyColumn: 'ULDTypeSNo', filterCriteria: "contains"
                 },
                 ...
                 },
                 {
                   ...
                   {
                       name: 'AlertEmail', display: 'Alert Email', type: 'text', isRequired: true, ctrlAttr: { controltype: 'email', onblur: "return validateEmail(this.id);", controltype: pageType == "NEW" || pageType == "EDIT" ? "email" : "" }, ctrlCss: { width: '150px', height: '20px' }
                   },
        ],
        isPaging: true,
