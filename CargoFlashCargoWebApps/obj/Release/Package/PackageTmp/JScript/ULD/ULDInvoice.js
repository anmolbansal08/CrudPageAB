...
function SaveULDInvoice() {
    ...
    $("input:checked[id^='tblULDGridDetails_Chkselect']").each(function (index, item) {
        ...
        ULDInvoice.push({
            ...
            AgreementNumber: $("#Text_AgreementNo").val(),
        });
    });
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result == 0) {
                ShowMessage('success', 'Success', "ULD Invoice Generated Successfully ", "bottom-right");
...
function onLoad() {
    ...
    if (PageType == "READ" || PageType == "EDIT") {
        ...
        $("#tblULDGridDetails").append("<tr id='tblULDGridDetails_total'><td class='ui-widget-content first' colspan='5'>TOTAL</td><td class='ui-widget-content' colspan='1'><label id='tblULDGridDetails_Meterial_total' style='width: 55px;'>" + metrialval.toString() + "</label></td><td class='ui-widget-content' colspan='1'><label id='tblULDGridDetails_ManHours_value' style='width: 55px;'>" + ManHours.toString() + "</label></td><td rowspan='2' class='ui-widget-content' colspan='1'><label id='tblULDGridDetails_Total_value' style='width: 55px;'>" + Total.toString() + "</label></td></tr>");
        ...
        cfi.AutoComplete("VendorSNo", "SNo,Name", "vGetVendorList", "SNo", "Name", null, null, "contains", null, null, null, null, OnSelectAirline);
        $("#__SpanHeader__").hide();
        $("#btnPrint").hide();
