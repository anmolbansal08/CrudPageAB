$(document).ready(function () {
    ...
    cfi.AutoComplete("ReturnFrom", "SNo,Name", "Account", "SNo", "Name", null, clearcontaint, "contains");
    cfi.AutoComplete("ReturnableItem", "Sno,Item", "VGetStockForReturn", "Sno", "Item", null, null, "contains", null, null, null, null, OnSelectReturnableItem);
    ...
    $("input[name=ReturnType]:radio").click(function () {
        ...
        if ($(this).attr("value") == "0") {
            ...
            var data = GetDataSource("ReturnFrom", "Account", "SNo", "Name", ["Name"], null);
            cfi.ChangeAutoCompleteDataSource("ReturnFrom", data, false,  clearcontaint, "Name");

         //   cfi.ChangeAutoCompleteDataSource("searchFlightNo", dataSource, false, ResetSearchByFlight, "FlightNo");
        }
        else {

            var data = GetDataSource("ReturnFrom", "Airline", "SNo", "AirlineName", ["AirlineName"], null);
        ///    cfi.ChangeAutoCompleteDataSource("ReturnFrom", data, true, null, "AirlineName",clearcontaint, "contains");
