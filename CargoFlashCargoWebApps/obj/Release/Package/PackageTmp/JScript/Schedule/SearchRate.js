$(document).ready(function () {
    ...
    cfi.AutoComplete("Airline", "airlinecode,airlinename", "Airline", "SNo", "airlinecode", ["airlinecode", "airlinename"], null, "contains");
    ...
    cfi.AutoComplete("Destination", "CityCode,CityName", "City", "SNo", "CityCode", ["CityCode", "CityName"], null, "contains");
    cfi.AutoComplete("Commodity", "CommodityCode", "Commodity", "sno", "CommodityCode", ["CommodityCode"], null, "contains");
    cfi.AutoComplete("flightname", "Flightno", "getflightNo", "sno", "Flightno", ["Flightno"], null, "contains");
    ...
    var RateSource = [{ Key: "1", Text: "Publish" }, { Key: "2", Text: "Promo" }, { Key: "3", Text: "Agent" }];
