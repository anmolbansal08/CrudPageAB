$(document).ready(function () {
    ...
    cfi.AutoComplete("AirlineCode", "AirlineCode", "TaxRate_vwAirline", "SNo", "AirlineCode@", ["AirlineCode", "AirlineName"], null, "contains");
...
function FnGetOriginAC(input) {
    ...
    if (Origin == "CITY") {
        ...
        var dataSource = GetDataSource("OriginSNo", "Country", "SNo", "CountryCode@", ["CountryCode", "CountryName"])
...
function FnGetDestinationAC(input) {
    ...
    if (Destination == "CITY") {
        ...
        var dataSource = GetDataSource("DestinationSNo", "Country", "SNo", "CountryCode@", ["CountryCode", "CountryName"])
