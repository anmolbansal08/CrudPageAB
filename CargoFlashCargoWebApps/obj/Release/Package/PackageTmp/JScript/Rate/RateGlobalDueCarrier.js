    ...
    if (getQueryStringValue("FormAction").toUpperCase() == "NEW" || getQueryStringValue("FormAction").toUpperCase() == "DUPLICATE") {
        ...
        $('#tbl' + dbTableName).appendGrid({
            ...
            columns: [
                      ...
                      { name: 'DueCarrierSNo', display: 'Due Carrier Code', type: 'text', ctrlAttr: { maxlength: 90, controltype: 'autocomplete' }, ctrlCss: { width: '80px', height: '20px' }, isRequired: true, tableName: 'DueCarrier', textColumn: 'Code', keyColumn: 'SNo' },
                     {
                         name: 'CommoditySNo', display: 'Commodity Code', type: 'text', ctrlAttr: { maxlength: 5, controltype: 'autocomplete' }, ctrlCss: { width: '80px', height: '20px' }, isRequired: true, tableName: 'Commodity', textColumn: 'CommodityCode', keyColumn: 'SNo', addOnFunction: function (evt) {
                             setValue(evt);
                         }
                     },

                      {
                          name: 'SPHCSNo', display: 'SPHC Code', type: 'text', ctrlAttr: { maxlength: 49, controltype: 'autocomplete' }, ctrlCss: { width: '80px', height: '20px' }, isRequired: true, tableName: 'SPHC', textColumn: 'Code', keyColumn: 'SNo', addOnFunction: function (evt) {
                              setValue(evt);
                      }
                      },

                      { name: 'ProductSNo', display: 'Product Name', type: 'text', ctrlAttr: { maxlength: 49, controltype: 'autocomplete' }, ctrlCss: { width: '80px', height: '20px' }, isRequired: true, tableName: 'Product', textColumn: 'ProductName', keyColumn: 'SNo', addOnFunction: function (evt) { setValue(evt); } },

                      { name: 'CurrencySNo', display: 'Currency Code', type: 'text', ctrlAttr: { maxlength: 3, controltype: 'autocomplete' }, ctrlCss: { width: '80px', height: '20px' }, isRequired: true, tableName: 'Currency', textColumn: 'CurrencyCode', keyColumn: 'SNo' },
