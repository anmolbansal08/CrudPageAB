...
function addBlock(obj) {
    ...
    cfi.AutoComplete(String.Format('AirlineCode{0}', currentOriginDestination.toString()), 'AirlineName,AirlineCode', 'Airline', 'AirlineCode', 'AirlineCode', ['AirlineCode', 'AirlineName'], null, "contains");
    ...
    cfi.AutoComplete(String.Format('FlightNo{0}', currentOriginDestination.toString()), "FlightNo", "vDailyFlight", "FlightNo", "FlightNo",null,null,"contains",null,null,null,null,onFlightSelect);
...
function onPageLoad() {
    cfi.ValidateForm();
    cfi.AutoComplete('AirlineCode', 'AirlineName,AirlineCode', 'Airline', 'AirlineCode', 'AirlineCode', ['AirlineCode', 'AirlineName'], null, "contains");
    ...
    cfi.AutoComplete("FlightNo", "FlightNo", "vDailyFlight", "FlightNo", "FlightNo",null,null,"contains",null,null,null,null,onFlightSelect);
    if (getQueryStringValue("FormAction").toUpperCase() == "EDIT") {
