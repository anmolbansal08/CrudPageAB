    ...
    if (getQueryStringValue("FormAction").toUpperCase() == "NEW" || getQueryStringValue("FormAction").toUpperCase() == "DUPLICATE") {
        ...
        $('#tbl' + dbTableName).appendGrid({
            ...
            columns: [
                ...
                { name: 'CommoditySubGroupSNo', display: 'Commodity Sub Group', type: 'text', ctrlAttr: { maxlength: 100, controltype: 'autocomplete' }, ctrlCss: { width: '140px', height: '20px' }, tableName: 'CommoditySubGroup', textColumn: 'SubGroupName', keyColumn: 'SNo', filterCriteria: "contains" },
                { name: 'CommoditySNo', display: 'Commodity Code', type: 'text', ctrlAttr: { maxlength: 100, controltype: 'autocomplete' }, ctrlCss: { width: '140px', height: '20px' }, tableName: 'Commodity', textColumn: 'CommodityCode', keyColumn: 'SNo' },
