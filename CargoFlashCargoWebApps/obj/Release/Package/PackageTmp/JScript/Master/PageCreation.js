...
$(document).ready(function () {
    ...
    cfi.AutoComplete("ProcessSno", "SNo,ProcessName", "vwProcess", "SNo", "ProcessName", null, OnSelectProcess, "contains");
    ...
    if (getQueryStringValue("FormAction").toUpperCase() == 'EDIT' || getQueryStringValue("FormAction").toUpperCase() == 'READ') {
        ...
        cfi.AutoComplete("SubprocessSno", "SNo,SubProcessName", "vwSubProcess", "SNo", "SubProcessName", null, OnSelectSubProcessName, "contains");
        cfi.AutoComplete("SNo", "SNo,name", "GetAlltables", "SNo", "name", null, OnSelectFillGrid, "contains");
        ...
        $('#tblPageCreation').appendGrid({
            ...
            columns: [
                      { name: 'ColumnName', display: 'Column Name', type: 'text', ctrlCss: { width: '90px', height: '20px' }, onChange: function (evt, rowIndex) { }, isRequired: true },
                       ...
                       {
                           name: 'ASSEMBLY_NAME', display: 'ASSEMBLY_NAME', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '90px', height: '20px' }, onSelect: FillFields, isRequired: true, tableName: 'PageCreationWFControls', textColumn: 'Assembley_Name', keyColumn: 'Assembley_Name', filterCriteria: "contains"
                       },
                       ...
                       { name: 'DATA_CELL_CSSCLASS', display: 'DATA_CELL_CSSCLASS', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '90px', height: '20px' }, isRequired: false, tableName: 'PageCreationWFControls', textColumn: 'Data_Cell_Cssclass', keyColumn: 'Data_Cell_Cssclass', filterCriteria: "contains" },
