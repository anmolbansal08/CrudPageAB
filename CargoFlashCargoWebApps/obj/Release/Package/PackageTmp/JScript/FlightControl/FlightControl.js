    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#btnSearch").bind("click", function () {
                ...
                CleanUI();
                /*Remove locked process when user search*/
                cfi.SaveUpdateLockedProcess(0, CurrentFlightSno, "", "", userContext.UserSNo, subprocesssno, subprocess, "", "");
                FlightSearch();
            });
...
function BindEvents(input, e) {
    ...
    $('#btnMoveToLying,#tdCancelLI').hide();
    ...
    var FlightSNoIndex = trRow.find("th[data-field='GroupFlightSNo']").index();
    ...
    var msg = cfi.GetAWBLockedEvent(userContext.UserSNo, 0, CurrentFlightSno, "", "", "");
    if (msg == "Fail") { return false; };
    cfi.SaveUpdateLockedProcess(0, CurrentFlightSno, "", "", userContext.UserSNo, subprocesssno, subprocess, 3, "");
    /*End*/

    /*End*/


    if (CurrentValue == 'PER-MANIFEST') {
        $('#btn_OSI').hide();
        //$('#btnFlightClose').hide();
        $('#tdManRemarks,#tdATDDate,#tdManifestRemarks,#tdATDTime').hide();
        //$('#btn_Print').show();
        ShowIndexView("divDetail", "Services/FlightControl/FlightControlService.svc/GetFlightTransGridData/FLIGHTCONTROL/FlightControl/MANIFESTULD/" + $(input).closest('tr').find("td:eq(" + FlightSNoIndex + ")").text() + "/PRE" + "/" + subprocesssno);
        ...
        ShowIndexView("divDetail", "Services/FlightControl/FlightControlService.svc/GetFlightTransGridData/FLIGHTCONTROL/FlightControl/FLIGHTAWB/" + $(input).closest('tr').find("td:eq(" + FlightSNoIndex + ")").text() + "/LI" + "/" + subprocesssno);
        $("#SecondTab").unbind("click").bind("click", function () {
            if ($("#divLyingDetail table").length === 0) {
        ...
        if (($(input).closest('tr').find("td:eq(" + FlightStatusIndex + ")").text().toUpperCase() == 'DEP') || ($(input).closest('tr').find("td:eq(" + FlightStatusIndex + ")").text().toUpperCase() == 'CLSD')) {
            ...
            ShowMessage('warning', 'Warning', "Flight not Departed", "bottom-right");
        }
    }
        ...
        $('#tdManRemarks,#tdATDDate,#tdManifestRemarks,#tdATDTime,#tdNILManifest,#tdEDIMSG,#tdregnNo,#tdregnNoTxt,#tdFlightType,#btnSaveAndClose').hide()
        $('#btn_Print').show();
    ...
    IsButtonClick = false;
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //if (subprocess == "MANIFEST" && FlightCloseFlag == "PRE")
    //{
    //IsButtonClick = false;
    //var trHeaderRow;
    //var trContentRow;
...
//    var CurrentValue = $(input).val();
//    CurrentFlightSno = $(input).closest('tr').find("td:eq(" + FlightSNoIndex + ")").text();
//    ManageCTMStatus = CurrentValue == 'PRE' ? 'PREUPDATE' : CurrentValue;//Use for Hide and Show CTM Charges
//    if (CurrentValue == 'PRE') {
//        $('#btn_OSI').hide();
//        //$('#btnFlightClose').hide();
//        $('#tdManRemarks,#tdATDDate,#tdManifestRemarks,#tdATDTime').hide();
//        $('#btn_Print').show();
//        ShowIndexView("divDetail", "Services/FlightControl/FlightControlService.svc/GetFlightTransGridData/FLIGHTCONTROL/FlightControl/MANIFESTULD/" + $(input).closest('tr').find("td:eq(" + FlightSNoIndex + ")").text() + "/PRE");
...
//            $('#btnCBV').show();
//        $('#btnFlightClose').hide();
//        ShowIndexView("divDetail", "Services/FlightControl/FlightControlService.svc/GetFlightTransGridData/FLIGHTCONTROL/FlightControl/MANIFESTULD/" + $(input).closest('tr').find("td:eq(" + FlightSNoIndex + ")").text() + "/MAN");
...
//        $('#btn_Print').show();
//        // $('#spnRegistrationNo,#RegistrationNo').hide();
//        ShowIndexView("divDetail", "Services/FlightControl/FlightControlService.svc/GetFlightTransGridData/FLIGHTCONTROL/FlightControl/FLIGHTAWB/" + $(input).closest('tr').find("td:eq(" + FlightSNoIndex + ")").text() + "/LI");
//        $("#SecondTab").unbind("click").bind("click", function () {
//            if ($("#divLyingDetail table").length === 0) {
//                fn_GetLyingList('-1', GetFlightSortRoute(FlightDestination), 'SINGLE');
//            }
...
function SavePreManifestInfo() {
    ...
    $('#divDetail .k-grid-content tbody tr').each(function (row, tr) {
        ...
        cfi.SaveUpdateLockedProcess(0, CurrentFlightSno, "", "", userContext.UserSNo, subprocesssno, subprocess, "0", "");
...
function GetManifestReportData(FlightSNo, Type) {
    ...
    $(FlightSNoArray).each(function (r, i) {
        ...
        $.ajax({
            url: "Services/FlightControl/FlightControlService.svc/GetManifestReport?DailyFlightSNo=" + i + "&Type=" + Type, async: false, type: "get", dataType: "html", cache: false,
            contentType: "application/json; charset=utf-8",
            success: function (result) {
                $("#btnPrint").closest('tr').hide();
                $('#SecondTab').hide();
...
function GetStopOverFlightULDDetails() {
    ShowIndexView("divStopOverDetail", "Services/FlightControl/FlightControlService.svc/GetFlightTransGridData/FLIGHTCONTROL/FlightControl/STOPOVERFLIGHT/" + CurrentFlightSno + "/SOFLIGHT" + "/" + subprocesssno);
}
var OffloadDest;
...
function fn_liVersion(e) {
    ...
    if (flag == true) {
        ...
        for (var i = 1; i <= latestLiVer; i++) {
            $("#ulid").append($(document.createElement('li'))
                .append(
        ...
        cfi.PopUp("divLiVersionPop", "LI Version Details", 1300, null, null, 100);
    }
    else
...
function fun_PrintByProcess() {
    ...
    if (SaveProcessStatus == "LI") {
        GetLIReportData(CurrentFlightSno);
        $('#tblSearch').hide();
        //$('#rbBulk').hide();
        //$('#rbULD').hide();
        //$('#rbHSC').hide();
        ...
        GetReportData(CurrentFlightSno);
    }
        ...
        GetManifestReportData(CurrentFlightSno, 'N');
