        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataTableobj.Table0.length > 0) {
                    ...
                    str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan=" + cols + ">SHARJAH AVIATION SERVICES</td></tr><tr><td align=\"right\" colspan=" + cols + ">Date : " + dataTableobj.Table1[0].Dt + "</td></tr>"
