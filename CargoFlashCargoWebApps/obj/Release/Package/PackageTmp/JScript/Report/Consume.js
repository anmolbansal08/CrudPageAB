...
$(document).ready(function () {
    ...
    cfi.AutoComplete("CItem", "Item", "vwconsumeitem", "Item", "Item", ["Item"], null, "contains");
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.length > 0) {
                        ...
                        var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:30%;' >SHARJAH AVIATION SERVICES</td><td></td><td align=\"center\" style='width:50%;'>Consumable Utilization Report</td><td align=\"right\" style='width:20%;'>Date : " + response[0].Dt +
