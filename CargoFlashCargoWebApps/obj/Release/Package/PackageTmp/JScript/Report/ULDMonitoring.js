    ...
    if (dbTableName == 'FAULDLocation') {
        ...
        $('#tbl' + dbTableName).appendGrid({
            ...
            columns: [
               ...
               { name: 'Location', display: 'Location', type: 'text', ctrlAttr: { maxlength: 100, controltype: 'autocomplete' }, ctrlCss: { width: '140px', height: '20px' }, isRequired: true, tableName: 'vAssignLocation', textColumn: 'LocationName', keyColumn: 'SNo' },
    ...
    if (dbAwbTableName == 'AwbULDLocation') {
        ...
        $('#tbl' + dbAwbTableName).appendGrid({
            ...
            columns: [
               ...
               { name: 'AssignLocation', display: 'Assign Location', type: 'text', ctrlAttr: { maxlength: 100, controltype: 'autocomplete' }, ctrlCss: { width: '140px', height: '20px' }, isRequired: true, tableName: 'vAssignLocation', textColumn: 'LocationName', keyColumn: 'SNo' },
                {
