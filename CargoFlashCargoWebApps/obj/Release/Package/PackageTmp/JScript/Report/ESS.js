...
$(document).ready(function () {
    ...
    cfi.AutoComplete("Party", "PartyName", "vwinvoiceparty", "sno", "PartyName", ["PartyName"], null, "contains");
...
function SearchData() {
    if (cfi.IsValidSubmitSection()) {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {
                FromDate: FromDate, ToDate: ToDate, Type: type, Handling: handling,Reporting: reporting,Party:party
            },
            ...
            success: function (data) {
                ...
                if ($("#Type").val() != "3") {
                    if (dataTableobj.Table0.length > 1) {
                        ...
                        str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='10'>SHARJAH AVIATION SERVICES</td></tr><tr><td colspan='6' align='LEFT'>From " + $("#FromDate").val() + " To " + $("#ToDate").val() + "</td>  <td align=\"right\" colspan='4'>Date : " + dataTableobj.Table1[0].Dt + "</td></tr>"
