...
$(document).ready(function () {
    ...
    cfi.AutoComplete("Agent", "Name", "vwforwardagent", "sno", "Name", ["Name"], null, "contains");
            ...
            success: function (data) {
                ...
                if (dataTableobj.Table0 != undefined) {
                    if (dataTableobj.Table0.length > 0) {
                        ...
                        str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='12'>SHARJAH AVIATION SERVICES</td></tr><tr><td colspan='6' align='LEFT'>From " + FromDate + " To " + ToDate + "</td>  <td align=\"right\" colspan='8'>Date : " + dataTableobj.Table4[0].Dt + "</td></tr>"
            ...
            success: function (data) {
                ...
                if (dataTableobj.Table0 != undefined) {
                    if (dataTableobj.Table0.length > 0) {
                        ...
                        str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='10'>SHARJAH AVIATION SERVICES</td></tr><tr><td colspan='4' align='LEFT'>From " + FromDate + " To " + ToDate + "</td>  <td align=\"right\" colspan='6'>Date : " + dataTableobj.Table4[0].Dt + "</td></tr>"
