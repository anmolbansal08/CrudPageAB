$(function () {
    ...
    cfi.AutoComplete("AgentAirline", "Name,SNo", "Account", "SNo", "Name", ["Name"], null, "contains");
    cfi.AutoComplete("AWB", "AWBNo", "vwWorkOrderAWBNo", "SNo", "AWBNo", null, null, "contains");//AWB
    cfi.AutoComplete("ULD", "ULDNo", "vwWorkOrderULD", "SNo", "ULDNo", null, null, "contains"); // Vuldnameuld
    cfi.AutoComplete("SLI", "SLINo", "vwWorkOrderSLI", "SNo", "SLINo", null, null, "contains");//SLIAWB
    cfi.AutoComplete("FlightNo", "FlightNo", "vwLandsideWorkOrderFlightNo", "FlightNo", "FlightNo", null, null, "contains");//VDailyFlightNo
...
function PrintSlip(SNo) {
    window.open("HtmlFiles/Tariff/WorkOrderPrint.html?InvoiceSNo=" + SNo + "&UserSNo=" + userContext.UserSNo);
}
