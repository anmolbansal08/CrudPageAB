...
$(document).ready(function () {
    cfi.ValidateForm();
    cfi.AutoComplete("CityCode", "CityName,CityCode", "City", "CityCode", "CityName", ["CityCode", "CityName"], GetCityData, "contains");
    cfi.AutoComplete("GroupSNo", "GroupName", "Groups", "SNo", "GroupName", ["GroupName"], GetData, "contains");
    cfi.AutoComplete("CustomerSNo", "CustomerName", "Customer", "SNo", "CustomerName", ["CustomerName"], null, "contains");
