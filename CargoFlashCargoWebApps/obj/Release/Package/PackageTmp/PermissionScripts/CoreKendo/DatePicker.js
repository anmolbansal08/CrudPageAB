...
(function ($, undefined) {
    ...
    */
    init: function (element, options) {
        ...
        var date = parse((that.element.val() || options.value), "MM/dd/yyyy", options.culture);
        ...
        if (date != null) {
            ...
            if (that.element.val() == "" || date == null) {
                ...
                that.element.attr("actualValue", "");
                that.element.attr("formattedValue", "");
            }
            else {
                that.element.attr("actualValue", kendo.toString(date, "MM/dd/yyyy", options.culture));
