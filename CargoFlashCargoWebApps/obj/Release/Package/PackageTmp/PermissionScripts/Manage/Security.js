...
$(document).ready(function () {
    cfi.ValidateForm();
    //cfi.AutoComplete("AccessibleCitySNo", "CityName,CityCode", "vCityWithAll", "SNo", "CityName", ["CityCode", "CityName"], GetCityData, "contains", ",");


    //cfi.AutoComplete("WareHouseMasterSNo", "WarehouseName,AirportSNo", "WarehouseMaster", "SNo", "WarehouseName", ["WarehouseName"], null, "contains");
    cfi.AutoComplete("CitySNo", "CityCode,CityName", "City", "SNo", "CityName", ["CityCode", "CityName"], GetCityData, "contains");

    cfi.AutoComplete("AllowCitySNo", "CityName,CityCode", "City", "SNo", "CityName", ["CityCode", "CityName"], RemoveRequired, "contains", ",");

    //==================Comment By:pradeeep Sharma============================================
    //cfi.AutoComplete("AllowAirportSNo", "AirportName", "VWAirportWithWarehouse", "AirPortSNo", "AirportName",["AirportCode","AirportName"] ,null, "contains", ",");
    //cfi.AutoComplete("AllowWarehouseSNo", "WarehouseName", "WarehouseMaster", "SNo", "WarehouseName", ["WarehouseName"], null, "contains", ",");    
    //cfi.AutoComplete("MobileCountryCode", "MobileCountryCode", "Country", "MobileCountryCode", "MobileCountryCode", null, "contains");
    cfi.AutoComplete("MobileCountryCode", "MobileCountryCode", "Country", "MobileCountryCode", "MobileCountryCode", null, readOnlyfield, "contains");


    cfi.AutoComplete("WareHouseMasterSNo", "WarehouseName", "WarehouseMaster", "SNo", "WarehouseName", ["WarehouseName"], null, "contains");
    cfi.AutoComplete("AirportSNo", "AirportCode,AirportName", "Airport", "SNo", "AirportName", ["AirportCode", "AirportName"], ClearWarehouse, "contains");
    cfi.AutoComplete("LanguaugeSNo", "LanguaugeName", "Language", "SNo", "LanguaugeName", ["LanguaugeName"], null, "contains");
