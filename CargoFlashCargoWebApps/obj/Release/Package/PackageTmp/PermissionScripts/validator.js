    ...
    cfValidator = function (mainElement, overrideOptions, instanceName) {
        ...
        var options = {
            ...
            errorMessages: {
                en: {
                    ...
                    'minlength': 'Enter the length must be at least {0} characters',
                    'maxlength': 'Enter the length must be at max {0} characters',
                    'rangelength': 'Enter the length must be between {0} and {1}',
		...
		_getErrMsgPosition = function (input, tooltip) {
		    ...
		    var tooltipContainer = input.data("errMsg.bV" + instanceName),
		         top = -((tooltipContainer.offset().top - ($("#" + tempinputId).offset().top == 0 ? $("#" + inputId).offset().top : $("#" + tempinputId).offset().top)) + tooltip.outerHeight() - options.offset.y),
		         left = (($("#" + tempinputId).offset().left == 0 ? $("#" + inputId).offset().left : $("#" + tempinputId).offset().left) + width) - tooltipContainer.offset().left + options.offset.x,
		...
		validator = {
		    ...
		    minlength: function (v, minlength) {
		        return (v.value.split(" ").join("").length >= parseInt(minlength))
		    },
