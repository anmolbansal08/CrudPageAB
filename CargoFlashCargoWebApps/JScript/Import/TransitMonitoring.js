...
function InstantiateSearchControl(cntrlId) {
    ...
    cfi.AutoCompleteV2("SearchAirlineCarrierCode", "CarrierCode,AirlineName", "TransitMonitoring_Airline", null, "contains");
    cfi.AutoCompleteV2("SearchBoardingPoint", "AirportCode,AirportName", "TransitMonitoring_Airport", null, "contains");
    cfi.AutoCompleteV2("searchFlightNo", "FlightNo", "TransitMonitoring_FlightNo", null, "contains");
        ...
        success: function (result) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    cfi.AutoCompleteV2("BillToSNo", "Name", "TransitMonitoring_BillTo", null, "contains");
        ...
        success: function (result) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    cfi.AutoCompleteV2("TerminateBillToSNo", "Name", "TransitMonitoring_BillTo", null, "contains");
