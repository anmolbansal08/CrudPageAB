...
function MasterFWBImport() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoCompleteV2("searchAirline", "AirlineCode,AirlineName", "FWBImport_Airline", null, "contains");
            cfi.AutoCompleteV2("searchFlightNo", "FlightNo", "FWBImport_searchFlightNo", null, "contains");
            cfi.AutoCompleteV2("searchAWBNo", "AWBNo", "FWBImport_searchAWBNo", null, "contains");
...
function BindCustomerInfo() {
    ...
    cfi.AutoCompleteV2("SHIPPER_AccountNo", "CustomerNo", "FWBImport_SHIPPER_AccountNo", GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("SHIPPER_CountryCode", "CountryCode,CountryName", "FWBImport_SHIPPER_CountryCode", null, "contains");
    cfi.AutoCompleteV2("SHIPPER_City", "CityCode,CityName", "FWBImport_SHIPPER_City", null, "contains");

    cfi.AutoCompleteV2("CONSIGNEE_AccountNo", "CustomerNo", "FWBImport_CONSIGNEE_AccountNo", GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("CONSIGNEE_CountryCode", "CountryCode,CountryName", "FWBImport_CONSIGNEE_CountryCode", null, "contains");
    cfi.AutoCompleteV2("CONSIGNEE_City", "CityCode,CityName", "FWBImport_CONSIGNEE_City", null, "contains");

    cfi.AutoCompleteV2("Notify_CountryCode", "CountryCode,CountryName", "FWBImport_Notify_CountryCode", null, "contains");
    cfi.AutoCompleteV2("Notify_City", "CityCode,CityName", "FWBImport_Notify_City", null, "contains");
...
function BindReservationSection() {
    ...
    cfi.AutoCompleteV2("Product", "ProductName", "FWBImport_Product", null, "contains");
    cfi.AutoCompleteV2("Commodity", "CommodityDescription", "FWBImport_Commodity", null, "contains");
    cfi.AutoCompleteV2("ShipmentOrigin", "AirportCode", "FWBImport_ShipmentOrigin", null, "contains");
    cfi.AutoCompleteV2("ShipmentDestination", "AirportCode", "FWBImport_ShipmentDestination", null, "contains");

    cfi.AutoCompleteV2("IssuingAgent", "AgentName", "FWBImport_IssuingAgent", null, "contains");
    cfi.AutoCompleteV2("SpecialHandlingCode", "CODE", "FWBImport_SpecialHandlingCode", null, "contains", ",");
    cfi.AutoCompleteV2("buptype", "Description", "FWBImport_buptype", null, "contains");
    cfi.AutoCompleteV2("densitygroup", "GroupName", "FWBImport_densitygroup", null, "contains");
    cfi.AutoCompleteV2("SubGroupCommodity", "SubGroupName", "FWBImport_SubGroupCommodity", null, "contains");
        ...
        success: function (result) {
            ...
            $("div[id$='areaTrans_shipment_shipmentclasssphc']").find("[id='areaTrans_shipment_shipmentclasssphc']").each(function () {
                $(this).find("input[id^='SPHC']").each(function () {
                    cfi.AutoCompleteV2($(this).attr("name"), "CODE", "FWBImport_SPHC", null, "contains");
                });
                $(this).find("input[id^='Class']").each(function () {
                    cfi.AutoCompleteV2($(this).attr("name"), "ClassName", "FWBImport_Class", null, "contains");
                });
            });
            ...
            $("div[id$='divareaTrans_import_fwbimportshipmentitinerary']").find("[id='areaTrans_import_fwbimportshipmentitinerary']").each(function () {
                ...
                $(this).find("input[id^='BoardPoint']").each(function () {
                    cfi.AutoCompleteV2($(this).attr("name"), "AirportCode", "FWBImport_BoardPoint", null, "contains");
                });
                $(this).find("input[id^='offPoint']").each(function () {
                    cfi.AutoCompleteV2($(this).attr("name"), "AirportCode", "FWBImport_offPoint", null, "contains");
                });
                $(this).find("input[id^='FlightNo']").each(function () {
                    cfi.AutoCompleteV2($(this).attr("name"), "FlightNo", "FWBImport_FlightNo", null, "contains");
                });
            });
...
function ReBindItenAutoComplete(elem, mainElem) {
    $(elem).closest("div[id$='divareaTrans_import_fwbimportshipmentitinerary']").find("[id^='areaTrans_import_fwbimportshipmentitinerary']").each(function () {
        $(this).find("input[id^='BoardPoint']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_fwbitinerary_BoardPoint");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
        $(this).find("input[id^='offPoint']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_fwbitinerary_offPoint");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
        $(this).find("input[id^='FlightNo']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_fwbitinerary_FlightNo");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
    });
}
...
function ReBindSPHCTransAutoComplete(elem, mainElem) {
    $(elem).closest("div[id$='areaTrans_shipment_shipmentclasssphc']").find("[id^='areaTrans_shipment_shipmentclasssphc']").each(function () {
        $(this).find("input[id^='SpecialHandlingCode']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_SPHCTransy_SpecialHandlingCode");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
        $(this).find("input[id^='Class']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_SPHCTransy_Class");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
    });
}
...
function BindAWBRate() {
    ...
    cfi.AutoCompleteV2("AWBCurrency", "CurrencyCode", "FWBImport_AWBCurrency", null, "contains");
    cfi.AutoCompleteV2("Currency", "CurrencyCode", "FWBImport_Currency", null, "contains");
    cfi.AutoCompleteV2("ChargeCode", "AWBChargeCode", "FWBImport_AWBChargeCode", null, "contains");
    ...
    cfi.AutoCompleteV2("CDCCurrencyCode", "CurrencyCode", "FWBImport_CDCCurrencyCode", null, "contains");
    cfi.AutoCompleteV2("CDCDestCurrencyCode", "CurrencyCode", "FWBImport_CDCDestCurrencyCode", null, "contains");
...
function BindDimensionEventsNew() {
    ...
    $("#tbl" + dbtableName).appendGrid({
        ...
        columns: [{ name: 'SNo', type: 'hidden', value: 0 },
                 ...
                 {
                     name: "RateClassCode", display: "Rate Class", type: "text", ctrlAttr: { maxlength: 80, controltype: "autocomplete" }, ctrlCss: { width: "90px" }, isRequired: true, AutoCompleteName: 'FWBImport_RateClassCode', filterField: 'RateClassCode'
                 },
                 {
...
function BindDimensionEventsNewULD() {
    ...
    $("#tbl" + dbtableName).appendGrid({
        ...
        columns: [{ name: 'SNo', type: 'hidden', value: 0 },
                 ...
                 {
                     name: "ULD", display: "ULD Type", type: "text", ctrlAttr: { maxlength: 80, controltype: "autocomplete" }, ctrlCss: { width: "50px" }, isRequired: true, AutoCompleteName: 'FWBImport_ULD', filterField: 'ULDName'
                 },
                {
               ...
               {
                   name: "Country", display: "Country", type: "text", ctrlAttr: { maxlength: 80, controltype: "autocomplete" }, ctrlCss: { width: "100px" }, isRequired: false, AutoCompleteName: 'FWBImport_Country', filterField: 'CountryCode'
               },
                  {
                      name: 'NatureOfGoods', display: 'Nature Of Goods', type: 'text', ctrlCss: { width: '150px', height: '20px' }, ctrlAttr: { Controltype: 'text', maxlength: 15 }, isRequired: true
                  }
...
function BindAWBOtherCharge() {
    ...
    $("#tbl" + dbtableName).appendGrid({
        ...
        columns: [{ name: 'SNo', type: 'hidden', value: 0 },
                 ...
                 {
                     name: "OtherCharge", display: "Charge Code", type: "text", ctrlAttr: { maxlength: 80, controltype: "autocomplete" }, ctrlCss: { width: "90px" }, isRequired: true, AutoCompleteName: 'FWBImport_OtherCharge', filterField: 'OtherChargeCode'
                 },
                 {
...
function BindCustomerInfo() {
    ...
    cfi.AutoCompleteV2("SHIPPER_AccountNo", "CustomerNo", "FWBImport_Cus_SHIPPER_AccountNo", GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("SHIPPER_CountryCode", "CountryCode,CountryName", "FWBImport_Cus_SHIPPER_CountryCode", null, "contains");
    cfi.AutoCompleteV2("SHIPPER_City", "CityCode,CityName", "FWBImport_Cus_SHIPPER_City", null, "contains");

    cfi.AutoCompleteV2("CONSIGNEE_AccountNo", "CustomerNo", "FWBImport_Cus_CONSIGNEE_AccountNo", GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("CONSIGNEE_CountryCode", "CountryCode,CountryName", "FWBImport_Cus_CONSIGNEE_CountryCode", null, "contains");
    cfi.AutoCompleteV2("CONSIGNEE_City", "CityCode,CityName", "FWBImport_Cus_CONSIGNEE_City", null, "contains");

    cfi.AutoCompleteV2("Notify_CountryCode", "CountryCode,CountryName", "FWBImport_Cus_Notify_CountryCode", null, "contains");
    cfi.AutoCompleteV2("Notify_City", "CityCode,CityName", "FWBImport_Cus_Notify_City", null, "contains");
...
function BindCountryCodeAutoComplete(elem, mainElem) {
    $(elem).find("input[id^='CountryCode']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "CountryCode,CountryName", "FWBImport_Country", null, "contains");
    });
    $(elem).find("input[id^='InfoType']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "InformationCode,Description", "FWBImport_InfoType", null, "contains");
    });
    $(elem).find("input[id^='CSControlInfoIdentifire']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "CustomsCode,Description", "FWBImport_CSControlInfoIdentifire", null, "contains");
    });
}
function ReBindCountryCodeAutoComplete(elem, mainElem) {
    $(elem).closest("div[id$='divareaTrans_import_fwbimportshipmentocitrans']").find("[id^='areaTrans_import_fwbimportshipmentocitrans']").each(function () {
        $(this).find("input[id^='CountryCode']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_fwbimportshipment_CountryCode");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
        $(this).find("input[id^='InfoType']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_fwbimportshipment_InfoType");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
        $(this).find("input[id^='CSControlInfoIdentifire']").each(function () {
            var newDataSource = GetDataSourceV2("Text_" + $(this).attr("id"), "DeliveryOrder_fwbimportshipment_CSControlInfoIdentifire");
            cfi.ChangeAutoCompleteDataSource($(this).attr("name"), newDataSource, false);
        });
    });
}
...
function BindHandlingInfoDetails() {
    cfi.AutoCompleteV2("CountryCode", "CountryCode,CountryName", "FWBImport_CountryCode", null, "contains");
    cfi.AutoCompleteV2("InfoType", "InformationCode,Description", "FWBImport_InfoType", null, "contains");
    cfi.AutoCompleteV2("CSControlInfoIdentifire", "CustomsCode,Description", "FWBImport_CustOCI", null, "contains");
...
function BindAWBSummary(isdblclick) {
    cfi.AutoCompleteV2("OPIAirportCity", "AirportCode", "FWBImport_AirportCode", null, "contains");
    cfi.AutoCompleteV2("OPIOfficeDesignator", "Code", "FWBImport_OfficeFunctionDesignator", null, "contains");
    cfi.AutoCompleteV2("OPIOtherAirportCity", "AirportCode", "FWBImport_OPIOtherAirportCity", null, "contains");

    cfi.AutoCompleteV2("REFAirportCityCode", "AirportCode", "FWBImport_REFAirportCityCode", null, "contains");
    cfi.AutoCompleteV2("REFOfficeDesignator", "Code", "FWBImport_REFOfficeDesignator", null, "contains");
    cfi.AutoCompleteV2("REFOthAirportCityCode", "AirportCode", "FWBImport_REFOthAirportCityCode", null, "contains");

    cfi.AutoCompleteV2("ISUPlace", "CityCode", "FWBImport_ISUPlace", null, "contains");
...
function BindDimensionChildGrid(tableid) {
    ...
    $("#" + dbtableName).appendGrid({
        ...
        columns: [{ name: 'SNo', type: 'hidden', value: 0 },
                 { name: 'AWBSNo', type: 'hidden', value: $('#hdnAWBSNo').val() },
                 {
                     name: "MeasurementUnitCode", display: "Mes. Unit", type: "text", ctrlAttr: { maxlength: 80, controltype: "autocomplete", onSelect: "return CalculateVol(this);" }, ctrlCss: { width: "100px" }, isRequired: true, AutoCompleteName: 'FWBImport_MeasurementUnitCode', filterField: 'UnitCode'
                 },
                 {
...

                {
                ...
                },
                  {
                     ...
                     {
                         name: "VolumeUnit", display: "Vol. Unit", type: "text", ctrlAttr: { maxlength: 80, controltype: "autocomplete" }, ctrlCss: { width: "100px" }, isRequired: true, AutoCompleteName: 'FWBImport_VolumeUnit', filterField: 'VolumeCode'
                     },
