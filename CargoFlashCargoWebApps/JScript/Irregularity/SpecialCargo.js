...
function LoadSpecialCargoDetails()
{
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoCompleteV2("SpecialCargoType", "SpecialCargoType", "SpecialCargo_SpecialCargoType", onchange, "contains");
            cfi.AutoCompleteV2("SpecialCargoNo", "SpecialCargoNo", "SpecialCargo_SpecialCargoNo", null, "contains");
