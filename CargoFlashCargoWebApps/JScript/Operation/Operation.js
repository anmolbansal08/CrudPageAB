        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataTableobj.Table0.length > 0) {
                    ...
                    var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:50%;' >Garuda Indonesia</td><td></td><td align=\"center\" style='width:50%;'><b>EXPORT PROCESS MONITORING <br/>" + prefix + " </b></td></tr><tr><td  align='LEFT' colspan='2' nowrap>From " + Fdt + " To " + Tdt + "</td></tr></table> "
