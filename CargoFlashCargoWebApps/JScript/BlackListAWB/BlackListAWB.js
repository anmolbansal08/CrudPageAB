...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("AirlineSNo", "CarrierCode,AirlineName", "BlacklistAWB_AirlineCode", null, "contains");
    cfi.AutoCompleteV2("CitySNo", "CityCode,CityName", "BlacklistAWB_City", null, "contains");
    cfi.AutoCompleteV2("OfficeSNo", "SNo,Name", "BlacklistAWB_Office", null, "contains");
    cfi.AutoCompleteV2("AgentSNo", "Name", "BlacklistAWB_Agents", null, "contains");
    cfi.AutoCompleteV2("AWbNo", "AWBNo", "BlacklistAWB_AwbNoForBlacklist", null, "contains");
...
function UpdateBlackListAwbNo() {
    ...
    if (arrayOfValues.length > 0) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (GetSucessResult == 0) {
                    ...
                    $('#Text_AWbNo').val('')
                    $("#BlackListTbl").remove();
                    ShowMessage('success', 'Success - Blacklist AWB !', "AWB Blacklist Successfully !");
        ...
        ShowMessage('warning', 'Warning - Blacklist AWB', "Kindly select at-least one Air Waybill");
    }
}
