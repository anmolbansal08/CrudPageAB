...
function AirMailList() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoCompleteV2("searchOrigin", "CityCode,CityName", "AirMail_ShipmentOrigin",  null, "contains");
            cfi.AutoCompleteV2("searchDestination", "CityCode,CityName", "AirMail_ShipmentOrigin",  null, "contains");
...
function ParentSuccessGrid()
{
    ...
    $("#divDetail").find("input[type='text'][" + attrType + "='" + autoCompleteType + "']").each(function () {
        var controlId = $(this).attr("id");
        cfi.AutoCompleteV2(controlId.replace("Text_", ""), "UldStockSNo", "AirMail_UldStockSNo",  null, "contains");
    });
