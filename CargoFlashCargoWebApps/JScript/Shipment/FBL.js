...
function LoadFBLDetails() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoCompleteV2("searchOriginCity", "CityCode,CityName", "FBL_Origin", null, "contains");
            cfi.AutoCompleteV2("searchDestinationCity", "CityCode,CityName", "FBL_Origin", null, "contains");
            cfi.AutoCompleteV2("searchFlightNo", "FlightNo", "FBL_FlightNo", null, "contains");
            cfi.AutoCompleteV2("searchAWBPrefix", "AWBPrefix", "FBL_AWBPrefix", null, "contains");
            cfi.AutoCompleteV2("searchAWBNo", "AWBNumber", "FBL_AWBNumber", null, "contains");
...
function FBR() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoCompleteV2("searchFlightNo1", "FlightNo,SNo", "FBL_Flightno_Search", null, "contains");
            cfi.AutoCompleteV2("AirlineName1", "AirlineName,SNo", "FBL_Airline", null, "contains");
