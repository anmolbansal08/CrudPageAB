...
function MasterAcceptance() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoCompleteV2("searchOriginCity", "CityCode,CityName", "HouseIndex_City", null, "contains");
            cfi.AutoCompleteV2("searchDestinationCity", "CityCode,CityName", "HouseIndex_City", null, "contains");
            cfi.AutoCompleteV2("searchFlightNo", "HAWBNo", "HouseIndex_FlightNo", null, "contains");
            cfi.AutoCompleteV2("searchAWBPrefix", "AWBPrefix", "HouseIndex_AWBPrefix", null, "contains");
            cfi.AutoCompleteV2("searchAWBNo", "AWBNumber", "HouseIndex_AWBNumber", null, "contains");
...
function BindHandlingInfoDetails() {
    ...
    cfi.AutoCompleteV2("CountryCode", "CountryCode,CountryName", "HouseIndex_Country", null, "contains");
    cfi.AutoCompleteV2("InfoType", "InformationCode,Description", "HouseIndex_InfoType", null, "contains");
    cfi.AutoCompleteV2("CSControlInfoIdentifire", "CustomsCode,Description", "HouseIndex_CustomsOCI", null, "contains");
...
function BindCountryCodeAutoComplete(elem, mainElem) {
    $(elem).find("input[id^='CountryCode']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "CountryCode,CountryName", "HouseIndex_Country", null, "contains");
    });
    $(elem).find("input[id^='InfoType']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "InformationCode,Description", "HouseIndex_InfoType", null, "contains");
    });
    $(elem).find("input[id^='CSControlInfoIdentifire']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "CustomsCode,Description", "HouseIndex_CustomsOCI", null, "contains");
    });
}
...
function BindHandlingAutoComplete(elem, mainElem) {
    $(elem).find("input[id^='Type']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "MessageType", "HouseIndex_MessageType", null, "contains");
    });
}
...
function BindCustomerInfo() {
    cfi.AutoCompleteV2("SHIPPER_AccountNo", "CustomerNo", "HouseIndex_CustomerNo"], GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("SHIPPER_Name", "Name", "HouseIndex_CustomerName", GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("SHIPPER_CountryCode", "CountryCode,CountryName", "HouseIndex_Country", null, "contains");
    cfi.AutoCompleteV2("SHIPPER_City", "CityCode,CityName", "HouseIndex_City", null, "contains");

    cfi.AutoCompleteV2("CONSIGNEE_AccountNo", "CustomerNo", "HouseIndex_CustomerNo", GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("CONSIGNEE_AccountNoName", "Name", "HouseIndex_CustomerName", GetShipperConsigneeDetails, "contains");
    cfi.AutoCompleteV2("CONSIGNEE_CountryCode", "CountryCode,CountryName", "HouseIndex_Country", null, "contains");
    cfi.AutoCompleteV2("CONSIGNEE_City", "CityCode,CityName", "HouseIndex_City", null, "contains");
...
function BindBankAutoComplete(elem, mainElem) {
    $(elem).find("input[id^='BankName']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "BankName", "HouseIndex_BankName", null, "contains");
    });
}
...
function BindReservationSection() {
    ...
    cfi.AutoCompleteV2("Commodity", "CommodityDescription", "HouseIndex_Commodity", null, "contains");
    cfi.AutoCompleteV2("ShipmentOrigin", "AirportCode", "HouseIndex_Airport", null, "contains");
    cfi.AutoCompleteV2("ShipmentDestination", "AirportCode", "HouseIndex_Airport", null, "contains");
    cfi.AutoCompleteV2("IssuingAgent", "AgentName", "HouseIndex_IssuingAgent", null, "contains");
    cfi.AutoCompleteV2("SpecialHandlingCode", "CODE", "HouseIndex_SPHC", null, "contains");
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if ($("#Text_AWBNo").data("kendoAutoComplete") == undefined || $("#Text_AWBNo").data("kendoAutoComplete").value() == "") {
                ...
                cfi.AutoCompleteV2("AWBNo", "AWBNo", "HouseIndex_AWBNo", null, "contains");
            }
            else {
            ...
            $("div[id$='areaTrans_house_houseclasssphc']").find("[id='areaTrans_house_houseclasssphc']").each(function () {
                $(this).find("input[id^='SPHC']").each(function () {
                    ...
                    cfi.AutoCompleteV2($(this).attr("name"), "CODE", "HouseIndex_SPHC", null, "contains");
                });
                $(this).find("input[id^='Class']").each(function () {
                    cfi.AutoCompleteV2($(this).attr("name"), "ClassName", "HouseIndex_SPHCClass", null, "contains");
                });
            });
...
function BindItenAutoComplete(elem, mainElem) {
    $(elem).find("input[id^='BoardPoint']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "CityCode", "HouseIndex_City", null, "contains");
    });
    $(elem).find("input[id^='offPoint']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "CityCode", "HouseIndex_City", null, "contains");
    });
    $(elem).find("input[id^='FlightNo']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "FlightNo", "HouseIndex_DailyFlight", null, "contains");
    });
}
...
function BindSPHCAutoComplete(elem, mainElem) {
    $(elem).find("input[id^='SpecialHandlingCode']").each(function () {
        cfi.AutoCompleteV2($(this).attr("name"), "CODE", "SpecialHandlingCode", "CODE", "CODE", ["CODE", "Detail"], null, "contains");
    });
