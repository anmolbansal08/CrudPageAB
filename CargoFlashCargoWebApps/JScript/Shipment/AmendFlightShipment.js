...
function BindAppendGrid1() {
    ...
    $('#tbl' + dbTableName).appendGrid({
        ...
        columns: [
            ...
            { name: 'FlightNo', display: 'Flight No', type: 'label', ctrlCss: { width: '80px' }, isRequired: false }, //, height: '21px', color: 'white', 'background-color': 'cornflowerblue' 
    ...
    if (!validateTableData('tblFlightOpen', uRows)) {
        ...
        $('#' + id).closest('tr').each(function () {
            var Array = {
                ...
                FlightNo: $(this).find('[id^="tblFlightOpen_FlightNo_"]').text(), //$(this).find('[id^="tblFlightOpen_FlightNo_"]').val(),
