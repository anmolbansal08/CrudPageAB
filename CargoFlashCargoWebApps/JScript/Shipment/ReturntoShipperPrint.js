                ...
                success: function (result) {
                    ...
                    if (GetSucessResult != undefined) {
                        ...
                        if (GetSucessResult.Table0.length > 0) {
                            ...
                            $("span#spnAWBNo").text(GetSucessResult.Table0[0].AWBNo);
                            ...
                            $("#TotalPieces").text(GetSucessResult.Table0[0].TotalPieces);
                            $("#spnVolWt").text(GetSucessResult.Table0[0].FOHVolumeWeight);
                            $("#imgAirline").attr({ "src": "/BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + GetSucessResult.Table0[0].AirlineImage, height: "57px", width: "220px" });
                            ...
                            $("#Spncreatedby").text(GetSucessResult.Table0[0].CreatedBy);
                            $("#SpnCreateddate").text(GetSucessResult.Table0[0].CreatedAt);
                            $("#spnHouseNo").text(GetSucessResult.Table0[0].HawbNO);
...
function PrintDiv(data, bac) {
    ...
    var divToPrint = document.getElementById('ReturnShipmentContent');
