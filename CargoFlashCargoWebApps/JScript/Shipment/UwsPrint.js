...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("FlightSNo", "FlightNo", "UWSPrint_FlightNo", null, "contains");
...
function GetUWSprintData(FlightNo, FlightDate, UserSNo) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (FinalData[0].Result == "1") {
                ShowMessage('warning', 'Need your Kind Attention!', 'Flight UWS does not match with Flight plan');
                $('#divhtml').html('');
                return false;
            }}
            ...
            if ((FinalData != undefined) && (TableData != undefined) && TableData.length > 0) {
                ...
                for (var i = 0; i < AllNextRoute; i++) {
                    ...
                    if (OffPointList.length > 0) {
                        html = html + "<tr style='border:1px solid black;'><td colspan='18' style='padding: 7px; font-size: 12px; font-weight: bold; text-align: center'>[ DESTINATION : " + OffPoint + " ]</td></tr>";
                    }
                    ...
                    for (var k = 0; k < OffPointList.length; k++) {
                        ...
                        html = html + "<tr style='border:1px solid black;'><td style='width:5%;'>" + OffPointList[k].EquipmentNumber + "</td><td style='width:5%;'>" + OffPointList[k].ULDNo + "</td><td style='width:3%;'>" + OffPointList[k].Pieces + "</td><td style='width:3%;'>" + OffPointList[k].GrossWt + "</td><td style='width:3%;'>" + OffPointList[k].NetWeight + "</td><td style='width:10%;' colspan='2'>" + OffPointList[k].SHC.substring(0, OffPointList[k].SHC.length - 1) + "</td><td style='width:5%;'>" + "</td><td style='width:5%; padding:7px;'> <input type='text' id='pry" + totalrows + "' value='" + OffPointList[k].Priority + "' name='" + OffPointList[k].Priority + "' required='required' controltype='number' maxlength='2' data-role='numerictextbox' class='k-formatted-value k-input' style='width:100%; font-size:10px;'>" + "</input></td><td style='width:15%; padding:7px;' colspan='2'>" + "<input type='text' id='remark" + totalrows + "' value='" + OffPointList[k].Remarks + "' maxlength='50' class='k-formatted-value k-input' style='width:100%; font-size:10px;'><input type='hidden' id='IsBulk" + totalrows + "' value='" + OffPointList[k].IsBulk + "' maxlength='50' style='width:100%; font-size:10px;'></td><td style='width:5%;'>" + ULDContourCode + "</td><td style='width:5%;'>" + OverhangDirection + "</td><td style='width:5%;'>" + OverhangWidth + "</td><td style='width:5%;'>" + OverhangMesUnit + "</td><td style='width:5%;'>" + Overhangtype + "</td><td style='width:15%;'>" + OverhangOtherInfo + "</td><td></td></tr>" + tr;
                    ...
                    if (OffPointList.length > 0) {
                        html = html + "<tr style='background-color: #cccccc; border: 1px solid black;'><td style='padding: 5%; padding: 7px; font-weight: bold;' colspan='3'>Total</td><td style='width:5%; padding:7px;  font-weight:bold;'><span  id='spnTGwt'>" + Tgwt + "</span></td> <td style='width:5%; padding:7px; font-weight:bold;'><span id='spnTNwt'>" + Tnwt + "</span></td><td style='width:5%; padding:7px;' colspan='2'>&nbsp;</td> <td style='width:5%; padding:7px;'>&nbsp;</td> <td style='width:5%; padding:7px;'>&nbsp;</td> <td style='width:5%; padding:7px;' colspan='7'>&nbsp;</td> <td></td> <td></td></tr>"
                    }
...
function SavePrintFun() {
    ...
    $('#SI1').after('<span id="spnSI1">' + $('#SI1').val() + '</span>');
    $('#SI2').after('<span id="spnSI2">' + $('#SI2').val() + '</span>');
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == 0) {
                ...
                var Flight = $("#spnFlight").html().split('/')[1]; // change by parvez khan,correct date format
