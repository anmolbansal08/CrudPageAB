$(document).ready(function () {
    ...
    cfi.ValidateForm();
    cfi.AutoCompleteV2("DepartmentSNo", "Name", "Roster_DepartmentName", null, "contains");
    cfi.AutoCompleteV2("AirlineSNo", "CarrierCode,AirlineName", "Roster_AirlineName", null, "contains");
    cfi.AutoCompleteV2("DesignationSNo", "Name", "Roster_DesignationMasterName", null, "contains");
    cfi.AutoCompleteV2("TeamIDSNo", "Name", "Roster_TeamIDName",  null, "contains");
    cfi.AutoCompleteV2("SkillSNo", "Name", "Roster_SkillMasterName", null, "contains", ",");
    cfi.BindMultiValue("SkillSNo", $("#Text_SkillSNo").val(), $("#SkillSNo").val());

    cfi.AutoCompleteV2("EmployeeTypeSNo", "EmployeeType", "Roster_EmployeeType", null, "contains");
