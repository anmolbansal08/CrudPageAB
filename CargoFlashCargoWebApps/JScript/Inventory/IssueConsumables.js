$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("IssuedTo", "SNo,Name", "Inventory_IssuedTo", null, "contains");
    cfi.AutoCompleteV2("IssuableItem", "Sno,Item", "Inventory_IssuableItem",  null, "contains", null, null, null, null, OnSelectIssuableItem);
    ...
    $("input[name=IssueType]:radio").click(function () {
        ...
        if ($(this).attr("value") == "0") {
            ...
            var data = GetDataSourceV2("IssuedTo", "IssueConsumables_IssuedTo", null);
            ...
            var data = GetDataSourceV2("IssuedTo", "IssueConsumables_IssuedTo2", null);
