$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("ConsumableItem", "ConsumableItem", "InventoryStock_ConsumableItem", OnchangeConsumableItems, "contains");
    cfi.AutoCompleteV2("City", "CityCode,CityName", "InventoryStock_City", OnchangeCity, "contains");
    cfi.AutoCompleteV2("Airport", "AirportCode,AirportName", "InventoryStock_Airport", onchangeAirport, "contains");
    cfi.AutoCompleteV2("Office", "OfficeName", "InventoryStock_Office", onchangeOffice, "contains");
    cfi.AutoCompleteV2("OwnerName", "SNo,Name", "InventoryStock_OwnerName", onchangeOwner, "contains");
        ...
        success: function (result) {
            ...
            if (myData.Table0.length > 0) {
                ...
                if (myData.Table0[0].Numbered == 'True') {
                    ...
                    //$('#ConsumableItem').val(myData.Table0[0].Sno + "-" + myData.Table0[0].Numbered);Riyaz
