...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("UserSNo", "UserName", "IndividualSalesReport_UserName", null, null);
    cfi.AutoCompleteV2("POSNameSNo", "AccountCode,Name", "IndividualSalesReport_AccountCode", null, null);
    ...
    $("#grid").kendoGrid({
        ...
        dataSource: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "../IndividualSalesReport/IndividualSalesReportGetRecord",
                    dataType: "json",
                    global: false,
                    type: 'POST',
                    ...
                    data: function GetReportData() {
                        ...
                        UserSNo = $('#UserSNo').val() == undefined ? "0" : $('#UserSNo').val() == "" ? "0" : $('#UserSNo').val();
                        PaymentStatus = $('#PaymentStatus').val()
                        return { AirlineSNo: AirlineSNo, OriginSNo: OriginSNo, DestinationSNo: DestinationSNo, FromDate: FromDate, ToDate: ToDate, Type: Type, AccountSNo: AccountSNo, UserSNo: UserSNo, PaymentStatus: PaymentStatus };
                    }
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        ...
                        TotalValuationCharges: { type: "string" },
                        TotalOtherCharges: { type: "string" },
                        TotalNet: { type: "string" },
                        AWBRefundFee: { type: "string" },
                        RecieptNo: { type: "string" },
                        TypeofPayment: { type: "string" },
                        Amount: { type: "string" },
                        DetailsBank: { type: "string" },
                        DetailsCardType: { type: "string" },
                        DetailsCardNo: { type: "string" },
        ...
        columns: [
            ...
            { field: "DocNo", title: "Doc No", width: 90 },
            { field: "POSName", title: "POS Name", width: 90 },
            { field: "MOP", title: "MOP", width: 70 },
            { field: "Org", title: "Org", width: 70 },
            { field: "Dest", title: "Dest", width: 70 },
            { field: "GrossWt", title: "Gross Wt", width: 70 },
            { field: "ChWt", title: "ChWt", width: 70 },
            { field: "Curr", title: "Curr", width: 70 },
            { field: "FrtCharges", title: "Frt Charges", width: 70 },
            { field: "TotalValuationCharges", title: "Total Valuation Charges", width: 130 },
            { field: "TotalOtherCharges", title: "Total Other Charges", width: 130 },
            { field: "TotalNet", title: "Total Net", width: 90 },
            { field: "AWBRefundFee", title: "AWB Refund Fee", width: 90 },
            { field: "RecieptNo", title: "Reciept No", width: 90 },
            { field: "TypeofPayment", title: "Type of Payment", width: 90 },
            { field: "Amount", title: "Amount", width: 90 },
              {
                  headerTemplate: "<div style='text-align: center;color: blue;font-weight: bold'>Details</div>",
                  columns: [
                     { field: "DetailsBank", headerTemplate: "<span style='color: blue;font-weight: bold'>Bank</span>", width: 70 },
                     { field: "DetailsCardType", headerTemplate: "<span style='color: blue;font-weight: bold'>Card Type</span>", width: 70 },
                     { field: "DetailsCardNo", headerTemplate: "<span style='color: blue;font-weight: bold'>Card No</span>", width: 70 },
                  ]
              },
            ...
            { field: "Remarks", title: "Remarks", width: 90 },
               { field: "PaymentStatus", title: "PaymentStatus", width: 90 },
    ...
    $("#gridSummary").kendoGrid({
        ...
        dataSource: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "../IndividualSalesReport/IndividualSalesReportGetRecordForSummary",
                    dataType: "json",
                    global: false,
                    type: 'POST',
                    contentType: "application/json; charset=utf-8",
                    data: function GetReportData() {
                        ...
                        return { AirlineSNo: AirlineSNo, OriginSNo: OriginSNo, DestinationSNo: DestinationSNo, FromDate: FromDate, ToDate: ToDate, Type: Type, AccountSNo: AccountSNo, UserSNo: UserSNo };
                    }
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        Curr: { type: "string" },
                        TotalFreightAmount: { type: "string" },
                        TotalValuationCharges: { type: "string" },
                        TotalOtherCharges: { type: "string" },
        ...
        columns: [
            ...
            { field: "TotalFreightAmount", title: "Total Freight Amount" },
            { field: "TotalValuationCharges", title: "Total Valuation Charges" },
...
var UserSNo = "";
var PaymentStatus = "";
function SearchIndividualSalesReport() {
    ...
    Type = $('input[type="radio"][name=Filter]:checked').val();
    $("#BlackListTbl").remove();
    if (AirlineSNo != "" && $('#OriginSNo').val() != "" && $("#FromDate").val() != "" && $("#ToDate").val() != "") {
...
function ExtraCondition(textId) {
    ...
    if (textId == "Text_AirlineSNo") {
        ...
        if ($('#UserSNo').val() != "" && $('#UserSNo').val() != undefined && $('#UserSNo').val() != "0") {
            cfi.setFilter(filterAirline, "CreatedBy", "eq", $('#UserSNo').val());
        }
        if ($('#OriginSNo').val() != "" && $('#OriginSNo').val() != undefined && $('#OriginSNo').val() != "0") {
            cfi.setFilter(filterAirline, "CitySNo", "eq", $('#OriginSNo').val());
        }
...
function ExportToExcel_IndividualSalesReport() {
    debugger
    AirlineSNo = $('#AirlineSNo').val();
    OriginSNo = $('#OriginSNo').val();
    FromDate = $("#FromDate").val();
...
function GetExcel() {
    ...
    if (AirlineSNo != "" && $('#OriginSNo').val() != "" && $("#FromDate").val() != "" && $("#ToDate").val() != "") {
        $.ajax({
            url: '../IndividualSalesReport/ExportToExcel',
            async: false,
            type: "GET",
            dataType: "json",
            data: {
                AirlineSNo: AirlineSNo, OriginSNo: OriginSNo, DestinationSNo: DestinationSNo, FromDate: FromDate, ToDate: ToDate, Type: Type, AccountSNo: AccountSNo, UserSNo: UserSNo, PaymentStatus: PaymentStatus
            },
            ...
            success: function (result) {
                ...
                "<th role='columnheader' data-field='DocNo' rowspan='2' data-title='Doc No' data-index='1'  data-role='columnsorter'>Doc No</th>" +
                "<th role='columnheader' data-field='MOP' rowspan='2' data-title='MOP' data-index='2'  data-role='columnsorter'>MOP</th>" +
                "<th role='columnheader' data-field='Org' rowspan='2' data-title='Org' data-index='3' data-role='columnsorter'>Org</th>" +
                "<th role='columnheader' data-field='Dest' rowspan='2' data-title='Dest' data-index='4'  data-role='columnsorter'>Dest</th>" +
                "<th role='columnheader' data-field='GrossWt' rowspan='2' data-title='Gross Wt' data-index='5'  data-role='columnsorter'>Gross Wt</th>" +
                "<th role='columnheader' data-field='ChWt' rowspan='2' data-title='ChWt' data-index='6'  data-role='columnsorter'>ChWt</th>" +
                "<th role='columnheader' data-field='Curr' rowspan='2' data-title='Curr' data-index='7'  data-role='columnsorter'>Curr</th>" +
                "<th role='columnheader' data-field='FrtCharges' rowspan='2' data-title='Frt Charges' data-index='8'  data-role='columnsorter'>Frt Charges</th>" +
                "<th role='columnheader' data-field='TotalValuationCharges' rowspan='2' data-title='Total Valuation Charges' data-index='9'  data-role='columnsorter'>Total Valuation Charges</th>" +
                "<th role='columnheader' data-field='TotalOtherCharges' rowspan='2' data-title='Total Other Charges' data-index='10'  data-role='columnsorter'>Total Other Charges</th>" +
                "<th role='columnheader' data-field='TotalNet' rowspan='2' data-title='Total Net' data-index='11'  data-role='columnsorter'>Total Net</th>" +
                "<th role='columnheader' data-field='AWBRefundFee' rowspan='2' data-title='AWB Refund Fee' data-index='12'  data-role='columnsorter'>AWB Refund Fee</th>" +
                "<th role='columnheader' data-field='RecieptNo' rowspan='2' data-title='Reciept No' data-index='13'  data-role='columnsorter'>Reciept No</th>" +
                "<th role='columnheader' data-field='TypeofPayment' rowspan='2' data-title='Type of Payment' data-index='14'  data-role='columnsorter'>Type of Payment</th>" +
                "<th role='columnheader' data-field='Amount' rowspan='2' data-title='Amount' data-index='15'  data-role='columnsorter'>Amount</th>" +
                "<th role='columnheader' colspan='3' data-colspan='3' ><div style='text-align: center;color: blue;font-weight: bold'>Details</div></th>" +
                "<th role='columnheader' data-field='Remarks' rowspan='2' data-title='Remarks' data-index='19'  data-role='columnsorter'>Remarks</th>"+
                "<th role='columnheader' data-field='IssueDate' rowspan='2' data-title='IssueDate' data-index='20'  data-role='columnsorter'>IssueDate</th>" +
                "<th role='columnheader' data-field='PaymentDate' rowspan='2' data-title='PaymentDate' data-index='21'  data-role='columnsorter'>PaymentDate</th>" +
                "<th role='columnheader' data-field='PaymentStatus' rowspan='2' data-title='PaymentStatus' data-index='22'  data-role='columnsorter'>PaymentStatus</th>" +
                  "<th role='columnheader' data-field='Tax' rowspan='2' data-title='Tax' data-index='23'  data-role='columnsorter'>PaymentStatus</th>" +
                "<th role='columnheader' data-field='POSName' rowspan='2' data-title='POSName' data-index='24'  data-role='columnsorter'>POSName</th>" +
                "<th role='columnheader' data-field='UserId' rowspan='2' data-title='UserId' data-index='25'  data-role='columnsorter'>UserId</th></tr>" +
                "<tr role='row' style='background-color: #daecf4'>" +
                "<th role='columnheader' data-field='DetailsBank' data-index='16' class='k-header k-first' data-role='columnsorter'>" +
                "<span style='color: blue;font-weight: bold'>Bank</span></th>" +
                "<th role='columnheader' data-field='DetailsCardType' data-index='17'  data-role='columnsorter'><span style='color: blue;font-weight: bold'>Card Type</span></th>" +
                "<th role='columnheader' data-field='DetailsCardNo' data-index='18'  data-role='columnsorter'><span style='color: blue;font-weight: bold'>Card No</span></th>" + "</tr></thead>";
                if (result.Data.length > 0) {
                    for (var i = 0; i < result.Data.length; i++) {
                        str += "<tr>";
                        str += "<td>" + result.Data[i].RowNo + "</td>";
                        str += "<td>" + result.Data[i].DocNo + "</td>";
                        str += "<td>" + result.Data[i].MOP + "</td>";
                        str += "<td>" + result.Data[i].Org + "</td>";
                        str += "<td>" + result.Data[i].Dest + "</td>";
                        str += "<td>" + result.Data[i].GrossWt + "</td>";
                        ...
                        str += "<td>" + result.Data[i].AWBRefundFee + "</td>";
                        str += "<td>" + result.Data[i].RecieptNo + "</td>";
                        str += "<td>" + result.Data[i].TypeofPayment + "</td>";
                        str += "<td>" + result.Data[i].Amount + "</td>";
                        str += "<td>" + result.Data[i].DetailsBank + "</td>";
                        str += "<td>" + result.Data[i].DetailsCardType + "</td>";
                        str += "<td>" + result.Data[i].DetailsCardNo + "</td>";
                    ...
                    str += " <tr>";
                    str += "<td colspan='19'><center><p style='color:red'>No Record Found</p></center></td>";
                    str += "</tr>";
                }
                str += "</table>";
                var today = new Date();
                ...
                $('#excel_Down').append(str.toString());
                var FileName = 'SalesReport_POS_' + today;
                //if ($("#" + obj.id + ":checked").val() == 1) {
                    exportToExcelNew($('#excel_Down').html(), FileName);
                    setTimeout(function () { $('#excel_Down').html(""); }, 500);
                    window.close();
                //}
...
function GetExcelForSummary() {
    ...
    if (AirlineSNo != "" && $('#OriginSNo').val() != "" && $("#FromDate").val() != "" && $("#ToDate").val() != "") {
        $.ajax({
            url: '../IndividualSalesReport/ExportToExcelForSummary',
            async: false,
            type: "GET",
            dataType: "json",
            data: {
                AirlineSNo: AirlineSNo, OriginSNo: OriginSNo, DestinationSNo: DestinationSNo, FromDate: FromDate, ToDate: ToDate, Type: Type, AccountSNo: AccountSNo, UserSNo: UserSNo
            },
            contentType: "application/json; charset=utf-8", cache: false,
            success: function (result) {
               ...
               "</tr></thead>";
                if (result.Data.length > 0) {
                    for (var i = 0; i < result.Data.length; i++) {
                        str += "<tr>";
                        str += "<td>" + result.Data[i].Curr + "</td>";
                        str += "<td>" + result.Data[i].TotalFreightAmount + "</td>";
                        str += "<td>" + result.Data[i].TotalValuationCharges + "</td>";
                        str += "<td>" + result.Data[i].TotalOtherCharges + "</td>";
                    ...
                    str += " <tr>";
                    str += "<td colspan='10'><center><p style='color:red'>No Record Found</p></center></td>";
                    str += "</tr>";
                }
                str += "</table>";
                var today = new Date();
