$(document).ready(function () {
    cfi.AutoCompleteV2("AirlineCode", "CarrierCode,AirlineName", "WareHouseInventory_Report_Airline", null, "contains");
    ...
    //$("#Text_AirlineCode_input").val(userContext.AirlineName);
    //}
    ...
    $("#grid").kendoGrid({
        ...
        dataSource: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "../WarehouseInventoryReport/WarehouseInventoryReportGetRecord",
                    dataType: "json",
                    global: true,
                    type: 'POST',
                    method: 'POST',
...
var Model = [];
function SearchWarehouseInventoryReport() {
    Model =
        {
...
function ExportExcelHoldType()
{
    ...
    window.location.href = "../WarehouseInventoryReport/ExportToExcel?AirlineCode=" + AirlineCode + "&OriginSNo=" + OriginSNo + "&FromDate=" + FromDate + "&ToDate=" + ToDate;
}
