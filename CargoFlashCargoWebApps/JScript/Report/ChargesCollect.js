...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("AWBNumber", "AWBNo", "ChargesCollectReport_AWBNo", null, "contains");
    cfi.AutoCompleteV2("ReferenceNumber", "ReferenceNumber", "ChargesCollectReport_ReferenceNumber", null, "contains");
    //cfi.AutoCompleteByDataSource("PaymentMode", PaymentMode, null, null);
    ...
    $("#grid").kendoGrid({
        ...
        dataSource: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "../ChargesCollect/GetChargesCollectReport",
                    dataType: "json",
                    global: false,
                    type: 'POST',
                    ...
                    data: function GetReportData() {
                        ...
                        SHC = $('#Text_SHC_input').val() == "" ? "" : $('#Text_SHC_input').val();
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        ...
                        ReceivedPieces: { type: "string" },
                        DeliverdPieces: { type: "string" },
                        TotalPieces: { type: "string" },
                        TotalAmount: { type: "string" },
                        ChargeCollect: { type: "string" },
                        STATUS: { type: "string" },
        ...
        //height: 450,
        columns: [
            { field: "ReferenceNumber", title: "Reference No", filterable: true, width: 120 },
            ...
            { field: "ReceivedPieces", title: "Received pcs./wt.", width: 90 },
            { field: "DeliverdPieces", title: "Deliverd pcs./wt.", width: 90 },
            { field: "TotalPieces", title: "Total pcs./wt.", width: 90 },
            { field: "TotalAmount", title: "Total Amount", width: 90 },
            { field: "ChargeCollect", title: "Charge Collect", width: 90 },
...
function ExportToExcel_Flight() {
    ...
    DateType = $('input[type="radio"][name=FilterDate]:checked').val();
    if (Airline != "" && Fromdate != "" & Todate != "") {
        window.location.href = "../ChargesCollect/GetChargesCollectReportForExcel?careerCode=" + Airline + "&SHCsno=" + SHC + "&productSno=" + Product + "&CommoditySno=" + Commodity + "&OriginCitySno=" + Origin + "&DestinationCitySno=" + Destination + "&fromdate=" + Fromdate + "&todate=" + Todate + "&AWBNumber=" + AWBNumber + "&ReferenceNumber=" + ReferenceNumber + "&DateType=" + DateType;
    }
