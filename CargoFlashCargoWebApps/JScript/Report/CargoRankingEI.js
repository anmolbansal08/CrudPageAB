...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("FilterType", "Name", "CargoRankingEI_Name", null, "contains");
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.length > 0) {
                        ...
                        var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:30%;' >GARUDA AIRLINES</td><td></td><td align=\"center\" style='width:50%;'>CARGO RANKING REPORT <BR/> COMMODITY WISE </td><td align=\"right\" style='width:20%;'>Date : " + response[0].Dt +
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.length > 0) {
                        ...
                        var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:30%;' >GARUDA AIRLINES</td><td></td><td align=\"center\" style='width:50%;'>CARGO RANKING REPORT <BR/> AIRLINE WISE </td><td align=\"right\" style='width:20%;'>Date : " + response[0].Dt +
                           "</td></tr><tr><td colspan='2' align='LEFT'>From " + Fdt + " To " + Tdt + "</td></tr></table> "
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.length > 0) {
                        ...
                        var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:30%;' >GARUDA AIRLINES</td><td></td><td align=\"center\" style='width:50%;'>CARGO RANKING REPORT <BR/> Airport WISE</td><td align=\"right\" style='width:20%;'>Date : " + response[0].Dt +
                          "</td></tr><tr><td colspan='2' align='LEFT'>From " + Fdt + " To " + Tdt + "</td></tr></table> "
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.length > 0) {
                        ...
                        var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:30%;' >GARUDA AIRLINES</td><td></td><td align=\"center\" style='width:50%;'>CARGO RANKING REPORT <BR/> AGENT WISE </td><td align=\"right\" style='width:20%;'>Date : " + response[0].Dt +
                          "</td></tr><tr><td colspan='2' align='LEFT'>From " + Fdt + " To " + Tdt + "</td></tr></table> "
