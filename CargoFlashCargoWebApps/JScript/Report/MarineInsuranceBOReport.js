                ...
                success: function (result) {
                    ...
                    if (Result.length > 0) {
                        ...
                        for (var i = 0; i < Result.length; i++) {
                            var count = i + 1;
                            var PublishPremiumRate = Result[i].PublishPremiumRate;
                            if (PublishPremiumRate == "0.000") {
                                PublishPremiumRate = '';
                            }
                            var MinimumPremiApplied = Result[i].MinimumPremiApplied;
                            if (MinimumPremiApplied == "0.000") {
                                PremiumGAFee = Result[i].PremiumGAFee;
                            ...
                            var GENERAL = parseFloat(Result[i].MinimumPremiApplied) - parseFloat(Result[i].ChargeableInsuranceRateForGA);
                            ...
                            TotalGENERAL = TotalGENERAL + GENERAL
                            ...
                            td += "<td class='ui-widget-content'  id='KGS' align='right'> <span  maxlength='100' style='width:100px;'>" + Result[i].PremiumRate + "%</span></td>";
                            td += "<td class='ui-widget-content'  id='13 DAYS' align='right'> <span  maxlength='100' style='width:100px;'>" + parseFloat(Result[i].ChargeableInsuranceRate).toFixed(3) + "</span></td>";
                            td += "<td class='ui-widget-content'  id='46 DAYS' align='right'> <span  maxlength='100' style='width:100px;'>" + parseFloat(Result[i].MinimumPremiApplied).toFixed(3) + "</span></td>";
                            td += "<td class='ui-widget-content'  id='7DAYS' align='right'> <span  maxlength='100' style='width:100px;'>" + PublishPremiumRate + "</span></td>";
                            td += "<td class='ui-widget-content'  id='ComplainStatus' align='right'> <span  maxlength='100' style='width:100px;'>" + PublishPremiumRate + "</span></td>";
                            //td += "<td class='ui-widget-content'  id='ComplainStatus' align='right'> <span  maxlength='100' style='width:100px;'>" + Result[i].NETRATE + "</span></td>";
                            //td += "<td class='ui-widget-content'  id='ComplainStatus' align='right'> <span  maxlength='100' style='width:100px;'>" + parseFloat(Result[i].ChargeableInsuranceRateForGA).toFixed(3) + "</span></td>";
                        ...
                        td1 += "<td class='ui-widget-content'  id='ComplainStatus' align='right'> <span  maxlength='100' style='width:100px;'>" + TotalDeclareValue + "</span></td>";
                        td1 += "<td class='ui-widget-content'  id='ComplainStatus'> <span  maxlength='100' style='width:100px;'></span></td>";
                        td1 += "<td class='ui-widget-content'  id='ComplainStatus'> <span  maxlength='100' style='width:100px;'></span></td>";
                        td1 += "<td class='ui-widget-content'  id='ComplainStatus'> <span  maxlength='100' style='width:100px;'></span></td>";
                        td1 += "<td class='ui-widget-content'  id='ComplainStatus' align='right' > <span  maxlength='100' style='width:100px;'>" + TotalMinimumPremiApplied + "</span></td>";
                        td1 += "<td class='ui-widget-content'  id='ComplainStatus'> <span  maxlength='100' style='width:100px;'></span></td>";
                        td1 += "<td class='ui-widget-content'  id='ComplainStatus' align='right'> <span  maxlength='100' style='width:100px;'>" + TotalChargeablePremi + "</span></td>";
                        //td1 += "<td class='ui-widget-content'  id='ComplainStatus'> <span  maxlength='100' style='width:100px;'></span></td>";
                        //td1 += "<td class='ui-widget-content'  id='ComplainStatus' align='right'> <span  maxlength='100' style='width:100px;'>" + TotalChargeableInsuranceRateForGA + "</span></td>";
                        //td1 += "<td class='ui-widget-content'  id='ComplainStatus' align='right' > <span  maxlength='100' style='width:100px;'>" + TotalChargeablePremiGAToInsurence + "</span></td>";
