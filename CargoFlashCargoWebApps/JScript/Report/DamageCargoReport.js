$(document).ready(function () {
    cfi.AutoCompleteV2("AirlineCode", "CarrierCode,AirlineName", "DamageCargo_Report_Airline", null, "contains");
    ...
    $("#grid").kendoGrid({
        ...
        dataSource: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "../DamageCargoReport/DamageCargoReportGetRecord",
                    dataType: "json",
                    global: true,
                    type: 'POST',
                    method: 'POST',
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        ...
                        MAWB: { type: "string" },
                        HAWB: { type: "string" },
                        DamagePcs: { type: "string" },
                        DamageGWt: { type: "string" },
        ...
        columns: [
            ...
            { field: "MAWB", title: "AWB"},
            { field: "HAWB", title: "HAWB"},
            { field: "DamagePcs", title: "Damage Pcs"},
            { field: "DamageGWt", title: "Damage G Wt."},
...
var Model = [];
function SearchDamageCargoReport() {
    Model =
        {
...
function ExportExcelDamageCargo() {
    ...
    window.location.href = "../DamageCargoReport/ExportToExcel?AirlineCode=" + AirlineCode +"&DestinationSNo=" + DestinationSNo + "&FromDate=" + FromDate + "&ToDate=" + ToDate;
}
