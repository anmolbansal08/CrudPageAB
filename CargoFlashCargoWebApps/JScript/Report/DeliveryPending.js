...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("Airline", "AirlineName", "DeleiveryPending_AirlineName", null, "contains");
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.length > 0) {
                    ...
                    var str = "<html><table  style='width:90%;'><tr><td align=\"left\" style='width:30%;' >GARUDA AIRLINES</td><td></td><td align=\"center\" style='width:50%;'>Delivery Pending Shipment </td><td align=\"right\" style='width:20%;'>Date : " + response[0].Dt +
