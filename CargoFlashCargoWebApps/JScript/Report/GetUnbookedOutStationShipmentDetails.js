...
function UnBookedOutStationShipmentSearch() {
    ...
    $("#tblCreditLimitReport").appendGrid({
        ...
        servicePath: "../OutStationUnbookedReport",
        getRecordServiceMethod: "GetOutStationUnbookedDetail",
        deleteServiceMethod: "",
        caption: "Unbooked OutStation Shipment Detail",
        initRows: 1,
        isGetRecord: true,
        columns: [
...
function ExportToExcel() {
    ...
    window.location.href = "../OutStationUnbookedReport/ExportToExcelFile?Fromdate=" + Fromdate + "&Todate=" + Todate;
