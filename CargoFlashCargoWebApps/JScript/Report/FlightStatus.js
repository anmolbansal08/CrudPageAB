...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("FlightOrigin", "OriginCity", "FlightStatus_FlightOrigin", null, "contains");
    cfi.AutoCompleteV2("FlightNo", "FlightNo", "FlightStatus_FlightNo", null, "contains");
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.length > 0) {
                    ...
                    str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='8'>GARUDA AIRLINES</td></tr><tr><td colspan='3' align='LEFT'>Flight No => " + fno + "</td>  <td align=\"right\" colspan='5'>Date : " + response[0].Dt + "</td></tr>"
