...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("Airline", "airlinecode", "ExportCSR_airlinecode", null, "contains");
    ...
    cfi.AutoCompleteV2("Party", "Name", "ExportCSR_Name", null, "contains");
                ...
                if (dataTableobj.Table0 != undefined) {
                    if (dataTableobj.Table0.length > 0) {
                        ...
                        for (var j = 0; j < dataTableobj.Table3.length; j++) {
                            ...
                            str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='6'>GARUDA AIRLINES</td><td colspan='7' align='center'><img src='\Images/sh.png'/></td><td align=\"right\" colspan='3'><font-size:18pt;font-family:Arial'><b>Export Cargo Sales Report</b></font></td></tr><tr>"
                ...
                if (dataTableobj.Table0 != undefined) {
                    if (dataTableobj.Table0.length > 0) {
                        ...
                        for (var j = 0; j < dataTableobj.Table3.length; j++) {
                            ...
                            str += "<table border=\"0px\" cellpadding='0' cellspacing='1' width='98%'>";
                            //str += "<tr font-size:13pt;font-family:Arial'><td align='center' colspan='15'><font color=':#419AD4'><b>Export CSR</b></font></td></TR>"
                            str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='6'>GARUDA AIRLINES</td><td colspan='6' align='center'><img src='\Images/sh.png'/></td><td align=\"right\" colspan='3'><font-size:18pt;font-family:Arial'><b>EXPORT Cargo Sales Report</b></font></td></tr><tr>"
