...
function LoadExportFlightMonitoringDetails() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            cfi.AutoCompleteV2("searchFlightNo", "FlightNo", "ExportFlightMonitoring_FlightNo", null, "contains");
            cfi.AutoCompleteV2("searchDestination", "AirportName", "ExportFlightMonitoring_AirportName",  null, "contains");
            cfi.AutoCompleteV2("searchAirline", "AirlineName", "ExportFlightMonitoring_AirlineName",  null, "contains");
