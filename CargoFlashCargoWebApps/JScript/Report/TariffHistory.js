...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("Tariffsno", "Sno", "Tariff_TariffHistory", null, "contains");
    cfi.AutoCompleteV2("TariffCode", "TariffCode", "Tariff_TariffCode", null, "contains");
    cfi.AutoCompleteV2("TariffName", "TariffName", "Tariff_TariffName", null, "contains");
...
function Search() {
    var tariffid = $("#Tariffsno").val() == "" ? "0" : $("#Tariffsno").val();
    var tariffcode = $("#TariffCode").val() == "" ? "0" : $("#TariffCode").val();
    var tariffname = $("#TariffName").val() == "" ? "0" : $("#TariffName").val();
    $("#divTariffHistory").html("")
    $.ajax({
