...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("EquipmentNo", "EquipmentNo", "UWSPending_EquipmentNo", null, "contains");

    cfi.AutoCompleteV2("Destination", "DestinationCode", "UWSPending_Destination", null, "contains");

    cfi.AutoCompleteV2("Airline", "AirlineName", "UWSPending_Airline", null, "contains");

    cfi.AutoCompleteV2("FlightNumber", "FlightNo", "UWSPending_FlightNumber", null, "contains");


    cfi.AutoCompleteV2("ULD", "ULDNo", "UWSPending_ULD", null, "contains");


    cfi.AutoCompleteV2("AwbNo", "AwbNo", "UWSPending_AwbNo", null, "contains");
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.length > 0) {
                    ...
                    var str = "<html><table  style='width:90%;'><tr><td align=\"left\" colspan='4'>GARUDA AIRLINES</td><td></td><td align=\"center\"  colspan='7'>Pending UWS </td><td align=\"right\" colspan='5'>Date : " + response[0].Dt +
                       "</td></tr></table> "
...
function BindWhereCondition() {
    ...
    //var flightdate = new Date($("#FlightDt").val());
    //var date = new Date(flightdate).toDateString("yyyy-MM-dd");
