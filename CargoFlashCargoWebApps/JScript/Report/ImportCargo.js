        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (dataTableobj.Table0.length>0) {
                    ...
                    str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='8'>GARUDA AIRLINES</td></tr><tr><td colspan='3' align='LEFT'>From " + Fdt + " To " + Tdt + "</td>  <td align=\"right\" colspan='5'>Date : " + dataTableobj.Table1[0].Dt + "</td></tr>"
