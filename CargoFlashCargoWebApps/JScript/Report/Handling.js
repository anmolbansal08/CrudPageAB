...
$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("Agent", "Name", "HandLing_Name", null, "contains", ",");
    cfi.AutoCompleteV2("Awb", "AWBNo", "HandLing_AWBNo", null, "contains");
    cfi.AutoCompleteV2("InvoiceNo", "InvoiceNo", "HandLing_InvoiceNo", null, "contains");
    cfi.AutoCompleteV2("Airline", "AirlineName", "HandLing_AirlineName", null, "contains", ",");
            ...
            success: function (data) {
                ...
                if ($("#Type").val() != "3") {
                    if (dataTableobj.Table0.length > 0) {
                        ...
                        str += "<tr  font-size:13pt;font-family:Arial'><td align=\"left\" colspan='10'>GARUDA AIRLINES</td></tr><tr><td colspan='4' align='LEFT'>From " + FromDate + " To " + ToDate + "</td>  <td align=\"right\" colspan='6'>Date : " + dataTableobj.Table1[0].Dt + "</td></tr>"
