...
$(document).ready(function () {
    ...
    //        transport: {
    //            read: {
    //                url: "../FPRReport/FPRReportGetRecord",
    //                dataType: "json",
    //                global: true,
    //                type: 'POST',
    //                method: 'POST',
...
function ExportExcelHoldType() {
    ...
    window.location.href = "../FPRReport/ExportToExcel?AirlineCode=" + AirlineCode + "&FlightNo=" + FlightNo + "&OriginSNo=" + OriginSNo + "&DestinationSNo=" + DestinationSNo + "&AWBNo=" + AWBNo + "&FromDate=" + FromDate + "&ToDate=" + ToDate+"&IsAutoProcess=1";
}
