    ...
    if (AWBData!=null) {
       ...
       // $("#spnOFWB").html(AWBData[0].AWBNo);
        ...
        //for (var i = 0; i < EDIData.length; i++) {
            ...
            //    FWB = 1;
            //}
            $("#spnFWBDate").html(EDITime[0].FWBEventDate.substring(0, 6) + " " + EDITime[0].FWBEventDate.substring(12, 17));
            ...
            //    RCS = 1;
            //}
            $("#spnRCSDate").html(EDITime[0].RCSEventDate.substring(0, 6) + " " + EDITime[0].RCSEventDate.substring(12, 17));
            ...
            //    DEP = 1;
            //}
            $("#spnDEPDate").html(EDITime[0].DEPEventDate.substring(0, 6) + " " + EDITime[0].DEPEventDate.substring(12, 17));
            ...
            //    RCF = 1;
            //}
            $("#spnRCFDate").html(EDITime[0].RCFEventDate.substring(0, 6) + " " + EDITime[0].RCFEventDate.substring(12, 17));
            ...
            //    NFD = 1;
            //}
            $("#spnNFDDate").html(EDITime[0].NFDEventDate.substring(0, 6) + " " + EDITime[0].NFDEventDate.substring(12, 17));
            ...
            //    DLV = 1;
            //}
            $("#spnDLVDate").html(EDITime[0].DLVEventDate.substring(0, 6) + " " + EDITime[0].DLVEventDate.substring(12, 17));
