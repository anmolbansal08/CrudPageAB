...
function BindEventMessageTrans() {
    ...
    $('#tbl' + EventmessageTrans).appendGrid({
        ...
        columns: [{ name: 'SNo', type: 'hidden' },
                  { name: "EventName", display: "Event Name", type: controlType, ctrlAttr: { maxlength: 48, controltype: 'alphanumericupper' }, ctrlCss: { width: '150px' }, isRequired: false, AutoCompleteName: 'EDI_EventName', filterField: 'EventName', filterCriteria: "contains", separator: "," },
                  { name: "SubProcessName", display: "Sub Process", type: controlType, ctrlAttr: { maxlength: 100, controltype: "autocomplete" }, ctrlCss: { width: "250px" }, isRequired: false, AutoCompleteName: "EDI_EventConfig_SubProcessName", filterField: "SubProcessName", filterCriteria: "contains", separator: "," },
                  { name: "MessageType", display: "Message", type: controlType, ctrlAttr: { maxlength: 100, controltype: "autocomplete" }, ctrlCss: { width: "100px" }, isRequired: false, AutoCompleteName: "EDI_EventConfig_MessageType", filterField: "MessageType", filterCriteria: "contains", separator: "," },
            ...
            { name: "Origin", display: "Origin", type: controlType, ctrlAttr: { maxLength: 3, controltype: "autocomplete" }, ctrlCss: { width: "100px" }, isRequired: false, AutoCompleteName: "EDI_EventConfig_City", filterField: "CityCode", filterCriteria: "contains", separator: "," },
            { name: "Destination", display: "Destination", type: controlType, ctrlAttr: { maxLength: 3,  controltype: "autocomplete" }, ctrlCss: { width: "100px" }, isRequired: false, AutoCompleteName: "EDI_EventConfig_City", filterField: "CityCode", filterCriteria: "contains", separator: "," }
        ],
