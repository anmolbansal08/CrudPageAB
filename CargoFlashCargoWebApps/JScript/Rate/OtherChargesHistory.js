...
$(document).ready(function () {
    ...
    $(document.body).append('<script type="text/javascript" src="../Scripts/jspdf.js" ></script>');
    $(document.body).append('<script type="text/javascript" src="../JScript/Shipment/table2excel.js" ></script>');
    $("#Search").after('<input type="button" name="Excel" id="Excel" value="Excel" class="btn btn-success">');
    $("#Search").after('<input type="button" name="Search" id="Search" value="VIEW" class="btn btn-success">');


    BindAutoComplete();
    $("#Text_OriginType,#Text_OriginSNo,#Text_DestinationType,#Text_DestinationSNo,#ValidFrom,#ValidTo").attr('data-valid', 'required');
...
function BindAutoComplete() {
    ...
    cfi.AutoCompleteV2("AirlineSNo", "CarrierCode,AirlineName", "OtherChargesHistory_Airline", null, "contains");
    //Ends
    ...
    cfi.AutoCompleteV2("OCCodeSNo", "Code,Name", "OtherChargesHistory_OCCode", null, "contains");
    //Ends
    cfi.AutoCompleteByDataSource("OriginType", Origin, FnGetOriginAC);
    cfi.AutoCompleteByDataSource("DestinationType", Destination, FnGetDestinationAC);
    // Changes by Vipin Kumar
    ...
    cfi.AutoCompleteV2("OriginSNo", "AirportCode,AirportName", "OtherChargesHistory_Airport", OnSelectOrigin, "contains");
    ...
    cfi.AutoCompleteV2("DestinationSNo", "AirportCode,AirportName", "OtherChargesHistory_Airport", OnSelectDestination, "contains");
    // ends
    ...
    cfi.AutoCompleteV2("CurrencySNo", "CurrencyCode", "OtherChargesHistory_Currency", null, "contains");
    //Ends
}

$(document).on("click", "#Excel", function () {
    debugger;
    $("#tblOtherChargesHistoryView").table2excel({
        // exclude CSS class
...
$(document).on("click", "#Search", function () {
    ...
    if ($('#tblOtherChargesHistoryView').length) {
        ...
        $('#tbl').after("<br/><div id='divOtherChargesHistory' style='height:350px; width:100%; overflow:auto'><table id='tblOtherChargesHistoryView'></table></div><br/>")
...
function FnGetOriginAC(input) {
    ...
    if (Origin == "AIRPORT") {
        ...
        var dataSource = GetDataSourceV2("OriginSNo", "OtherChargesHistory_Airport")
        // Ends
        ...
        var dataSource = GetDataSourceV2("OriginSNo", "OtherChargesHistory_City")
        //Ends
        ...
        var dataSource = GetDataSourceV2("OriginSNo", "OtherChargesHistory_Region")
        // Ends
        ...
        var dataSource = GetDataSourceV2("OriginSNo", "OtherChargesHistory_Country");
        ...
        cfi.AutoCompleteV2("OriginSNo", "CountryCode,CountryName", "OtherChargesHistory_Country", OnSelectOrigin, "contains");
        // Ends
    }
    else if (Origin == "ZONE") {
        cfi.ResetAutoComplete("OriginSNo");
        ...
        var dataSource = GetDataSourceV2("OriginSNo", "OtherChargesHistory_Zone")
        // Ends
...
function FnGetDestinationAC(input) {
    ...
    if (Destination == "AIRPORT") {
        ...
        var dataSource = GetDataSourceV2("DestinationSNo", "OtherChargesHistory_Airport")
        //Ends
        ...
        var dataSource = GetDataSourceV2("DestinationSNo", "OtherChargesHistory_City")
        //Ends
        ...
        var dataSource = GetDataSourceV2("DestinationSNo", "OtherChargesHistory_Region")
        //Ends
        ...
        var dataSource = GetDataSourceV2("DestinationSNo", "OtherChargesHistory_Country")
        // Ends
        ...
        var dataSource = GetDataSourceV2("DestinationSNo", "OtherChargesHistory_Zone")
        //Ends
...
function getOtherChargesHistoryData() {
    ...
    var obj=
    JSON.stringify({
        AirlineSNo: parseInt($("#AirlineSNo").val()), chargeTypeval: $("#Charge").val(), DueCarrierCode: $("#OCCodeSNo").val(),
        statusval: $("#Active").val(), OriginLev: $("#OriginType").val(),
        Origin: $("#OriginSNo").val(), DestLev: $("#DestinationType").val(),
        Destination: $("#DestinationSNo").val(), vallidFrom: $("#ValidFrom").val(), VallidTo: $("#ValidTo").val(), ReferenceNumber: $("#ReferenceNumber").val()
    });
    ...
    if (user != "") {
        ...
        $.ajax({
            ...
            url: "Services/Rate/OtherChargesHistoryService.svc/GetOtherChargesHistoryData",
    ...
    $("#tblOtherChargesHistoryView").appendGrid({
        ...
        columns: [
               { name: 'abc', display: '', type: 'button', value: 'ViewDetails', ctrlCss: { width: "70px", height: '25px' }, ctrlAttr: { maxlength: 70, onClick: "return Opennew(this.id)" } },
                 ...
                 { name: 'AirlineCarrierCode', display: 'AirlineCode', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'AirlineCarrierCodeText', display: 'AirlineCarrierCode', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'AirlineCarrierCodeIsInclude', display: 'AirlineCarrierCode-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'FlightIsInclude', display: 'Flight-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'ETDIsInclude', display: 'ETD-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'TransitText', display: 'Transit', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'TransitIsInclude', display: 'Transit-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'AgentText', display: 'Agent', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'AgentGroupText', display: 'AgentGroup', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'AgentGroupIsInclude', display: 'AgentGroup-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'AccountShipperText', display: 'AccountShipper', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'AccountShipperIsInclude', display: 'AccountShipper-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'CommodityText', display: 'Commodity', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'CommodityIsInclude', display: 'Commodity-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'ProductText', display: 'Product', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'ProductIsInclude', display: 'Product-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 ...
                 { name: 'SHCHText', display: 'SHCH', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'SHCHIsInclude', display: 'SHCH-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'SPHCGroupSNo', type: 'hidden', value: 0 },
                //{ name: 'SPHCGroupSNo', display: 'SPHCGroupSNo', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'SPHCGroupText', display: 'SPHCGroup', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'SPHCGroupIsInclude', display: 'SPHCGroup-IsInclude', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'CreatedbyON', display: 'Createdby/ON', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false },
                 { name: 'UpdatedbyON', display: 'Updatedby/ON', type: 'label', ctrlCss: { width: '100px', height: '30px' }, ctrlAttr: { maxlength: 600 }, isRequired: false }
