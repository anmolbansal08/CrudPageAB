                ...
                if (GetSucessResult != undefined) {
                    ...
                    if (GetSucessResult.Table0.length > 0) {
                        ...
                        if (GetSucessResult.Table0.length > 0) {
                            ...
                            tbl += "<td  style='padding: 4px; font-family: sans-serif; font-size: 12px; border: 1px solid black;' width='15%'><b>Material(IDR)</b></td>"
                            ...
                            for (var i = 1; i <= GetSucessResult.Table0.length; i++) {
                                ...
                                totalmetrial = (parseFloat(totalmetrial) + parseFloat(GetSucessResult.Table0[i - 1].Meterial)).toFixed(3);
                                totalmanhours = (parseFloat(totalmanhours) + parseFloat(GetSucessResult.Table0[i - 1].ManHours)).toFixed(3);
                                grandTotal = parseFloat(grandTotal) + parseFloat(GetSucessResult.Table0[i - 1].Total);
                               
                                 total1 = (parseFloat(GetSucessResult.Table0[i - 1].Meterial) + parseFloat(GetSucessResult.Table0[i - 1].ManHours)).toFixed(3)

                                 total += (parseFloat(GetSucessResult.Table0[i - 1].Meterial) + parseFloat(GetSucessResult.Table0[i - 1].ManHours))
                                ...
                                tbl += "<td style='padding: 4px; font-family: sans-serif; font-size: 12px; border: 1px solid black;'>" + total1 + "</td>"
                                tbl += "</tr>"
                            ...
                            tbl += "<td style='padding: 4px; font-family: sans-serif; font-size: 12px; border: 1px solid black;' rowspan='2'>" + total.toFixed(3) + "</td>"
                            tbl += "</tr>"
