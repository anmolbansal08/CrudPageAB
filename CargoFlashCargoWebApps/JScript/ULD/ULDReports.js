...
{
    $('#OwnershipSNo').val('2')
    $('#Text_OwnershipSNo').val('Both')

    cfi.AutoCompleteV2("AirlineSNo", "AirlineCode,AirlineName", "ULDStockReport_Airline", null, "contains");
    cfi.AutoCompleteV2("CitySNo", "CityCode,CityName", "ULDStockReport_City", null, "contains");
    var OwnershipType = [{ Key: "0", Text: "Airline" }, { Key: "1", Text: "Hired" }, { Key: "2", Text: "Both" }];
    cfi.AutoCompleteByDataSource("OwnershipSNo", OwnershipType);
...
function GetReportData() {
    ...
    OwnershipSNo = $("#OwnershipSNo").val() == null ? "" : $("#OwnershipSNo").val();
            ...
            dataSource: {
                transport: {
                    read: {
                        ...
                        datatype: 'json',
                        method: 'post',
                        data: { AirlineSNo: AirlineSNo, CitySNo: CitySNo, OwnershipSNo: OwnershipSNo}
                    }
        ...
        dataSource: {
            transport: {
                read: {
                    ...
                    data: { AirlineSNo: e.data.ASNo, CitySNo: CitySNo, OwnershipSNo: $("#OwnershipSNo").val() }
                }
            },
            parameterMap: function (data, operation) {
                alert(JSON.stringify(data));
        ...
        dataSource: {
            transport: {
                read: {
                    ...
                    method: 'post',
                    //data: { AWBPrefix: e.data.AWBPrefix }
                    data: { AirlineSNo: e.data.ASNo, CitySNo: e.data.CSNo, OwnershipSNo: $("#OwnershipSNo").val() }
                }
            },
            parameterMap: function (data, operation) {
                alert(JSON.stringify(data));
        ...
        dataSource: {
            transport: {
                read: {
                    ...
                    method: 'post',
                    //data: { AWBPrefix: e.data.AWBPrefix }
                    data: { AirlineSNo: e.data.ASNo, CitySNo: e.data.CSNo, ULDType: e.data.ULDTp, OwnershipSNo: $("#OwnershipSNo").val() }
                }
            },
            parameterMap: function (data, operation) {
                alert(JSON.stringify(data));
...
function ExportToExcel(Count, AirlineSNo, CitySNo, field, Status, ULDTp, ULD) {
    if (Count) {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {
                AirlineSNo: AirlineSNo, CitySNo: CitySNo, field: field, Status: Status, ULDTp: (ULDTp || 'No'), ULD: (ULD || 'No'), OwnershipSNo: $("#OwnershipSNo").val()
            },
