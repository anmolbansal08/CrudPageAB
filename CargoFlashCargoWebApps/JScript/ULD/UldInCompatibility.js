$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("UldTypeName", "Text_ULD", "ULD_UldTypeName", null, "contains");

    //cfi.AutoComplete("Airline", "CarrierCode,AirlineName", "vwAirline", "SNo", "AirlineCode", ["CarrierCode", "AirlineName"], onselect, "contains");
    cfi.AutoCompleteV2("Airline", "CarrierCode,AirlineName", "ULD_Airline_vwAirline", onselect, "contains");
    ...
    $("tr[id^='areaTrans_ULD_ULDInCompatibilityTrans']").find("input[id^='SPHC']").each(function () {
        ...
        cfi.AutoCompleteV2($(this).attr("name"), "SNo,Code", "ULD_name", null, "contains", ",");
    ...
    if (getQueryStringValue("FormAction").toUpperCase() == "EDIT") {
        ...
        var autocomplete = $("#Text_Airline").data("kendoAutoComplete");
        autocomplete.enable(false);
...
function BindAutoCompleteFor(elem, mainElem) {
    $(elem).find("input[id^='SPHC']").each(function () {
        ...
        cfi.AutoCompleteV2($(this).attr("name"), "Code", "ULD_name_vSPHCCode", null, "contains", ",");
...
function SaveULD() {
    ...
    $.ajax({
        ...
        success: function (result) {
            $('#valueareaTrans_ULD_ULDInCompatibilityTrans').val('');
...
function ExtraCondition(textId) {
    ...
    if (textId == "Text_UldTypeName") {
        cfi.setFilter(filter, "AirlineSno", "eq", $("#Airline").val())
