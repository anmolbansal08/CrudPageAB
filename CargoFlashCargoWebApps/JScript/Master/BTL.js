...
function CreateData() {
    ...
    cfi.AutoCompleteV2("AccountSNo", "Name", "Master_BTL_Account", null, "contains");
    //cfi.AutoComplete("AirlineSNo", "CarrierCode,AirlineName", "Airline", "SNo", "AirlineCode", ["CarrierCode", "AirlineName"], null, "contains");
    cfi.AutoCompleteV2("AirlineSNo", "CarrierCode,AirlineName", "Master_BTL_Airline", null, "contains");
    ...
    cfi.AutoCompleteV2("Aircraft", "AircraftType,AirlineName", "Master_BTL_Aircraft", null, "contains", ",");
    ...
    cfi.AutoCompleteV2("Commodity", "CommodityCode,CommodityDescription", "Master_BTL_Commodity", null, "contains");
    //cfi.AutoComplete("SHC", "SNo,Code", "vwsphc", "SNo", "Code", ["Code"], null, "contains");
    cfi.AutoCompleteV2("SHC", "SNo,Code", "Master_BTL_SHC", null, "contains");
...
function CreateFlightGrid() {
    ...
    $("#tblBTL").appendGrid({
        ...
        columns: [
           ...
           { name: 'FlightSNo', display: 'Flight', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '150px', height: '20px' }, onChange: function (evt, rowIndex) { }, isRequired: true, AutoCompleteName: 'BTL_FlightSNo', filterField: 'FlightNo', filterCriteria: "contains" },
           ...
           { name: "TotalWeight", display: "Total Weight", type: "text", ctrlCss: { width: '100px' }, ctrlAttr: { maxlength: 10, controltype: "number" }, isRequired: true },
            { name: 'CommoditySNo', display: 'Commodity', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '150px', height: '20px' }, onChange: function (evt, rowIndex) { }, isRequired: true, AutoCompleteName: 'BTL_Commodity', filterField: 'CommodityDescription', filterCriteria: "contains" },
            { name: 'SHCSNo', display: 'SHC', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '150px', height: '20px' }, onChange: function (evt, rowIndex) { }, isRequired: true, AutoCompleteName: 'BTL_SHCSNo', filterField: 'Code', filterCriteria: "contains" }
...
function CreatePeriodGrid() {
    ...
    $("#tblBTL").appendGrid({
        ...
        columns: [
           ...
           { name: "TotalWeight", display: "Total Weight", type: "text", ctrlCss: { width: '100px' }, ctrlAttr: { maxlength: 10, controltype: "number" }, isRequired: true },
           { name: 'CommoditySNo', display: 'Commodity', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '150px', height: '20px' }, onChange: function (evt, rowIndex) { }, isRequired: true, AutoCompleteName: 'BTL_CommoditySNo', filterField: 'CommodityDescription', filterCriteria: "contains" },
           { name: 'SHCSNo', display: 'SHC', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '150px', height: '20px' }, onChange: function (evt, rowIndex) { }, isRequired: true, AutoCompleteName: 'BTL_SHCSNo', filterField: 'Code', filterCriteria: "contains" }
