...
$(document).ready(function () {
    ...
    if (!$("#Text_" + $(this).attr("name")).data("kendoAutoComplete")) {
        cfi.AutoCompleteV2("CityCode", "CityName,CityCode,SNo", "Master_SlabMaster_CityName", null, "contains");
    }
    cfi.AutoCompleteV2("AirlineSNo", "AirlineCode,AirlineName", "Master_SlabMaster_AirlineName", null, "contains");
    ...
    if (getQueryStringValue("FormAction").toUpperCase() == "EDIT") {
        //$("#ApplicationTabs").kendoTabStrip().data("kendoTabStrip").activateTab($('#liSlab'));// Commented By Akash on 28 Nov
        $("#ApplicationTabs").kendoTabStrip().data("kendoTabStrip").activateTab($('#liSlabMaster')); // Added By Akash on 28 Nov
        CreateSlab();
    }
...
function BindAutoComplete() {
    ...
    if (Zonearea == 3) {
        ...
        cfi.AutoCompleteV2("Slab", "RegionName", "Master_SlabMaster_SLabRegion", null, "contains", ",");

    }
    else if (Zonearea == 5) {

        cfi.AutoCompleteV2("Slab", "CountryCode,CountryName", "Master_SlabMaster_CountryCode", null, "contains", ",");//updated by indra pratap singh

    }
    else if (Zonearea == 2) {

        cfi.AutoCompleteV2("Slab", "CityCode", "Master_SlabMaster_CityCode", null, "contains", ",");

    }
    else if (Zonearea == 1) {

        cfi.AutoCompleteV2("Slab", "AirportCode", "Master_SlabMaster_AirportCode", null, "contains", ",");

    }
    else if (Zonearea == 4) {

        cfi.AutoCompleteV2("Slab", "ZoneName", "Master_SlabMaster_ZoneName", null, "contains", ",");
