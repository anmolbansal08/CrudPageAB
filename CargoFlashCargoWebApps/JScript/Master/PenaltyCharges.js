...
//    $("html, body").animate({ scrollTop: loc.top }, "slow");
    cfi.AutoCompleteV2(String.Format('Origin{0}', currentOriginDestination.toString()), 'CityName,CityCode', 'Master_PenaltyCharge_City',  null, "contains");
    cfi.AutoCompleteV2(String.Format('Destination{0}', currentOriginDestination.toString()), 'CityName,CityCode', 'Master_PenaltyCharge_City', null, "contains");
    cfi.AutoCompleteV2(String.Format('PenaltyType{0}', currentOriginDestination.toString()), "PenaltyTypeName", "Master_PenaltyCharge_Penalty");
    cfi.AutoCompleteV2(String.Format('CustomerName{0}', currentOriginDestination.toString()), "CustomerTypeName", "Master_PenaltyCharge_CustomerType");
    cfi.AutoCompleteV2(String.Format('AirlineName{0}', currentOriginDestination.toString()), "AirlineName,AirlineCode", "Master_PenaltyCharge_Airline",  null, "contains");
    cfi.AutoCompleteV2("FlightName" + currentOriginDestination.toString(), "FlightNo", "Master_Revenuesimulator_FlightNo");
...
$(document).ready(function () {
    ...
    try {
        ...
        cfi.AutoCompleteV2("BucketClassSNo", "Name", "BucketClass", "SNo", "Name");
        cfi.AutoCompleteV2("CustomerName", "CustomerTypeName", "Master_PenaltyCharge_CustomerType");
        cfi.AutoCompleteV2("AirlineName", "AirlineName,AirlineCode", "Master_PenaltyCharge_Airline", null, "contains");
        cfi.AutoCompleteV2("PenaltyType", "PenaltyTypeName", "Master_PenaltyCharge_Penalty");
        cfi.AutoCompleteV2("Origin", "CityName,CityCode", "Master_PenaltyCharge_City",  null, "contains");
        cfi.AutoCompleteV2("Destination", "CityName,CityCode", "Master_PenaltyCharge_City", null, "contains");
        cfi.AutoCompleteV2("FlightName", "FlightNo", "Master_Revenuesimulator_FlightNo");
