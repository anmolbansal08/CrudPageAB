$(document).ready(function ()
{
    ...
    cfi.ValidateForm();
    cfi.AutoCompleteV2("ContactTypeSNo", "SNo,Name", "Master_Contacts_ContactType", null, "contains");
   ...
   // cfi.AutoComplete("WarehouseSNo", "SNo,Name", "Warehouse", "SNo", "Name", null, null, "contains");
    cfi.AutoCompleteV2("DepartmentSNo", "SNo,Name", "Master_Contacts_Department", null, "contains");
    cfi.AutoCompleteV2("CitySNo", "CityCode,CityName", "Master_Contacts_CityName", null, "contains");
    cfi.AutoCompleteV2("CountryCode", "CountryCode,CountryName", "Master_Contacts_CountryName", null, "contains", null, null, null, null, OnSelectCountry);
    $('input:radio[name=ContactsType]').click(function ()
    {
        ...
        else if ($(this).val() == '1')
        {
            ...
            $('#ContactTypeSNo').val('');
            $('#Text_ContactTypeSNo').val('');
            cfi.AutoCompleteV2("ContactTypeSNo", "SNo,Name", "Master_Contacts_AccountName", null, "contains");
        }
        else if ($(this).val() == '2') {
            $('#spnContactTypeSNo').text('CTO Name');
            $('#ContactTypeSNo').val('');
            $('#Text_ContactTypeSNo').val('');
            cfi.AutoCompleteV2("ContactTypeSNo", "SNo,Name", "Master_Contacts_WareHouse", null, "contains");
        }
    });
