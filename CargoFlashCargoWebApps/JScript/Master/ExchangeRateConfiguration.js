$(document).ready(function () {
    ...
    cfi.AutoCompleteV2("RateTypeUse", "RateTypeCode", "Master_RateType", null, "contains", ",");
...
function ExtraCondition(textId) {
    var filterERC = cfi.getFilter("AND");

    if (textId == "Text_RateTypeUse") {

        cfi.setFilter(filterERC, "SNo", "notin", $("#Text_RateTypeUse").data("kendoAutoComplete").key())
        var OriginCityAutoCompleteFilter2 = cfi.autoCompleteFilter([filterERC]);
