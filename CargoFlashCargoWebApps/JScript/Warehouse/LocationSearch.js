...
function BindSearchControls() {
    cfi.AutoCompleteV2("Terminal_Search", "TerminalName", "Warehouse_Terminal_Search",  null, "contains");
    cfi.AutoCompleteV2("Airline_Search", "AirlineName", "Warehouse_Airline_Search", null, "contains");
    ...
    cfi.AutoCompleteV2("DestCity_Search", "CityName", "Warehouse_DestCity_Search",  null, "contains");
    cfi.AutoCompleteV2("AgentForwarder_Search", "Name", "Warehouse_AgentForwarder_Search",  null, "contains");
...
function BindLoactionSearchGrid() {
    ...
    $("#" + dbtableName).appendGrid({
        ...
        columns: [{ name: 'SNo', type: 'hidden', value: 0 },
            ...
            //},
            {
                name: 'LocationName', display: 'Location Name', type: 'text', value: '', ctrlAttr: { maxlength: 3, controltype: 'autocomplete' }, ctrlCss: { width: '150px', height: '20px' }, isRequired: true, AutoCompleteName: 'Warehouse_LocationName',filterField :'LocationName', filterCriteria: "contains"
...
function bindhtml(evt, rowIndex)
{
    ...
    cfi.AutoCompleteV2("LSearch", "LocationName", "Warehouse_LocationName",  null, "contains");
    cfi.AutoCompleteV2("MPieceNo", "PieceNo", "Warehouse_MPieceNo", null, "contains", ",", null, null, null, null, true, null);
...
function bindhtml1(evt, rowIndex)
{
    ...
    cfi.AutoCompleteV2("LSearch", "LocationName", "Warehouse_LocationName", null, "contains");
    cfi.AutoCompleteV2("MPieceNo", "PieceNo", "Warehouse_MPieceNo_SunProcess",  null, "contains", ",", null, null, null, null, true, null);
}
