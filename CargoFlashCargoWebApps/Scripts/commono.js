...
//var url = 'Services/AutoCompleteService.svc/WMSAutoCompleteDataSourceByParameter';
...
function CargoFlashApplication() {
    ...
    this.GridAutoComplete = function (textId, basedOn, tableName, keyColumn, textColumn, templateColumn, addOnFunction, filterCriteria, separator, newAllowed, confirmOnAdd, procName, onSelect, Parameterlist) {
        var keyId = textId;
        //textId = "Text_" + textId;
        ...
        if (IsValid(textId, autoCompleteType)) {
            ...
            var dataSource = GetDataSource(textId, tableName, keyColumn, textColumn, templateColumn, procName,Parameterlist);
    ...
    this.GridAutoCompleteV2 = function (textId, basedOn, AutoCompleteName, addOnFunction, filterCriteria, separator, newAllowed, confirmOnAdd, procName, onSelect) {
        var keyId = textId;
        //textId = "Text_" + textId;
        var KeyIdArray = new Array();
        KeyIdArray = textId.split("_");
    ...
    this.AutoComplete = function (textId, basedOn, AutoCompleteName, addOnFunction, filterCriteria, separator, newAllowed, confirmOnAdd, procName, newUrl) {
        var keyId = textId;
        textId = "Text_" + textId;

        if (IsValid(textId, autoCompleteType)) {
            var width = $("input[type='text'][name='" + textId + "']").attr("data-width");
            var dataSource = GetDataSource(textId, AutoCompleteName, newUrl);
            if ($("input[type='text'][name='" + textId + "']").data("kendoAutoComplete") != undefined) {
...
//Changed by Manoj Kumar
GetDataSource = function (textId, AutoCompleteName,ParameterList,newUrl) {
    var dataSource = new kendo.data.DataSource({
        type: "json",
        serverPaging: true,
        serverSorting: true,
...
//GetDataSource = function (textId, AutoCompleteName,newUrl) {
//    var dataSource = new kendo.data.DataSource({
//        type: "json",
//        serverPaging: true,
//        serverSorting: true,
