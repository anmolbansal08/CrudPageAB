        ...
        for (var z = 0; z < numOfRow; z++) {
            ...
            for (var y = 0; y < settings.columns.length; y++) {
                ...
                if (settings.columns[y].type == 'custom') {
                    ...
                    cfi.GridAutoComplete(ctrl.id, settings.columns[y].basedOn, settings.columns[y].tableName, settings.columns[y].keyColumn, settings.columns[y].textColumn, settings.columns[y].templateColumn, settings.columns[y].addOnFunction, settings.columns[y].filterCriteria,settings.columns[y].separator,settings.columns[y].newAllowed,settings.columns[y].confirmOnAdd,settings.columns[y].procName,settings.columns[y].onSelect );
                }
