...
namespace CargoFlashCargoWebApps.Controllers
{
    public class ClaimReportController : Controller
    {
        ...
        public ActionResult GetClaimReport(string Status, string fromdate, string todate, string ClaimType, int IsAutoProcess)
        {
            ...
            try
            {
                ...
                ds = CargoFlash.SoftwareFactory.Data.SqlHelper.ExecuteDataset(connectionString, System.Data.CommandType.StoredProcedure, "GetClaimReport_New", Parameters);
