...
{
    public class ChargesCollectController : Controller
    {
        //
        // GET: /ChargesCollect/
        ...
        public ActionResult GetChargesCollectReport([Kendo.Mvc.UI.DataSourceRequest]Kendo.Mvc.UI.DataSourceRequest request, string careerCode, string SHCSNo, string productSno, string CommoditySno, string OriginCitySno, string DestinationCitySno, string fromdate, string todate, string AWBNumber, string ReferenceNumber, string DateType)
        {
            ...
            try
            {
                ...
                ds = CargoFlash.SoftwareFactory.Data.SqlHelper.ExecuteDataset(connectionString, System.Data.CommandType.StoredProcedure, "ChargesCollectReport_GetRecord", Parameters);

                CommodityList = ds.Tables[0].AsEnumerable().Select(e => new ChargesCollect
                {
                    ...
                    ChargeCollect = e["ChargeCollect"].ToString().ToUpper(),
                    ReceivedPieces = e["ReceivedPieces"].ToString().ToUpper() + '/' + e["ReceivedGrossWeight"].ToString().ToUpper(),
                    DeliverdPieces = e["DeliverdPieces"].ToString().ToUpper() + '/' + e["DeliverdGrossWeight"].ToString().ToUpper(),
                    TotalPieces = e["TotalPieces"].ToString().ToUpper() + '/' + e["TotalGrossWeight"].ToString().ToUpper(),
            ...
            catch (Exception ex)
            {
                ...
                System.Data.SqlClient.SqlParameter[] ParametersError = { 
                                                                   new System.Data.SqlClient.SqlParameter("@ErrorMessage",ex.Message),
                                                                    new System.Data.SqlClient.SqlParameter("@ProcName","ChargesCollectReport_GetRecord"),
        ...
        public void GetChargesCollectReportForExcel([Kendo.Mvc.UI.DataSourceRequest]Kendo.Mvc.UI.DataSourceRequest request, string careerCode, string SHCSNo, string productSno, string CommoditySno, string OriginCitySno, string DestinationCitySno, string fromdate, string todate, string AWBNumber, string ReferenceNumber, string DateType)
        {
            ...
            System.Data.SqlClient.SqlParameter[] Parameters = {
                                                                   new System.Data.SqlClient.SqlParameter("@AirlineCarrierCode",careerCode),
                                                                   new System.Data.SqlClient.SqlParameter("@SHCSNo",Convert.ToString(SHCSNo)),
                                                                   new System.Data.SqlClient.SqlParameter("@productSno",Convert.ToInt32(productSno)),
                                                                   new System.Data.SqlClient.SqlParameter("@CommoditySno",Convert.ToInt32(CommoditySno)),
                                                                   new System.Data.SqlClient.SqlParameter("@OriginCitySno",Convert.ToInt32(OriginCitySno)),
                                                                   new System.Data.SqlClient.SqlParameter("@DestinationCitySno",Convert.ToInt32(DestinationCitySno)),
        ...
        public void ConvertDSToExcel_Success(DataTable dt, int mode)
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ChargesCollectReport_'" + date + "'.xlsx");
