...
Purpose:		    This JS used to get Tab for UserProfile.
...
$(document).ready(function () {
    ...
    cfi.ValidateForm();
    cfi.AutoCompleteV2("CitySNo", "CityName,CityCode", "Users_Usersprofile", null, "contains");
    cfi.AutoCompleteV2("AirportSNo", "AirportCode,AirportName", "Users_UsersAirport", null, "contains");
    cfi.AutoCompleteV2("WareHouseMasterSNo", "WarehouseName,AirportSNo", "Users_WarehouseMaster", null, "contains");
    cfi.AutoCompleteV2("AllowCitySNo", "CityName,CityCode", "Users_AllowCity", null, "contains", ",");
    cfi.AutoCompleteV2("LanguaugeSNo", "LanguaugeName", "Users_Language", null, "contains");
    cfi.AutoCompleteV2("MobileCountryCode", "MobileCountryCode", "Users_MobileCode", null, null, "contains");
    cfi.AutoCompleteV2("GroupSNo", "GroupName", "Users_GroupName", OnAdminChange, "contains");
        ...
        $('#tbl' + UserDoorRights).appendGrid({
           ...
           // deleteServiceMethod: 'DeleteUserDoorRights',
            ...
            columns: [{ name: 'SNo', type: 'hidden', value: '0' },                                                                                                                                                                                                           
                      ...
                      { name: 'CitySNo', display: 'City', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '100px', height: '20px' }, onChange: function (evt, rowIndex) { }, addOnFunction: "ClearAirportandWareHouseAndDoor(this.id);", isRequired: true, AutocompleteName: 'Users_Usersprofile', filterField: 'CityName', filterCriteria: "contains" },
                      { name: 'AirPortSNo', display: 'Airport Name', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '100px', height: '20px' }, onChange: function (evt, rowIndex) { }, addOnFunction: "ClearWareHouseAndDoor(this.id);", isRequired: true, AutocompleteName: 'Users_UsersAirport', filterField: 'AirportName', filterCriteria: "contains" },
                      { name: 'WareHouseMasterSNo', display: 'Warehouse Name', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '100px', height: '20px' }, onChange: function (evt, rowIndex) { }, addOnFunction: "ClearDoor(this.id);", isRequired: true, AutocompleteName: 'Users_WarehouseMaster', filterField: 'WarehouseName', filterCriteria: "contains", separator: null },
                      { name: 'BayMasterSNo', display: 'Door Name', type: 'text', ctrlAttr: { controltype: 'autocomplete' }, ctrlCss: { width: '150px', height: '20px' }, onChange: function (evt, rowIndex) { }, isRequired: false, AutocompleteName: 'Users_BayName', filterField: 'BayName',  filterCriteria: "contains", separator: "," },
