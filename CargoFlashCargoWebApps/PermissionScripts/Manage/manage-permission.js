        ...
        if ($(this).attr("SNo") == undefined) {
            if (true) {
                ...
                $(nextTr).find("div.k-grid-content").find("tr").each(function () {
                    var childPageObj = {};
                   // alert($(this).find("input[type='checkbox'][id$='chkRead']").prop('checked', true));
                    if (parseInt(groupSNo) != 0) {
                        ...
                        //if ($(this).find("input[type='checkbox'][id='chkCreate']").is(":checked") == true || $(this).find("input[type='checkbox'][id='chkEdit']").is(":checked") == true || $(this).find("input[type='checkbox'][id='chkDelete']").is(":checked") == true){
                            
                        //   // childPageObj.IsRead = $(this).find("input[type='checkbox'][id$='chkRead']").attr('checked', true);
                        //    childPageObj.IsRead = true;
                        //    childPageObj.IsReadSNo = $(this).find("input[type='hidden'][name$='SNo4']").val();
                        //}
                    }
...
function CreateRead(obj) {
    var self = $(obj);
    if ($(obj).is(':checked')) {
        self.closest('tr').find("input:checkbox[id$='chkRead']").attr('checked', true);
      //  $("input[type='checkbox'][id$='chkRead']").attr('checked', true);
        }
        
}
function UnCheckedByRead(obj) {
    var self = $(obj);
    
    //self.closest('tr').find("input:checkbox[id$='chkCreate']").attr('id', 'chkCreate_1')
    if ($(obj).is(':checked') == false) {
       
        self.closest('tr').find("input:checkbox[id$='chkCreate']").removeAttr('checked');
        self.closest('tr').find("input:checkbox[id$='chkEdit']").removeAttr('checked');
        self.closest('tr').find("input:checkbox[id$='chkDelete']").removeAttr('checked');
