...
namespace CargoFlash.Cargo.DataService.FlightControl
{
    ...
    public class FlightControlService : BaseWebUISecureObject, IFlightControlService
    {
        ...
        public Stream GetFCULDGridData(WebFormBuildWebFormRequest model)
        {
            return BuildWebForm(model.processName, model.moduleName, model.appName, "IndexView", CurrentFlightSno: model.DailyFlightSNo);
        }
                    ...
                    switch (processName)
                    {
                        ...
                        case "FLIGHTCONTROL":
                            ...
                            else if (appName.ToUpper().Trim() == "OSCLYING")
                            {
                                // CreateFlightLyingListSearch(myCurrentForm);
                                //  CreateFlightLyingGrid(myCurrentForm, FlightSNo);
                                CreateOSCFlightLyingGrid(myCurrentForm, OriginCity, DestinationCity, FlightNo, AWBNo, CarrierCode, FlightRoute, OffloadType: OffloadType, CurrentFlightSno: CurrentFlightSno);
                            ...
                            {
                                CreateManifestULDGrid(myCurrentForm, ProcessStatus, FlightSNo, CurrentProcessSNo);
                            ...
                            else if (appName.ToUpper().Trim() == "EDIMSG")
                            {
                                ...
                                CreateFCOffloadedULDGrid(myCurrentForm, CurrentProcessSNo, ULDStockSNo);
                            break;
                        case "FlIGHTARRIVAL":
        ...
        private void CreateFCOffloadedULDGrid(StringBuilder Container, string DailyFlightSNo, string ULDStockSNo)
        {
        ...
        {
            return BuildWebForm(processName, moduleName, appName, "IndexView", OriginCity: BoardingPoint, DestinationCity: EndPoint, FlightNo: FlightNo, SearchAirlineCarrierCode1: SearchAirlineCarrierCode1, FromFlightDate: FromFlightDate, ToFlightDate: ToFlightDate, AWBPrefix: "A~A", AWBNo: "A~A", LoggedInCity: LoggedInCity, FlightStatus: FlightStatus);
        }

        public Stream GetFlightTransGridData(string processName, string moduleName, string appName, string FlightSNo, string ProcessStatus = "", string CurrentProcessSNo = "")
        {
            return BuildWebForm(processName, moduleName, appName, "IndexView", FlightSNo: FlightSNo, ProcessStatus: ProcessStatus, CurrentProcessSNo: CurrentProcessSNo);
        }
        ...
        private void CreateFlightControlGrid(StringBuilder Container, string OriginCity = "", string DestinationCity = "", string FlightNo = "", string SearchAirlineCarrierCode1 = "", string FromFlightDate = "", string ToFlightDate = "", string FlightStatus = "", string LoggedInCity = "")
        {
            try
            {
                using (Grid g = new Grid())
                {
                    ...
                    g.IsAllowCopy = false;
                    g.DataSoruceUrl = "Services/FlightControl/FlightControlService.svc/GetFlightControlGridData";
                    g.NewURL = MyPageName + "?" + GetWebURLString("New", false);
                    g.ServiceModuleName = this.MyModuleID;
                    g.UserID = this.MyUserID;
                    ...
                    g.Column = new List<GridColumn>();
                    g.Column.Add(new GridColumn { Field = "SNo", Title = "SNo", IsHidden = true, DataType = GridDataType.Number.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsStack", Title = "IsStack", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsStopOver", Title = "IsStopOver", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsNILManifested", Title = "IsNILManifested", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsCargoTransfered", Title = "IsCargoTransfered", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsRFS", Title = "IsRFS", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsBuildup", Title = "IsBuildup", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsInternational", Title = "IsInternational", IsHidden = true, DataType = GridDataType.Boolean.ToString() });

                    g.Column.Add(new GridColumn { Field = "IsRFSFlightsEdit", Title = "IsRFSFlightsEdit", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsPreManifested", Title = "IsPreManifested", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsFlightClosed", Title = "IsFlightClosed", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "FlightType", Title = "FlightType", IsHidden = true, DataType = GridDataType.Number.ToString() });
                    ...
                    //g.Column.Add(new GridColumn { Field = "FlightDate", IsLocked = false, Title = "Flight Date", DataType = GridDataType.String.ToString(), Width = 60, Filterable = "false" });
                    g.Column.Add(new GridColumn { Field = "AirCraftSNo", IsLocked = false, IsHidden = true, Title = "AirCraftSNo", DataType = GridDataType.Number.ToString() });
                    ...
                    g.Column.Add(new GridColumn { Field = "IsNarrowBody", IsLocked = false, IsHidden = true, Title = "IsNarrowBody", DataType = GridDataType.Boolean.ToString(), Width = 70 });
                    g.Column.Add(new GridColumn { Field = "IsRegistrationAvailable", IsLocked = false, IsHidden = true, Title = "IsRegistrationAvailable", DataType = GridDataType.Boolean.ToString(), Width = 70 });


                    g.Column.Add(new GridColumn { Field = "FlightRoute", IsLocked = false, Title = "Flight Route ", DataType = GridDataType.String.ToString(), Width = 70, Template = "#= SearchRoute#" });
                    g.Column.Add(new GridColumn { Field = "BoardingPoint", IsLocked = false, IsHidden = true, Title = "Boarding Point", DataType = GridDataType.String.ToString(), Width = 60 });
                    g.Column.Add(new GridColumn { Field = "EndPoint", Title = "Off Point", IsHidden = true, DataType = GridDataType.String.ToString(), Width = 60 });
                    g.Column.Add(new GridColumn { Field = "STD", IsLocked = false, Title = "STD", DataType = GridDataType.String.ToString(), Width = 60 });
                    g.Column.Add(new GridColumn { Field = "ETD", IsLocked = false, Title = "ETD", DataType = GridDataType.String.ToString(), Width = 40 });
                    g.Column.Add(new GridColumn { Field = "ATD", IsLocked = false, IsHidden = false, Title = "ATD", DataType = GridDataType.String.ToString(), Width = 40 });
                    g.Column.Add(new GridColumn { Field = "ATDGMT", IsLocked = false, IsHidden = true, Title = "ATDGMT", DataType = GridDataType.String.ToString(), Width = 60 });
                    g.Column.Add(new GridColumn { Field = "ATDSystemTime", IsLocked = false, Title = "System Departure Time", DataType = GridDataType.String.ToString(), Width = 80, Filterable = "false" });
                    g.Column.Add(new GridColumn { Field = "ETA", IsHidden = true, Title = "ETA", DataType = GridDataType.String.ToString(), Width = 40 });
                    g.Column.Add(new GridColumn { Field = "DAY", Title = "Day Difference", IsHidden = true, DataType = GridDataType.String.ToString(), Width = 70, Format = "n" });
                    g.Column.Add(new GridColumn { Field = "ACType", Title = "A/C Type", IsHidden = false, DataType = GridDataType.String.ToString(), Width = 60 });
                    g.Column.Add(new GridColumn { Field = "CAO", Title = "CAO", IsHidden = false, DataType = GridDataType.String.ToString(), Width = 30 });
                    g.Column.Add(new GridColumn { Field = "FlightStatus", Title = "Flight Status", IsHidden = true, DataType = GridDataType.String.ToString(), Width = 50 });
                    g.Column.Add(new GridColumn { Field = "ViewFlightStatus", Title = "Flight Status", IsHidden = false, DataType = GridDataType.String.ToString(), Width = 50 });
                    g.Column.Add(new GridColumn { Field = "IsPAX", Title = "IsPAX", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "IsUWS", Title = "IsUWS", IsHidden = true, DataType = GridDataType.Boolean.ToString() });
                    g.Column.Add(new GridColumn { Field = "Booked_G_V_CBM", Title = "Booked Gross/Vol (Kgs)", Template = "<sapn title=\"#= Booked_G_V_CBM #\">#= Booked_G_V_CBM #</span>", DataType = GridDataType.String.ToString(), Width = 90,Sortable = "false", Filterable = "false" });
                    g.Column.Add(new GridColumn { Field = "Avilable_G_V_CBM", IsHidden = true, Title = "Available G/V/CBM", Template = "<sapn title=\"#= Avilable_G_V_CBM #\">#= Avilable_G_V_CBM #</span>", DataType = GridDataType.String.ToString(), Width = 110, Sortable = "false", Filterable = "false" });
                    g.Column.Add(new GridColumn { Field = "GroupFlightSNo", Title = "GroupFlightSNo", IsHidden = true, DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "RegistrationNo", Title = "RegistrationNo", IsHidden = true, DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "PartnerAirline", Title = "PartnerAirline", IsHidden = true, DataType = GridDataType.String.ToString() });
                    g.Column.Add(new GridColumn { Field = "FWDGroupSNo", Title = "FWDGroupSNo", IsHidden = true, DataType = GridDataType.String.ToString() });
                    ...
                    g.ExtraParam.Add(new GridExtraParam { Field = "SearchAirlineCarrierCode1", Value = SearchAirlineCarrierCode1 });
        ...
        private void CreateFlightAWBGrid(StringBuilder Container, string FlightSNo = "")
        {
            try
            {
                using (Grid g = new Grid())
                {
                    ...
                    g.IsAllowedSorting = false;
                    g.Column = new List<GridColumn>();
                    g.Column.Add(new GridColumn { Field = "isSelect", Title = "Select", Template = "# if(isSelect==true) {#<input type=\"checkbox\" id=\"chkbtnSelect\" value=\"#=isSelect#\" checked=\"1\"  disabled=\"Transit\"  onclick=\"MarkSelected(this);\"/><input type=\"hidden\" value=\"#=isHold#\" /># } else {#<input type=\"checkbox\" id=\"chkbtnSelect\" value=\"#=isSelect#\"  Transit  onclick=\"MarkSelected(this);\"/> <input type=\"hidden\" value=\"#=isHold#\" /># } #", DataType = GridDataType.Boolean.ToString(), Width = 40 });


                    g.Column.Add(new GridColumn { Field = "SNo", Title = "SNo", DataType = GridDataType.String.ToString(), IsHidden = true });
                    g.Column.Add(new GridColumn { Field = "AWBNo", Title = "AWB No", Template = "<sapn title=\"#= AWBNo #\">#= AWBNo #</span>", DataType = GridDataType.String.ToString(), Width = 90 });
                    g.Column.Add(new GridColumn { Field = "AWBSector", Title = "AWB Org/Dest", DataType = GridDataType.String.ToString(), Width = 90 });
                    g.Column.Add(new GridColumn { Field = "ShipmentType", Title = "Shipment Type", DataType = GridDataType.String.ToString(), Width = 90 });
                    g.Column.Add(new GridColumn { Field = "AWBReferenceBookingSNo", Title = "AWBReferenceBookingSNo", IsHidden = true, DataType = GridDataType.String.ToString(), Width = 70 });
                    ...
                    g.Column.Add(new GridColumn { Field = "Agent", Title = "FRWDR(Agent)", Template = "<sapn title=\"#= Agent #\">#= Agent #</span>", DataType = GridDataType.String.ToString(), Width = 65 });
                    ...
                    g.Column.Add(new GridColumn { Field = "FPSNo", Title = "FPSNo", DataType = GridDataType.String.ToString(), IsHidden = true });
                    g.Column.Add(new GridColumn { Field = "McBookingSNo", Title = "McBookingSNo", DataType = GridDataType.String.ToString(), IsHidden = true });
                    ...
                    g.Column.Add(new GridColumn { Field = "HDQRemarks", Title = "HDQ", Template = "# if(HDQRemarks==\"HDQ\"){#<a onclick=\"fun_HDQRemarks(this,1);\"  style=\"cursor:pointer;color:red;\" >#=HDQRemarks#</a> #} else{#<label>#=HDQRemarks#</label> #}  #  ", DataType = GridDataType.String.ToString(), Width = 60 });
        ...
        private void CreateOSCFlightLyingGrid(StringBuilder Container, string OriginCity = "", string DestinationCity = "", string FlightNo = "", string AWBNo = "", string CarrierCode = "", string FlightRoute = "", string OffloadType = "", string CurrentFlightSno = "")
        {
            try
            {
                using (Grid g = new Grid())
                {
                    ...
                    g.Column.Add(new GridColumn { Field = "FlightNo", Title = "FlightNo", DataType = GridDataType.String.ToString(), Width = 70 });
                    g.Column.Add(new GridColumn { Field = "FlightDate", Title = "Flight Date", IsHidden = false, DataType = GridDataType.Date.ToString(), Width = 60, Template = "# if( FlightDate==null) {# # } else {# #= kendo.toString(new Date(data.FlightDate.getTime() + data.FlightDate.getTimezoneOffset()*60000),\"" + UIDateTimeFormat.UIDateFormatString + "\") # #}#", Filterable = "false" });

                    g.Column.Add(new GridColumn { Field = "AWBSector", Title = "AWB Sector", DataType = GridDataType.String.ToString(), Width = 70 });
                    g.Column.Add(new GridColumn { Field = "ShipmentType", Title = "Shipment Type", DataType = GridDataType.String.ToString(), Width = 70 });
                    ...
                    g.Column.Add(new GridColumn { Field = "HOLDRemarks", Title = "HOLDRemarks", DataType = GridDataType.String.ToString(), IsHidden = true });
                    g.Column.Add(new GridColumn { Field = "FPSNo", Title = "FPSNo", DataType = GridDataType.Number.ToString(), IsHidden = true });
                    g.Column.Add(new GridColumn { Field = "McBookingSNo", Title = "McBookingSNo", DataType = GridDataType.Number.ToString(), IsHidden = true });
                    // g.Column.Add(new GridColumn { Field = "Commodity", Title = "Commodity", DataType = GridDataType.String.ToString(), Width = 50 });
        ...
        private void CreateManifestULDGrid(StringBuilder Container, string ProcessStatus, string FlightSNo = "", string CurrentProcessSNo = "")
        {
            try
            {
                using (NestedGrid g = new NestedGrid())
                {
                    ...
                    g.AppsName = this.MyAppID;
                    g.DefaultPageSize = 1000;
                    g.DataSoruceUrl = "Services/FlightControl/FlightControlService.svc/GetManifestULDGridData";
                    g.PrimaryID = "ULDStockSNo";
                    g.NewURL = MyPageName + "?" + GetWebURLString("New", false);
                    g.ModuleName = this.MyModuleID;
                    g.FormCaptionText = "ULD Details";
                    ...
                    g.Column.Add(new GridColumn { Field = "ULDStockSNo", Title = "ULD No", IsHidden = true, DataType = GridDataType.Number.ToString() });
                    g.Column.Add(new GridColumn { Field = "ULDNo", Title = "ULD Nbr/CART Nbr", IsHidden = false, DataType = GridDataType.String.ToString() });
                    ...
                    g.NestedDataSoruceUrl = "Services/FlightControl/FlightControlService.svc/GetMULDShipmentGridData";
                    g.NestedColumn = new List<GridColumn>();
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "ShipmentType", Title = "Shipment Type", DataType = GridDataType.String.ToString(), Width = 70, Filterable = "false" });
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "ActG_V_CBM", Title = "Actual G/V/CBM", Template = "<sapn title=\"#= ActG_V_CBM #\">#= ActG_V_CBM #</span>", DataType = GridDataType.String.ToString(), Width = 110, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "PlannedPieces", Title = "Planned Pieces", Template = "#if(IsBulk!=0 && IsCart==false){#<input type=\"text\" id=\"txt_PlannedPieces\" value=\"#=PlannedPieces#\" style=\"width:50%;\" MaxLength=\"5\" onkeyup=\"fn_CalPRE_Man_GVCBM(this);\" onblur=fn_ResetPre_Man(this);fn_GetPOMAilDNDetails(this,#=TotalPPcs#,#=ULDStockSNo#,#=McBookingSNo#,\"" + ProcessStatus + "\"); />#}else{##=PlannedPieces##}#", DataType = GridDataType.Number.ToString(), Width = 70, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "PlanG_V_CBM", Title = "Planned G/V/CBM", Template = "#if(IsBulk!=0  && IsCart==false){#<input type=\"text\" id=\"txtPG\" value=\"#=PG#\" MaxLength=\"7\" style=\"width:25%;\"  onkeyup=\"fn_CheckNum(this);fn_Cal_GVCBMOnPRE_MAN(this);\" onblur=\"fn_ResetPre_Man(this);\" />/<input type=\"text\" id=\"txtPV\" value=\"#=PV#\" style=\"width:25%;\" MaxLength=\"9\"  onkeyup=\"fn_CheckNum(this);fn_Cal_GVCBMOnPRE_MAN(this);\" onblur=\"fn_ResetPre_Man(this);\" />/<input type=\"text\" id=\"txtPCBM\" value=\"#=PCBM#\" style=\"width:25%;\" MaxLength=\"9\" onkeyup=\"fn_CheckNum(this);fn_Cal_GVCBMOnPRE_MAN(this);\" onblur=\"fn_ResetPre_Man(this);\" />#}else{##=PlanG_V_CBM##}#", DataType = GridDataType.String.ToString(), Width = 130, Filterable = "false" });
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "McBookingSNo", Title = "McBookingSNo", DataType = GridDataType.Number.ToString(), IsHidden = true });
                    g.NestedColumn.Add(new GridColumn { Field = "IsChanged", Title = "IsChanged", DataType = GridDataType.Boolean.ToString(), IsHidden = true });
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "AWBOffPoint", Title = "Off Point", FixTooltip = "Off Point", Template = "#if(ULDStockSNo==0 || IsCart==true){# <input type=\"hidden\" name=\"AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\" id=\"AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\"  id=\"Text_AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" /> #}else{#<input type=\"hidden\" name=\"AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\" id=\"AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\"  id=\"Text_AWBOffPoint_#=ULDStockSNo#_#=AWBSNo#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" style=\"display:none\" />#}#", DataType = GridDataType.String.ToString(), Width = 75, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "IsCTM", Title = "Charges", IsHidden = true, DataType = GridDataType.Boolean.ToString(), Template = "#if(IsCTM==true){#<input type=\"button\" value=\"C\" style=\"#=ChargeCSS#\" onclick=\"fn_GetCTMChargeDetails(#=AWBSNo#,#=CTMSNo#,this,1);\" title=\"#=ChargesRemarks#\">#}#", Width = 35, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "RFSRemarks", Title = "Remarks", Template = "#if(ULDStockSNo==0){ if(RFSRemarks!=\"\"){ #<input type=\"button\" value=\"R\" class=\"completeprocess\" onclick=fn_GetSetULDAWBRemarks(\"A\",#=AWBSNo#,this); /><input type=hidden id=\"hdnRFSRemarks\" value=\"#=RFSRemarks#\" > #}else{ #<input type=\"button\" value=\"R\" onclick=fn_GetSetULDAWBRemarks(\"A\",#=AWBSNo#,this); /><input type=hidden id=\"hdnRFSRemarks\" value=\"#=RFSRemarks#\" > #} }else{##}#", DataType = GridDataType.String.ToString(), Width = 35, Filterable = "false", IsHidden = true });
                    g.NestedColumn.Add(new GridColumn { Field = "HDQRemarks", Title = "HDQ", Template = "# if(HDQRemarks==\"HDQ\"){#<a onclick=\"fun_HDQRemarks(this,2);\"  style=\"cursor:pointer;color:red;\" >#=HDQRemarks#</a> #} else{#<label>#=HDQRemarks#</label> #}  #  ", DataType = GridDataType.String.ToString(), Width = 60 });
                    if (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["IsMandetoryOffloadRemarks"].ToString().ToLower() == "true" && CurrentProcessSNo == "34")
                    {
                        g.NestedColumn.Add(new GridColumn { Field = "IsOffloadRemarks", Title = "Offload Remarks", Template = "#if(ULDStockSNo==0){#<input type=\"button\" value=\"Offload Remarks\" onclick=fn_GetSetOffloadRemarks(\"A\",#=AWBSNo#,this); />#}else{##}#", DataType = GridDataType.Boolean.ToString(), Width = 100 });
                    }
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "IsCart", Title = "IsCart", DataType = GridDataType.Boolean.ToString(), IsHidden = true });
                    g.NestedColumn.Add(new GridColumn { Field = "DailyFlightSNo", Title = "DailyFlightSNo", DataType = GridDataType.Number.ToString(), IsHidden = true });

                    g.NestedExtraParam = new List<NestedGridExtraParam>();
                    g.NestedExtraParam.Add(new NestedGridExtraParam { Field = "FlightSNo", Value = FlightSNo });
                    g.NestedExtraParam.Add(new NestedGridExtraParam { Field = "ProcessStatus", Value = ProcessStatus });
                    g.NestedExtraParam.Add(new NestedGridExtraParam { Field = "CurrentProcessSNo", Value = CurrentProcessSNo });
                    g.InstantiateIn(Container);
                }
            }
            catch (Exception ex)//(Exception ex)
        ...
        private void CreateOSCFlightLyingULDGrid(StringBuilder Container, string OriginCity = "", string DestinationCity = "", string ULDStockSNo = "", string CarrierCode = "", string FlightRoute = "", string OffloadType = "", string AWBNo = "")
        {
            try
            {
                using (NestedGrid g = new NestedGrid())
                {
                    ...
                    // g.Column.Add(new GridColumn { Field = "Status", Title = "Status", IsHidden = false, DataType = GridDataType.String.ToString()});
                    g.Column.Add(new GridColumn { Field = "RFSRemarks", Title = "Remarks", Template = "#if(ULDStockSNo>0){#<input type=\"button\" value=\"R\" onclick=fn_GetSetULDAWBRemarks(\"U\",#=ULDStockSNo#,this); /><input type=hidden id=\"hdnRFSRemarks\" value=\"#=RFSRemarks#\" >#}else{##}#", DataType = GridDataType.String.ToString(), Width = 70, IsHidden = true });
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "PlannedPieces", Title = "Plan Pieces", Template = "#if(IsBulk!=0){#<input type=\"text\" id=\"txt_PlannedPieces\" value=\"#=PlannedPieces#\" MaxLength=\"5\" style=\"width:50%;\" onkeyup=\"fn_CalculateOLCGVCBM(this);\"  onblur=fn_CalculateOLCGVCBM(this);fn_ResetOLCPcs(this);fn_GetPOMAilDNDetails(this,#=OLCPieces#,#=ULDStockSNo#,#=McBookingSNo#,\"OFLD\"); />#}else{##=PlannedPieces##}#", DataType = GridDataType.Number.ToString(), Filterable = "false" });
                    ...
                    //g.NestedColumn.Add(new GridColumn { Field = "AWBOffPoint", Title = "Off Point", FixTooltip = "Off Point", Template = "#if(ULDStockSNo==0){#<input type=\"hidden\" name=\"AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" id=\"AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  id=\"Text_AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" />#}else{#<input type=\"hidden\" name=\"AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" id=\"AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  id=\"Text_AWBOffPoint_OSC_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" style=\"display:none;\" />#}#", DataType = GridDataType.String.ToString(), Width = 75, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "AWBOffPoint", Title = "Off Point", FixTooltip = "Off Point", Template = "#if(ULDStockSNo==0){#<input type=\"hidden\" name=\"#=AWBOffPointId#\" id=\"#=AWBOffPointId#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_#=AWBOffPointId#\"  id=\"Text_#=AWBOffPointId#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" />#}else{#<input type=\"hidden\" name=\"#=AWBOffPointId#\" id=\"#=AWBOffPointId#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_#=AWBOffPointId#\"  id=\"Text_#=AWBOffPointId#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" style=\"display:none;\" />#}#", DataType = GridDataType.String.ToString(), Width = 75, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "IsCTM", Title = "Charges", IsHidden = true, DataType = GridDataType.Boolean.ToString(), Template = "#if(IsCTM==true){#<input type=\"button\" value=\"C\" style=\"#=ChargeCSS#\" onclick=\"fn_GetCTMChargeDetails(#=AWBSNo#,#=CTMSNo#,this,3);\" title=\"#=ChargesRemarks#\">#}#", Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "RFSRemarks", Title = "Remarks", Template = "#if(ULDStockSNo==0){#<input type=\"button\" value=\"R\" onclick=fn_GetSetULDAWBRemarks(\"A\",#=AWBSNo#,this); /><input type=hidden id=\"hdnRFSRemarks\" value=\"#=RFSRemarks#\" > #}else{##}#", DataType = GridDataType.String.ToString(), Width = 35, Filterable = "false", IsHidden = true });
        ...
        private void CreateManifestLyingULDGrid(StringBuilder Container, string OriginCity = "", string DestinationCity = "", string ULDStockSNo = "", string CarrierCode = "", string FlightRoute = "", string OffloadType = "", string AWBNo = "")
        {
            try
            {
                using (NestedGrid g = new NestedGrid())
                {
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "OLCPieces", Title = "OFLD Pieces", DataType = GridDataType.String.ToString(), Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "ActG_V_CBM", Title = "Actual G/V/CBM", Template = "<sapn title=\"#= ActG_V_CBM #\">#= ActG_V_CBM #</span>", DataType = GridDataType.String.ToString(), Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "PlannedPieces", Title = "Plan Pieces", Template = "#if(IsBulk!=0){#<input type=\"text\" id=\"txt_PlannedPieces\" value=\"#=PlannedPieces#\" style=\"width:50%;\" MaxLength=\"5\" onkeyup=\"fn_CalculateOLCGVCBM(this);\"  onblur=fn_CalculateOLCGVCBM(this);fn_ResetOLCPcs(this);fn_GetPOMAilDNDetails(this,#=OLCPieces#,#=ULDStockSNo#,#=McBookingSNo#,\"OFLD\");  />#}else{##=PlannedPieces##}#", DataType = GridDataType.Number.ToString(), Filterable = "false" });
                    ...
                    g.NestedColumn.Add(new GridColumn { Field = "Agent", Title = "FRWDR(Agent)", DataType = GridDataType.String.ToString(), Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "Priority", Title = "Priority", DataType = GridDataType.String.ToString(), Filterable = "false" });
                    //g.NestedColumn.Add(new GridColumn { Field = "AWBOffPoint", Title = "Off Point", FixTooltip = "Off Point", Template = "#if(ULDStockSNo==0){#<input type=\"hidden\" name=\"AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" id=\"AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  id=\"Text_AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" />#}else{#<input type=\"hidden\" name=\"AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" id=\"AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  id=\"Text_AWBOffPoint_ML_#=CarrierCode#_#=ULDStockSNo#_#=AWBSNo#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" style=\"display:none;\" />#}#", DataType = GridDataType.String.ToString(), Width = 75, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "AWBOffPoint", Title = "Off Point", FixTooltip = "Off Point", Template = "#if(ULDStockSNo==0){#<input type=\"hidden\" name=\"#=AWBOffPointId#\" id=\"#=AWBOffPointId#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_#=AWBOffPointId#\"  id=\"Text_#=AWBOffPointId#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" />#}else{#<input type=\"hidden\" name=\"#=AWBOffPointId#\" id=\"#=AWBOffPointId#\" value=\"#=AWBOffPoint#\" /><input type=\"text\" class=\"\" name=\"Text_#=AWBOffPointId#\"  id=\"Text_#=AWBOffPointId#\"  controltype=\"autocomplete\"   maxlength=\"10\" data-width=\"65px\" value=\"#=AWBOffPoint#\" placeholder=\"Off Point\" style=\"display:none;\" />#}#", DataType = GridDataType.String.ToString(), Width = 75, Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "IsCTM", Title = "Charges", IsHidden = true, DataType = GridDataType.Boolean.ToString(), Template = "#if(IsCTM==true){#<input type=\"button\" value=\"C\" style=\"#=ChargeCSS#\" onclick=\"fn_GetCTMChargeDetails(#=AWBSNo#,#=CTMSNo#,this,2);\" title=\"#=ChargesRemarks#\">#}#", Filterable = "false" });
                    g.NestedColumn.Add(new GridColumn { Field = "RFSRemarks", Title = "Remarks", Template = "#if(ULDStockSNo==0){#<input type=\"button\" value=\"R\" onclick=fn_GetSetULDAWBRemarks(\"A\",#=AWBSNo#,this); /><input type=hidden id=\"hdnRFSRemarks\" value=\"#=RFSRemarks#\" > #}else{##}#", DataType = GridDataType.String.ToString(), Width = 35, Filterable = "false", IsHidden = true });
                    //g.NestedColumn.Add(new GridColumn { Field = "ULDType", Title = "ULD Type", Template = " <select id=\"SULDType\" ></select><input type=\"hidden\" value=\"#=ULDType#\"/>", DataType = GridDataType.String.ToString(), Width = 60 });
                    // g.NestedColumn.Add(new GridColumn { Field = "ULDGroupNo", Title = "Group No", DataType = GridDataType.String.ToString(), Width = 60 });
                    g.NestedExtraParam = new List<NestedGridExtraParam>();
        ...
        public string UpdateTransferFlight(string OLDGroupFlightSNo, string NewDailyFlightSno, string OFLD_AWBSNo, string TR_AWBSNo, string OFLD_MCBookingSNo, string TR_MCBookingSNo, string TR_UldStockSNo, string OFLD_UldStockSNo, int ProcessType, bool IsDataPushToPlan, bool IsStopOverCargo, bool IsULDOFLD, string OffloadRemarks)//1- for transfer offload and create Nill,2-Only Transfer 
        {
            SqlParameter[] Parameters = { new SqlParameter("@OLDGroupFlightSNo", OLDGroupFlightSNo), new SqlParameter("@NewDailyFlightSno", NewDailyFlightSno), new SqlParameter("@OFLD_AWBSNo", OFLD_AWBSNo), new SqlParameter("@TR_AWBSNo", TR_AWBSNo),
                                            new SqlParameter("@OFLD_MCBookingSNo", OFLD_MCBookingSNo), new SqlParameter("@TR_MCBookingSNo", TR_MCBookingSNo), new SqlParameter("@TR_UldStockSNo", TR_UldStockSNo), new SqlParameter("@OFLD_UldStockSNo", OFLD_UldStockSNo)
                                            , new SqlParameter("@ProcessType", ProcessType), new SqlParameter("@IsDataPushToPlan", IsDataPushToPlan), new SqlParameter("@OffloadRemarks", OffloadRemarks), new SqlParameter("@IsStopOverCargo", IsStopOverCargo), new SqlParameter("@IsULDOFLD", IsULDOFLD),
                                            new SqlParameter("@UpdatedBy", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).UserSNo.ToString()),new SqlParameter("@LoginAirportSNo", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).AirportSNo.ToString()) };
            DataSet ds = new DataSet();
            try
            {
        ...
        // Login Airport in LoggedInCity Parameter
        public DataSourceResult GetFlightControlGridData(string OriginCity, String DestinationCity, String FlightNo, string SearchAirlineCarrierCode1, string FromFlightDate, string ToFlightDate, string FlightStatus, string LoggedInCity, int skip, int take, int page, int pageSize, List<SoftwareFactory.Data.GridSort> sort, SoftwareFactory.Data.GridFilter filter)
        {
            try
            {
                ...
                ProcName = "GetListWMSFlightControl";       //for testing GetListWMSFlightControlTest_n
                ...
                var wmsFlightControlList = ds.Tables[0].AsEnumerable().Select(e => new WMSFlightControlGridData
                {
                    SNo = Convert.ToInt32(e["SNo"]),
                    RegistrationNo = e["RegistrationNo"].ToString(),
                    ...
                    ATDSystemTime = e["ATDSystemTime"].ToString(),
                    FlightType = Convert.ToInt32(e["FlightType"]),
                    ...
                    ViewFlightStatus = e["ViewFlightStatus"].ToString(),
                    ...
                    STD = e["STD"].ToString(),
                    ATD = e["ATD"].ToString(),
                    ATDGMT = e["ATDGMT"].ToString() == "" ? "" : Convert.ToDateTime(e["ATDGMT"].ToString()).ToString(DateFormat.DateFormatString),
                    IsStack = Convert.ToBoolean(e["IsStack"]),
                    IsNarrowBody = Convert.ToBoolean(e["IsNarrowBody"]),
                    IsStopOver = Convert.ToBoolean(e["IsStopOver"]),
                    AirCraftSNo = Convert.ToInt32(e["AirCraftSNo"]),
                    IsRegistrationAvailable = Convert.ToBoolean(e["IsRegistrationAvailable"]),
                    IsNILManifested = Convert.ToBoolean(e["IsNILManifested"]),
                    IsRFS = Convert.ToBoolean(e["IsRFS"]),
                    IsBuildup = Convert.ToBoolean(e["IsBuildup"]),
                    IsPreManifested = Convert.ToBoolean(e["IsPreManifested"]),
                    IsFlightClosed = Convert.ToBoolean(e["IsClosed"]),
                    IsRFSFlightsEdit = Convert.ToBoolean(e["IsRFSFlightsEdit"]),
                    ProcessStatus = Convert.ToString(e["ProcessStatus"]),
                    FlightRoute = e["FlightRoute"].ToString(),
                    IsPAX = Convert.ToBoolean(e["IsPAX"]),
                    IsUWS = Convert.ToBoolean(e["IsUWS"]),
                    SearchRoute = e["SearchRoute"].ToString(),
                    ...
                    PartnerAirline = e["PartnerAirline"].ToString(),
                    IsCargoTransfered = Convert.ToBoolean(e["IsCargoTransfered"]),
                    IsInternational = Convert.ToBoolean(e["IsInternational"]),
                    FWDGroupSNo = e["FWDGroupSNo"].ToString()
                    ...
                    //AvilableCBMWeight = Convert.ToDecimal(e["AvilableCBMWeight"]),
        ...
        public DataSourceResult GetWMSFlightAWBGridData(string FlightSNo, int skip, int take, int page, int pageSize, List<SoftwareFactory.Data.GridSort> sort, SoftwareFactory.Data.GridFilter filter)
        {
            try
            {
                ...
                SqlParameter[] Parameters = { new SqlParameter("@PageNo", page), new SqlParameter("@PageSize", pageSize), new SqlParameter("@WhereCondition", filters), new SqlParameter("@OrderBy", sorts), new SqlParameter("@FlightSNo", FlightSNo), new SqlParameter("@UserSNo", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).UserSNo.ToString()) };
                ...
                var wmsFlightAWBList = ds.Tables[0].AsEnumerable().Select(e => new WMSFlightAWBGridData
                {
                    ...
                    AWBReferenceBookingSNo = Convert.ToInt32(e["AWBReferenceBookingSNo"]),
                    HDQRemarks = Convert.ToString(e["HDQRemarks"]),
                    Transit = Convert.ToString(e["Transit"])
        ...
        public DataSourceResult GetOSCLyingListGridData(string OriginCity, String DestinationCity, String FlightNo, string AWBNo, string CarrierCode, string FlightRoute, string OffloadType, string CurrentFlightSno, int skip, int take, int page, int pageSize, List<SoftwareFactory.Data.GridSort> sort, SoftwareFactory.Data.GridFilter filter)
        {
            try
            {
                ...
                SqlParameter[] Parameters = { new SqlParameter("@PageNo", page), new SqlParameter("@PageSize", pageSize), new SqlParameter("@WhereCondition", filters), new SqlParameter("@OrderBy", sorts), new SqlParameter("@OriginCity", OriginCity), new SqlParameter("@DestinationCity", DestinationCity), new SqlParameter("@FlightNo", FlightNo), new SqlParameter("@AWBNo", AWBNo), new SqlParameter("@CarrierCode", CarrierCode), new SqlParameter("@FlightRoute", FlightRoute), new SqlParameter("@OffloadType", OffloadType), new SqlParameter("@CurrentFlightSno", CurrentFlightSno), new SqlParameter("@LoggedInAirport", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).AirportCode.ToString()), new SqlParameter("@UserSNo", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).UserSNo.ToString()) };
        ...
        public string SaveMenifestInformation(List<BulkShipment> BulkShipmentInfo, List<IntectShipment> IntectShipmentInfo, List<BulkShipment> LyingBulkShipmentInfo, List<IntectShipment> LyingIntectShipmentInfo, List<BulkShipment> OSCLyingBulkShipmentInfo, List<IntectShipment> OSCLyingIntectShipmentInfo, List<POMailDNDetails> POMailDNDetailsInfo, int FlightType, Int64 FlightSNo, string RegistrationNo, string mode, string ATDDate, string ATDTime, bool IsExcludeFromFFM, List<OffloadRemarksDetails> OffloadRemarks)
        {
            ...
            DataTable dtPOMailDNDetailsInfo = CollectionHelper.ConvertTo(POMailDNDetailsInfo, "");
            BaseBusiness baseBusiness = new BaseBusiness();
            ...
            SqlParameter paramPOMailDNDetailsInfo = new SqlParameter();
            paramPOMailDNDetailsInfo.ParameterName = "@POMailDNDetailsInfo";
            paramPOMailDNDetailsInfo.SqlDbType = System.Data.SqlDbType.Structured;
            paramPOMailDNDetailsInfo.Value = dtPOMailDNDetailsInfo;

            SqlParameter[] Parameters = { paramBulkShipmentInfo, paramIntectShipmentInfo, paramLyingBulkShipmentInfo, paramLyingIntectShipmentInfo, paramOSCLyingBulkShipmentInfo, paramOSCLyingIntectShipmentInfo, paramPOMailDNDetailsInfo, new SqlParameter("@FlightType", FlightType), new SqlParameter("@FlightSNo", FlightSNo), new SqlParameter("@RegistrationNo", RegistrationNo), new SqlParameter("@mode", mode), new SqlParameter("@ATDDate", ATDDate), new SqlParameter("@ATDTime", ATDTime), new SqlParameter("@IsExcludeFromFFM", IsExcludeFromFFM), new SqlParameter("@LoginAirportSNo", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).AirportSNo.ToString()), new SqlParameter("@UpdatedBy", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).UserSNo.ToString()), new SqlParameter("@OffloadRemarks", JsonConvert.SerializeObject(OffloadRemarks)) };
            ...
            try
            {
                ...
                else if (msg == "0?0" && mode == "DEP")
                {
                    CommonService.SaveFlightSubProcessTrans(FlightSNo, 6, 2112, true, null);
                }
                ////////////////////////////////////////////////////////////////////////
                return ds.Tables[ds.Tables.Count - 1].Rows[0][0].ToString();
            }
        ...
        public string GetG9LIReport(string DailyFlightSNo)
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo) };
        ...
        /// <summary>
        /// Added by karan for LiversionPrint
        /// </summary>
        /// <param name="ds"></param>
        /// <returns></returns>
        public Stream GetLIReportForLiversion(string DailyFlightSNo)
        {
            int Liversion = Convert.ToInt32(DailyFlightSNo.Split(',')[1]);
            string Dfsno = DailyFlightSNo.Split(',')[0].ToString();
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", Dfsno), new SqlParameter("@Liversion", Liversion) };

                DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "LIReportForLiVersion", Parameters);
                byte[] resultBytes = Encoding.UTF8.GetBytes(GetLIReportHTML(ds));
                WebOperationContext.Current.OutgoingResponse.ContentType = "text/html";
                return new MemoryStream(resultBytes);
            }
        ...
        public string GetReportHTML(DataSet ds)
        {
            try
            {
                ...
                {
                    string logo = ds.Tables[2].Rows[0][0].ToString();
                    ...
                    tbl.Append("<tr align=\"center\"><td colspan=\"9\" ><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='90px' onError='this.onerror=null;this.src=\"" + logo + "\";' /></td></tr> ");
                    tbl.Append("<tr align=\"center\"><td colspan=\"9\" ><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO PRE MANIFEST") + "</h2></td></tr> ");
                        ...
                        if (drRpt.Length > 0)
                        {
                            ...
                            if (drLocal.Length > 0)
                            {
                                ...
                                foreach (DataRow dr in drLocal)
                                {
                                    ...
                                    tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + j.ToString() + "</td><td colspan=\"1\" >" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" >" + dr["Remarks"] + "</td><td colspan=\"1\"></td></tr>");
                                    j++;
                                }
                            }
                            if (drTrans.Length > 0)
        ...
        public string GetLIReportHTML(DataSet ds)
        {
            try
            {
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string[] logopath = logo.Split('/');
                    logo = logopath[3] + "/" + logopath[4];
                    tbl.Append("<table id=\"tblReport\" align=\"center\" border=\"1\" width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");

                    tbl.Append("<tr align=\"center\"><td colspan=\"14\" ><img src='../BLOBUploadAndDownload/DownloadFromBlob?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width=\"300px\" height=\"90px\" onError='this.onerror=null;this.src=\"" + logo + "\";' /></td></tr> ");

                    tbl.Append("<tr align=\"center\"><td colspan=\"14\"><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO LOADING INSTRUCTION") + "</h2></td></tr> ");
                    ...
                    tbl.Append("<tr align=\"center\"><td colspan=\"3\" align=\"left\">Owner or Operator</td><td  align=\"left\" colspan=\"2\" >" + ds.Tables[0].Rows[0]["airlinename"].ToString() + "</td><td  colspan=\"2\" align=\"left\" >Aircraft Reg no</td><td colspan=\"2\" align=\"left\" >" + ds.Tables[0].Rows[0]["REGISTRATIONNO"].ToString() + "</td><td colspan=\"3\" align=\"left\" >Routing</td><td colspan=\"2\"  align=\"left\"  >" + ds.Tables[0].Rows[0]["Route"].ToString() + "</td></tr>");


                    tbl.Append("<tr align=\"center\"><td colspan=\"3\" align=\"left\">Flight Number</td><td  align=\"left\" colspan=\"2\">" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "</td><td  colspan=\"2\" align=\"left\">Flight Date</td><td colspan=\"2\" align=\"left\">" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yy") + "</td><td colspan=\"3\" align=\"left\" >STD</td><td colspan=\"2\"  align=\"left\" >" + ds.Tables[0].Rows[0]["SUB"].ToString() + "</td></tr>");

                    //tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Flight Number</td><td align=\"left\" >" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "</td><td align=\"left\" colspan=\"2\" >Flight Date</td><td >" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yy") + "</td><td colspan=\"2\" >&nbsp;Point Of Loading</td><td  >" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td></tr>");



                    tbl.Append("<tr align=\"center\"><td colspan=\"3\" align=\"left\">Point Of Loading</td><td align=\"left\" colspan=\"2\">" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"2\" align=\"left\">Point Of Unloading</td><td   colspan=\"2\" align=\"left\">" + ds.Tables[0].Rows[0]["FlightDestination"].ToString() + "</td><td colspan=\"3\" align=\"left\">LI Versions</td><td   colspan=\"2\"  align=\"left\" >" + ds.Tables[0].Rows[0]["LIVersion"].ToString() + "</td></tr>");


                    tbl.Append("<tr align=\"center\"><td colspan=\"3\" align=\"left\">Flight Capacity </td><td align=\"left\" colspan=\"2\">" + ds.Tables[0].Rows[0]["GrossWeightCap"].ToString() + "/" + ds.Tables[0].Rows[0]["UsedVolume"].ToString() + "</td><td colspan=\"2\" align=\"left\">Created By</td><td   colspan=\"2\" align=\"left\">" + ds.Tables[0].Rows[0]["CreatedBy"].ToString() + "</td><td colspan=\"3\" align=\"left\"></td><td   colspan=\"2\"></td></tr>");



                    //tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\"></td><td colspan=\"2\" >Point Of Unloading</td><td  >" + ds.Tables[0].Rows[0]["FlightDestination"].ToString() + "</td><td colspan=\"6\" >&nbsp;</td></tr>");

                    tbl.Append("<tr align=\"center\"><td colspan=\"4\">Pallet/ULD No</br>Local Transit</td><td colspan=\"10\">For use by owner/operator</td></tr>");

                    tbl.Append("<tr align=\"center\"><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">No</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Air Waybill and part No</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">No of Pieces</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Nature of Goods</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Gross Weight</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Total volume </td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Agent </td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Product </td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">ORI/DES</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">SHC</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Priority</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Location</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Remarks</td><td colspan=\"1\" style=\"background-color:gray;\" class=\"grdTableHeader\">Office Use</td></tr>");
                    ...
                    foreach (DataRow drDistinctULD in dtDistinctULD.Rows)
                    {
                        ...
                        if (drRpt.Length > 0)
                        {
                            ...
                            tbl.Append("<tr align=\"left\" class=\"grdTableRow\"><td colspan=\"14\" >" + drDistinctULD["ULDType"] + "</td></tr>");

                            uldtype += " " + drDistinctULD["ULDType"].ToString();
                            if (drLocal.Length > 0)
                            {
                                int j = 1;
                                foreach (DataRow dr in drLocal)
                                {
                                    if (j == 1)
                                    {
                                        tbl.Append("<tr align=\"left\" class=\"grdTableRow\"><td colspan=\"14\" >COMMERCIAL CARGO/LOCAL CARGO</td></tr>");
                                    }
                                    tbl.Append("<tr align=\"center\" class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + j.ToString() + "</td><td colspan=\"1\" >" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedVolumeWeight"].ToString() + "</td><td colspan=\"1\">" + dr["Name"].ToString() + "</td><td colspan=\"1\">" + dr["ProductName"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" >" + dr["WHLocation"] + "</td><td colspan=\"1\" >" + dr["Remarks"] + "</td><td colspan=\"1\"></td></tr>");
                                    j++;
                                }
                            }
                            if (drTrans.Length > 0)
                            {
                                ...
                                foreach (DataRow dr in drTrans)
                                {
                                    if (k == 1)
                                    {
                                        tbl.Append("<tr align=\"left\" class=\"grdTableRow\"><td colspan=\"14\" >COMMERCIAL CARGO/TRANSIT</td></tr>");
                                    }
                                    tbl.Append("<tr align=\"center\" class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + k.ToString() + "</td><td colspan=\"1\" >" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedVolumeWeight"].ToString() + "</td><td colspan=\"1\">" + dr["Name"].ToString() + "</td><td colspan=\"1\">" + dr["ProductName"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" >" + dr["WHLocation"] + "</td><td colspan=\"1\" >" + dr["Remarks"] + "</td><td colspan=\"1\"></td></tr>");
                                    k++;
                                }
                            }
                            tbl.Append("<tr align=\"center\" class=\"grdTableRow\"><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ><b>Total</b></td><td colspan=\"1\" ><b>" + pieces.ToString() + "</b></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\"><b>" + Weight.ToString() + "</b></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\">&nbsp;</td><td colspan=\"1\">&nbsp;</td><td colspan=\"1\">&nbsp;</td><td colspan=\"1\">&nbsp;</td><td colspan=\"1\">&nbsp;</td></tr>");

                            uldtype += " : " + Weight.ToString() + "kgs";
                        }

                    }

                    uldtype = "( " + uldtype + " )";
                    tbl.Append("<tr align=\"left\" class=\"grdTableRow\"><td colspan=\"14\"><b>No of AWB : " + ds.Tables[1].Rows[0]["AWBCount"].ToString() + " &nbsp;&nbsp;&nbsp;" + uldtype + "</b></td></tr>");
                    // Changes by Vipin kumar
                    tbl.Append("<tr align=\"left\" class=\"grdTableRow\"><td colspan=\"14\"><b>Remarks : </b><b>" + ds.Tables[0].Rows[0]["FlightRemarks"] + "</b></td></tr>");
                    //Ends
                    //tbl.Append("<tr align=\"right\"  class=\"grdTableRow;no-print\"  id=\"PrintTr\"><td colspan=\"14\" ><input id=\"btnPrint\" type=\"button\" value=\"Print\" class=\"no-print\" onclick=\"window.print();\" /></td></tr>");
                    tbl.Append("</table>");
                }
        ...
        public Stream GetManifestReport(string DailyFlightSNo, string LogedInAirport, string Type = "N", string IsCart = "0")
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo), new SqlParameter("@LogedInAirport", LogedInAirport), new SqlParameter("@Type", Type), new SqlParameter("@IsCart", IsCart) };
                DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "ManifestReport", Parameters);
                if (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["NewManifestPrint"].ToString().ToUpper().Trim() == "TRUE")
                {
                    byte[] resultBytes = Encoding.UTF8.GetBytes(GetManifestReportHTMLGA(ds, Type));
                    WebOperationContext.Current.OutgoingResponse.ContentType = "text/html";
                    return new MemoryStream(resultBytes);
                }
                else
        ...
        public Stream GetInboundManifestReport(string DailyFlightSNo, string Type = "N", string IsCart = "0")
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo), new SqlParameter("@Type", Type), new SqlParameter("@IsCart", IsCart) };
                DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "InboundManifestReport", Parameters);
                byte[] resultBytes = Encoding.UTF8.GetBytes(GetManifestReportHTML(ds, Type));
                WebOperationContext.Current.OutgoingResponse.ContentType = "text/html";
                return new MemoryStream(resultBytes);
            }
        ...
        public string GetRouteFlight(string DailyFlightSNo)
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo) };
                DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "GetRouteFlight", Parameters);
        ...
        public string GetManifestReportHTML(DataSet ds, string Type)
        {
            try
            {
                ...
                else if (Type == "G")
                {
                    ...
                    {
                        tbl.Append("<table id=\"tblReport\" align=\"center\" style=\"border: 1px solid black;'\" width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");
                        tbl.Append("<tr align=\"center\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" ><h2>DELEVERY CARGO/BAGGAGE</h2> </td></tr> ");
                        tbl.Append("<tr align=\"center\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" >&nbsp;</td></tr> ");
                ...
                else
                {
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            //if (IsPharrma == 1)
                            //{
                            //    tbl.Append("<tr align='left'><td colspan='2' rowspan='3' align='left' style=\"padding: 2px 0px 0px 2px;\"><img src='Logo/CEIV_stamp.jpg' width='120px' height='75px' style='background-color: rgba(0,0,0,.5)'/></td><td colspan='3' align='center' style='font: bold;'><h2> " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></td><td colspan='5'>&nbsp;</td></tr>");
                            //    //tbl.Append("<tr><td align='center' colspan='3'>ICAO ANNEX 9 APPENDIX 3</td><td colspan='5'>&nbsp;</td></tr>");
                            //}
                            //else
                            //{
                            tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" ><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='90px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "CARGO MANIFEST" : "") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></div> </td></tr> ");
                            tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" ><div><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></div> </td></tr> ");
                            //tbl.Append("<tr align=\"center\"><td colspan=\"11\" >ICAO ANNEX 9 APPENDIX 3</td></tr> ");
                            //}//<img src='../Logo/GaurdaCMS Logo.jpg' width='300px' height='90px' />
                        }
                        else
                        {
                            tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" ><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='90px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "CARGO MANIFEST" : "") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></div> </td></tr> ");
                        ...
                        tbl.Append("<tr align=\"center\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" >&nbsp;</td></tr> ");
                        tbl.Append("<tr align=\"left\"><td colspan=\"2\" align=\"left\">Owner or Operator :</td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "4" : "3") + "\" align=\"left\" >" + ds.Tables[0].Rows[0]["airlinename"].ToString() + "</td></tr> ");

                        tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Lading" : "Loading") + " </td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "4" : "3") + "\" align=\"left\" >" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"2\" align=\"left\" >Flight / Date:</td><td align=\"left\" colspan=\"3\" >" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "/" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td><td colspan=\"6\" >&nbsp;</td></tr>");
                        // tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Point Of Loading</td><td colspan=\"2\" align=\"left\" >" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"2\" align=\"left\" >Flight / Date:</td><td align=\"left\" colspan=\"2\" >" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "/" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd/MM/yyyy") + "</td><td colspan=\"6\" >&nbsp;</td></tr>");

                        tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Unlading" : "Unloading") + " </td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "4" : "3") + "\" align=\"left\" >" + ds.Tables[0].Rows[0]["FlightDestination"].ToString() + "</td>" + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == false ? "<td colspan=\"2\" align=\"left\" >A/C Reg:</td><td align=\"left\" colspan=\"3\" >" + ds.Tables[0].Rows[0]["RegistrationNo"].ToString() + "</td><td colspan=\"6\" >&nbsp;</td>" : "</td><td colspan=\"8\" >&nbsp;</td>") + "</tr>");

                        tbl.Append("<tr align=\"center\" style=\"height:50px;border: 1px solid black;'\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "6" : "5") + "\" style=\"border: 1px solid black;'\" >Pallet/ULD No</br>Local Transit</td><td colspan=\"6\"  style=\"border: 1px solid black;\">For use by owner/operator</td></tr>");
                        tbl.Append("<tr align=\"center\"><td colspan=\"1\" class=\"grdTableHeader\">No</td><td colspan=\"1\" class=\"grdTableHeader\"> Air Waybill and part No</td><td colspan=\"1\" class=\"grdTableHeader\">No of Pieces</td><td colspan=\"1\" class=\"grdTableHeader\">Description</td><td colspan=\"1\" class=\"grdTableHeader\">SHC</td><td colspan=\"1\" class=\"grdTableHeader\">Status</td><td colspan=\"1\" class=\"grdTableHeader\">Gross Weight</td><td colspan=\"1\" class=\"grdTableHeader\">ORI/DES</td><td colspan=\"1\" class=\"grdTableHeader\">Priority</td><td colspan=\"1\" class=\"grdTableHeader\">Remarks</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\" class=\"grdTableHeader\">Connecting Flight</td>" : "") + "<td colspan=\"1\" class=\"grdTableHeader\">Office Use</td></tr>");
                        ...
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow drDistinctULD in dtDistinctULD.Rows)
                            {
                                ...
                                if (drRpt.Length > 0)
                                {
                                    ...
                                    tbl.Append("<tr align=\"left\" class=\"grdTableRow\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >" + drDistinctULD["ULDNo"] + "</td></tr>");
                                    if (drLocal.Length > 0)
                                    {
                                        int j = 1;
                                        foreach (DataRow dr in drLocal)
                                        {
                                            ...
                                            //if (Convert.ToInt32(dr["IsPharma"]) == 1 && Convert.ToInt32(dr["IsEurope"]) == 1)
                                            //{
                                            //    tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + j.ToString() + "</td><td colspan=\"1\" ><img src='Logo/ceiv-pharma-stamp.gif' width='28px' height='18px' style='vertical-align: middle'/>" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
                                            //    j++;
                                            //}
                                            //else
                                            //{
                                            //if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt"))
                                            //{
                                            tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + j.ToString() + "</td><td colspan=\"1\" >" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSectorAirport"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" >" + dr["Remarks"] + "</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
                                            j++;
                                            // }
                                            //else
                                            //{
                                            //    tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + j.ToString() + "</td><td colspan=\"1\" >" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
                                            //    j++;
                                            //}
                                    ...
                                    if (drTrans.Length > 0)
                                    {
                                        ...
                                        foreach (DataRow dr in drTrans)
                                        {
                                            ...
                                            //if (Convert.ToInt32(dr["IsPharma"]) == 1 && Convert.ToInt32(dr["IsEurope"]) == 1)
                                            //{
                                            //    tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + k.ToString() + "</td><td colspan=\"1\" ><img src='../../Logo/ceiv-pharma-stamp.gif' width='28px' height='18px' style='vertical-align: middle'/> " + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
                                            //    k++;
                                            //}
                                            //else
                                            //{
                                            tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + k.ToString() + "</td><td colspan=\"1\" > " + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSectorAirport"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" >" + dr["Remarks"] + "</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "</td><td colspan=\"1\"></td></tr>");
                                            k++;
                                            //}
                                        }
                                    }
                                    tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ><b>Total</b></td><td colspan=\"1\" ><b>" + pieces.ToString() + "</b></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\"></td>&nbsp;<td colspan=\"1\" >&nbsp;</td><td colspan=\"1\"><b>" + Weight.ToString() + "</b></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\">&nbsp;</td><td colspan=\"1\">&nbsp;</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\"></td>" : "") + "<td colspan=\"1\">&nbsp;</td></tr>");
                            ...
                            //tbl.Append("<tr style=\"font-weight: bold;\"><td colspan=\"8\" align=\"left\" ><b> Remarks : </b>" + ds.Tables[0].Rows[0]["Remarks"] + "</td></tr>");
                            foreach (DataRow dr1 in dtDistinctDestinationCity.Rows)
                            {
                                ...
                                if (ds.Tables[1].Rows[0]["airlinename"].ToString().ToLower() == ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["FC_AirlineName"].ToString().ToLower().Trim() && dr1[0].ToString().ToLower() == ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["FC_AllowedCity"].ToString().ToLower().Trim())
                                {
                                    ...
                                    //tbl.Append("<tr align=\"right\"><td align=\"top\" width=\"10px\">Note:</td><td colspan=\"10\">NOTE:DME <br/>There are no goods on board of the aircraft the import of which to the Customs Union zone prohibited or restricted such as pharmaceuticals consisting of narcotic drugs and potent agents; psychotropic & toxic substances; weapon & ammunition.</td></tr> ");
                                    tbl.Append("<tr style=\"font-weight: bold;\" ><td valign=\"top\" >Note:</td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" align=\"left\" >NOTE:DME <br/>There are no goods on board of the aircraft the import of which to the Customs Union zone prohibited or restricted such as pharmaceuticals consisting of narcotic drugs and potent agents; psychotropic & toxic substances; weapon & ammunition</td></tr>");
                        ...
                        {
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            if (ds != null && ds.Tables[1].Rows.Count > 0) { }
                            else { tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font-size:30px;color:red\">NIL MANIFEST&nbsp;</td></tr>"); }
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                        ...
                        if (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["IsManifestFooterForAirAsia"].ToString().ToLower().Trim() == "true")
                        {
                            if (ds != null && ds.Tables[1].Rows.Count > 0)
                                tbl.Append("<tr  class=\"grdTableRow\"><td colspan=\"5\" style=\"border-right: none;\"><b>Prepared by : " + ds.Tables[1].Rows[0]["UserName"].ToString() + "</b></td><td colspan=\"7\" align=\"right\" style=\"border-left: none;\"><b>Page______________________ of Page _______________________________ </b></td></tr>");
                            else
                                tbl.Append("<tr  class=\"grdTableRow\"><td colspan=\"5\" style=\"border-right: none;\"><b>Prepared by : </b></td><td colspan=\"7\" align=\"right\" style=\"border-left: none;\"><b>Page______________________ of Page _______________________________ </b></td></tr>");
                        }
                        //tbl.Append("<tr style=\"font-weight: bold;\"><td colspan=\"11\" align=\"left\" ><b> Remarks : </b>" + ds.Tables[0].Rows[0]["Remarks"] + "</td></tr>");

                        if (ds != null && ds.Tables[3].Rows.Count == 0)
                        {

                            tbl.Append("<tr align=\"left\"  class=\"grdTableRow\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" ><b> Remarks : </b><b>" + ds.Tables[0].Rows[0]["Remarks"] + "</b></td></tr>");
                        }
                        if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt"))
                        {
                            tbl.Append("<tr align=\"left\"  class=\"grdTableRow\"><td colspan=\"12\" ><b> LMC Remarks : </b></td></tr>");
                        }
                        //tbl.Append("<tr align=\"right\"  class=\"grdTableRow;no-print\" id=\"PrintTr\"><td colspan=\"11\" ><input id=\"btnPrint\" type=\"button\" value=\"Print\" class=\"no-print\" onclick=\"window.print();\"  /></td></tr>");
                        tbl.Append("</table>");
                    }
                    if (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["IsStopOverShowInManifestPrintOnArrival"].ToString() == "TRUE")
                    {
                        if (ds != null && ds.Tables[3].Rows.Count > 0)
                        {

                            tbl.Append("<table id=\"tblStopOverReport\" align=\"center\" style=\"border: 1px solid black;'\" width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");
                            tbl.Append("<tr align=\"left\"  class=\"grdTableRow\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" ><b>Stop Over Details</b></td></tr>");
                            tbl.Append("<tr align=\"center\"><td colspan=\"1\" class=\"grdTableHeader\">No</td><td colspan=\"1\" class=\"grdTableHeader\"> Air Waybill and part No</td><td colspan=\"1\" class=\"grdTableHeader\">No of Pieces</td><td colspan=\"1\" class=\"grdTableHeader\">Description</td><td colspan=\"1\" class=\"grdTableHeader\">SHC</td><td colspan=\"1\" class=\"grdTableHeader\">Status</td><td colspan=\"1\" class=\"grdTableHeader\">Gross Weight</td><td colspan=\"1\" class=\"grdTableHeader\">ORI/DES</td><td colspan=\"1\" class=\"grdTableHeader\">Priority</td><td colspan=\"1\" class=\"grdTableHeader\">Remarks</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\" class=\"grdTableHeader\">Connecting Flight</td>" : "") + "<td colspan=\"1\" class=\"grdTableHeader\">Office Use</td></tr>");
                            if (ds != null && ds.Tables[3].Rows.Count > 0)
                            {
                                foreach (DataRow dr1 in ds.Tables[3].Rows)
                                {
                                    tbl.Append("<tr align=\"left\" class=\"grdTableRow\">" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b> " + ds.Tables[3].Rows[0]["AWBCount"].ToString() + "</b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b> " + ds.Tables[3].Rows[0]["AWBNo"].ToString() + "</b></td>" +
                                         "<td colspan=\"1\" style=\"border-right: none\">" + ds.Tables[3].Rows[0]["Pieces"].ToString() + "/" + ds.Tables[3].Rows[0]["FFMPieces"].ToString() + "</b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b></b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b></b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b></b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b>" + ds.Tables[3].Rows[0]["GrossWeight"].ToString() + "</b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b>" + ds.Tables[3].Rows[0]["Route"].ToString() + "</b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b></b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b></b></td>" +
                                        "<td  colspan=\"1\" style=\"border-right: none;\"><b></b></td>" +
                                        "</tr>");
                                ...
                                //    if (ds.Tables[3].Rows[0]["airlinename"].ToString().ToLower() == ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["FC_AirlineName"].ToString().ToLower().Trim() && dr1[0].ToString().ToLower() == ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["FC_AllowedCity"].ToString().ToLower().Trim())
                                //    {
                                //        //tbl.Append("<tr align=\"left\"><td colspan=\"11\" >Notes: NOTE:DME <br/> There are no goods on board of the aircraft the import of which to the Customs Union zone is prohibited or restricted such as pharmaceuticals consisting of narcotic <br/>drugs and potent agents; psychotropic & toxic substances; weapon & ammunition.</td></tr> ");/
                            ...
                            tbl.Append("<tr align=\"left\"  class=\"grdTableRow\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" ><b> Remarks : </b><b></b></td></tr>");
                            tbl.Append("</table>");
                        }
                    }
                    return tbl.ToString();
        ...
        //public string GetManifestReportHTMLGA(DataSet ds, string Type)
        //{
        //    try
        //    {
        //        StringBuilder tbl = new StringBuilder();
        ...
        //            if (ds != null && ds.Tables[0].Rows.Count > 0)
        //            {
        //                tbl.Append("<table id=\"tblReport\" align=\"center\" style=\"border: 1px solid black;border-style: hidden;border-collapse: collapse'\"width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");
        //                if (ds != null && ds.Tables[1].Rows.Count > 0)
        //                {
        //                    foreach (DataRow dr in ds.Tables[1].Rows)
        //                    {
        ...
        //                    else
        //                    {
        //                        // tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\" ><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='90px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></div> </td></tr> ");
        //                        tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\"><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='80px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/></div> </td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; vertical-align: bottom; align: center;'\" colspan=\"1\"><div style=\"white-space:nowrap;\"><h2>Air Cargo - Manifest(ALL)</h2><h3>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h3></div> </td><td style=\"font: bold; border: solid; border-width: 2px 0; border-top: none; vertical-align: bottom;white-space:nowrap;'\" colspan=\"1\" >Generated Date:" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td></tr> ");
        //                        tbl.Append("</table>");
        //                        //tbl.Append("<tr align=\"center\"><td colspan=\"11\" >ICAO ANNEX 9 APPENDIX 3</td></tr> ");
        //                    }//<img src='../Logo/GaurdaCMS Logo.jpg' width='300px' height='90px' />
        //                }
        //                else
        //                {
        //                    tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\" ><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='80px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/></div> </td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; vertical-align: bottom; align: center;'\" colspan=\"1\" ><div style=\"white-space:nowrap;\"><h2>Air Cargo - Manifest(ALL)</h2><h3>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h3></div> </td><td style=\"font: bold; border: solid; border-width: 2px 0; border-top: none; vertical-align: bottom;'\" colspan=\"1\" >Generated Date:" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td></tr> ");
        //                    tbl.Append("</table>");
        //                    //tbl.Append("<tr align=\"center\"><td colspan=\"11\" >ICAO ANNEX 9 APPENDIX 3</td></tr> ");
        //                }
        //                tbl.Append("<table id=\"tblReport1\" align=\"center\" style=\"border: 1px solid black;border-style: hidden;border-collapse: collapse'\"width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");
        //                tbl.Append("<tr align=\"left\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "4") + "\" style=\"font: bold;'\" >&nbsp;</td></tr> ");
        //                tbl.Append("<tr align=\"left\"><td colspan=\"1\" align=\"left\"   style=\"white-space:nowrap;\";>Owner or Operator :</td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "4" : "1") + "\" align=\"left\"  >" + ds.Tables[0].Rows[0]["airlinename"].ToString() + "</td><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\">Manifest No:</td><td align=\"left\" colspan=\"1\"  ></td></tr> ");
        //                tbl.Append("<tr align=\"left\"><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\">Registration: :</td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "4" : "1") + "\" align=\"left\"  >" + ds.Tables[0].Rows[0]["RegistrationNo"].ToString() + "</td><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\">Customs Ref:</td><td align=\"left\" colspan=\"1\"  ></td></tr> ");
        //                tbl.Append("<tr align=\"left\"><td colspan=\"1\" align=\"left\"   style=\"white-space:nowrap;\";>Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Lading" : "Loading") + " : </td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "4" : "1") + "\" align=\"left\"  style=\"white-space:nowrap;\">" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\";>Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Unlading" : "Unloading") + ":</td><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "4" : "1") + "\" align=\"left\"   style=\"white-space:nowrap;\">" + ds.Tables[0].Rows[0]["FlightDestination"].ToString() + "</td></tr>");
        //                // tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Point Of Loading</td><td colspan=\"2\" align=\"left\" >" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"2\" align=\"left\" >Flight / Date:</td><td align=\"left\" colspan=\"2\" >" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "/" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd/MM/yyyy") + "</td><td colspan=\"6\" >&nbsp;</td></tr>");

        //                tbl.Append("<tr align=\"left\"><td colspan=\"1\" align=\"left\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\"   style=\"white-space:nowrap;\";>Flight / Date:</td><td align=\"left\" colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\"  style=\"white-space:nowrap;\";>" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "/" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td>" + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == false ? "<td colspan=\"1\" align=\"left\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\"  >STD:</td><td align=\"left\" colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\"  ></td>" : "</td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" >&nbsp;</td>") + "</tr>");
        //                tbl.Append("</table>");
        //                tbl.Append("<table id=\"tblReport2\" align=\"center\" style=\"border: 1px solid black;border-style: hidden;border-collapse: collapse'\"width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");
        //                //tbl.Append("<tr align=\"center\" style=\"height:50px;border: 1px solid black;'\"><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "6" : "5") + "\" style=\"border: 1px solid black;'\" >Pallet/ULD No</br>Local Transit</td><td colspan=\"6\"  style=\"border: 1px solid black;\">For use by owner/operator</td></tr>");
        //                tbl.Append("<tr align=\"left\"><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\"  ><span style=\"font-size:12px;white-space:nowrap;\" ><b>AIR WAYBILL</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>Pcs</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>WEIGHT</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>Vol</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\"><b>NATURE OF GOODS</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>O-D</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\"><b>OPERATOR</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>P</b></span></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><b>Connecting Flight</b></td>" : "") + "<td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\"><b>OFFICIAL USE</b></span></td></tr>");
        ...
        //                                pieces = (pieces == 0 ? Convert.ToInt32(dr["PlannedPieces"].ToString()) : pieces + Convert.ToInt32(dr["PlannedPieces"].ToString()));
        //                                Weight = (Weight == 0 ? Convert.ToDecimal(dr["PlannedGrossWeight"].ToString()) : Convert.ToDecimal(Weight) + Convert.ToDecimal(dr["PlannedGrossWeight"].ToString()));
        //                                Volume = (Volume == 0 ? Convert.ToDecimal(dr["VolumeWeight"].ToString()) : Convert.ToDecimal(Volume) + Convert.ToDecimal(dr["VolumeWeight"].ToString()));
        //                            }

        //                            tbl.Append("<tr align=\"left\" ><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "9") + "\" ><span style=\"font-size:12px;\" width=\"99%\"><b>" + drDistinctULD["ULDNo"] + "</b></span></td></tr>");
        //                            if (drLocal.Length > 0)
        //                            {
        //                                int j = 1;
        //                                foreach (DataRow dr in drLocal)
        ...
        //                                    if (Convert.ToInt32(dr["IsPharma"]) == 1 && Convert.ToInt32(dr["IsEurope"]) == 1)
        //                                    {
        //                                        tbl.Append("<tr align=\"center\"  ><td colspan=\"1\" ><img src='Logo/ceiv-pharma-stamp.gif' width='28px' height='18px' style='vertical-align: middle'/>" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
        //                                        j++;
        //                                    }
        //                                    else
        //                                    {
        //                                        tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["AWBNo"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["RPTPIECES"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["PlannedGrossWeight"] + "</span></td>" + "</td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["PlannedVolumeWeight"] + "</span></td>" + "</td><td colspan=\"1\"><span style=\"font-size:10px;\">" + dr["NatureOfGoods"].ToString() + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["AWBSector"].ToString() + "<span></td><td colspan=\"1\"><span style=\"font-size:10px;\"></span></td><td colspan=\"1\"><span style=\"font-size:10px;\">" + dr["Priority"] + "</span></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\" >" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\" ><span style=\"font-size:10px;\"></span></td></tr>");
        //                                        //tbl.Append("<tr align=\"center\"  ><td colspan=\"1\" >" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
        //                                        j++;
        //                                    }
        //                                }
        //                            }
        ...
        //                                    if (Convert.ToInt32(dr["IsPharma"]) == 1 && Convert.ToInt32(dr["IsEurope"]) == 1)
        //                                    {
        //                                        tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" style=\"width:20px;\" >" + k.ToString() + "</td><td colspan=\"1\" ><img src='../../Logo/ceiv-pharma-stamp.gif' width='28px' height='18px' style='vertical-align: middle'/> " + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
        //                                        k++;
        //                                    }
        //                                    else
        //                                    {
        //                                        tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" style=\"width:20px;\" >" + k.ToString() + "</td><td colspan=\"1\" > " + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "</td><td colspan=\"1\"></td></tr>");
        //                                        k++;
        //                                    }
        //                                }
        //                            }
        //                            tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + pieces.ToString() + "</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + Weight.ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + Volume.ToString()+" MC</b></span></td>&nbsp;<td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\" ></td>" : "") + "<td colspan=\"1\" >&nbsp;</td></tr>");


        //                        }

        //                    }
        //                    tbl.Append("<tr align=\"left\" ><td  colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>Total:</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedPieces"].ToString() + " Pcs</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedGrossWeight"].ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedVolumeWeight"].ToString() + " MC</b></span></td><td colspan=\"4\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>Total No. of DOCs :" + ds.Tables[2].Rows[0]["AWBCount"].ToString() + "</b></span></td></tr>");
        //                    //tbl.Append("<tr style=\"font-weight: bold;\"><td colspan=\"8\" align=\"left\" ><b> Remarks : </b>" + ds.Tables[0].Rows[0]["Remarks"] + "</td></tr>");
        //                    foreach (DataRow dr1 in dtDistinctDestinationCity.Rows)
        //                    {
        ...
        //                {
        //                    if (ds != null && ds.Tables[1].Rows.Count > 0)
        //                        tbl.Append("<tr  ><td colspan=\"5\" style=\"border-right: none;\"><b>Prepared by : " + ds.Tables[1].Rows[0]["UserName"].ToString() + "</b></td><td colspan=\"7\" align=\"right\" style=\"border-left: none;\"><b>Page______________________ of Page _______________________________ </b></td></tr>");
        //                    else
        //                        tbl.Append("<tr  ><td colspan=\"5\" style=\"border-right: none;\"><b>Prepared by : </b></td><td colspan=\"7\" align=\"right\" style=\"border-left: none;\"><b>Page______________________ of Page _______________________________ </b></td></tr>");
        //                }
        //                //tbl.Append("<tr style=\"font-weight: bold;\"><td colspan=\"11\" align=\"left\" ><b> Remarks : </b>" + ds.Tables[0].Rows[0]["Remarks"] + "</td></tr>");
        //                //tbl.Append("<tr align=\"left\"  ><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "9") + "\" ><b> Remarks : </b><b>" + ds.Tables[0].Rows[0]["Remarks"] + "</b></td></tr>");
        //                if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt"))
        //                {
        //                    tbl.Append("<tr align=\"left\"  ><td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "9") + "\" ><b> Remarks : </b><b>" + ds.Tables[0].Rows[0]["Remarks"] + "</b></td></tr>");
        //                    tbl.Append("<tr align=\"left\"  ><td colspan=\"12\" ><b> LMC Remarks : </b></td></tr>");
        //                }
        //                //tbl.Append("<tr align=\"right\"  class=\"grdTableRow;no-print\" id=\"PrintTr\"><td colspan=\"11\" ><input id=\"btnPrint\" type=\"button\" value=\"Print\" class=\"no-print\" onclick=\"window.print();\"  /></td></tr>");
        //                tbl.Append("</table>");
        //            }
                ...
                else
                {
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            //{
                            // tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "12" : "11") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\" ><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='90px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></div> </td></tr> ");
                            if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ClientEnvironment"].ToString().ToLower().Trim() == "th"))
                            {
                                tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; border-bottom: none;'\" width=\"300px\"></td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; border-bottom: none; vertical-align: bottom; align: center;'\" colspan=\"1\"><div style=\"white-space:nowrap;\"><h2>Air Cargo - Manifest</h2><h3>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h3></div> </td><td align=\"right\" vertical-align=\"top\" margin-bottom = \"25px\"  colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; border-bottom: none;'\"><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='80px' onError='this.onerror=null;this.src=\"../Logo/aa.jpg\";'/></div> </td></tr> ");
                                tbl.Append("<tr align=\"center\">  <td  colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\" width=\"300px\"></td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;  vertical-align: bottom; align: center;'\" colspan=\"1\"> </td><td align=\"right\" style=\"font: bold; border: solid; border-width: 2px 0; border-top: none; vertical-align: bottom;white-space:nowrap;'\" colspan=\"1\" >Generated Date:" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td></tr> ");
                            }
                            else
                            {
                                tbl.Append("<tr align=\"center\">  <td colspan=\"" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\"><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='80px' onError='this.onerror=null;this.src=\"../Logo/aa.jpg\";'/></div> </td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; vertical-align: bottom; align: center;'\" colspan=\"1\"><div style=\"white-space:nowrap;\"><h2>Air Cargo - Manifest(ALL)</h2><h3>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h3></div> </td><td style=\"font: bold; border: solid; border-width: 2px 0; border-top: none; vertical-align: bottom;white-space:nowrap;'\" colspan=\"1\" >Generated Date:" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td></tr> ");
                            }
                        ...
                        else
                        {
                            ...
                            {
                                tbl.Append("<tr align=\"center\">  <td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\" ><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='80px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/></div> </td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; vertical-align: bottom; align: center;'\" colspan=\"1\" ><div style=\"white-space:nowrap;\"><h2>Air Cargo - Manifest(ALL)</h2><h3>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h3></div> </td><td style=\"font: bold; border: solid; border-width: 2px 0; border-top: none; vertical-align: bottom;'\" colspan=\"1\" >Generated Date:" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td></tr> ");
                            }
                            tbl.Append("</table>");
                            //tbl.Append("<tr align=\"center\"><td colspan=\"11\" >ICAO ANNEX 9 APPENDIX 3</td></tr> ");
                        }
                        tbl.Append("<table id=\"tblReport1\" align=\"center\" style=\"border: 1px solid black;border-style: hidden;border-collapse: collapse'\"width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");
                        tbl.Append("<tr align=\"left\"><td colspan=\"4\" style=\"font: bold;'\" >&nbsp;</td></tr> ");
                        tbl.Append("<tr align=\"left\"><td colspan=\"1\" align=\"left\"   style=\"white-space:nowrap;\";>Owner or Operator :</td><td colspan=\"1\" align=\"left\"  >" + ds.Tables[0].Rows[0]["airlinename"].ToString() + "</td><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\">Manifest No:</td><td align=\"left\" colspan=\"1\"  ></td></tr> ");
                        tbl.Append("<tr align=\"left\"><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\">Registration: :</td><td colspan=\"1\" align=\"left\"  >" + ds.Tables[0].Rows[0]["RegistrationNo"].ToString() + "</td><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\">Customs Ref:</td><td align=\"left\" colspan=\"1\"  ></td></tr> ");
                        tbl.Append("<tr align=\"left\"><td colspan=\"1\" align=\"left\"   style=\"white-space:nowrap;\";>Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Lading" : "Loading") + " : </td><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\">" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"1\" align=\"left\"  style=\"white-space:nowrap;\";>Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Unlading" : "Unloading") + ":</td><td colspan=\"1\" align=\"left\"   style=\"white-space:nowrap;\">" + ds.Tables[0].Rows[0]["FlightDestination"].ToString() + "</td></tr>");
                        // tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Point Of Loading</td><td colspan=\"2\" align=\"left\" >" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"2\" align=\"left\" >Flight / Date:</td><td align=\"left\" colspan=\"2\" >" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "/" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd/MM/yyyy") + "</td><td colspan=\"6\" >&nbsp;</td></tr>");
                        ...
                        if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ClientEnvironment"].ToString().ToLower().Trim() == "th"))
                        {
                            tbl.Append("<tr align=\"left\"><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\"  ><span style=\"font-size:16px;white-space:nowrap;\" ><b>AIR WAYBILL AND PART NO</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:16px;\"><b>PIECES</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:16px;\"><b>GROSS WEIGHT</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:16px;\"><b>Vol</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\"><b>NATURE OF GOODS</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:16px;\"><b>Ori/Des</b></span></td><td colspan=\"2\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\"><b>REMARKS</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\"><b>OFFICIAL USE</b></span></td></tr>");
                        }
                        else
                        {
                            tbl.Append("<tr align=\"left\"><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\"  ><span style=\"font-size:12px;white-space:nowrap;\" ><b>AIR WAYBILL</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>Pcs</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>WEIGHT</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>Vol</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\"><b>NATURE OF GOODS</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>O-D</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\"><b>OPERATOR</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;\"><b>P</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-top: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\"><b>OFFICIAL USE</b></span></td></tr>");
                        }
                        ...
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow drDistinctULD in dtDistinctULD.Rows)
                            {
                                ...
                                if (drRpt.Length > 0)
                                {
                                    ...
                                    if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ClientEnvironment"].ToString().ToLower().Trim() == "th"))
                                    {
                                        tbl.Append("<tr align=\"left\" ><td colspan=\"9\" ><span style=\"font-size:14px;\" width=\"99%\"><b>" + drDistinctULD["ULDNo"] + "</b></span></td></tr>");
                                    }
                                    else
                                    {
                                        tbl.Append("<tr align=\"left\" ><td colspan=\"9\" ><span style=\"font-size:12px;\" width=\"99%\"><b>" + drDistinctULD["ULDNo"] + "</b></span></td></tr>");
                                    }
                                    ...
                                    if (drLocal.Length > 0)
                                    {
                                        ...
                                        foreach (DataRow dr in drLocal)
                                        {
                                            ...
                                            //{
                                            //    //tbl.Append("<tr align=\"center\"  ><td colspan=\"1\" ><img src='Logo/ceiv-pharma-stamp.gif' width='28px' height='18px' style='vertical-align: middle'/>" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSector"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
                                            //    tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["AWBNo"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["RPTPIECES"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["PlannedGrossWeight"] + "</span></td>" + "</td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["PlannedVolumeWeight"] + "</span></td>" + "</td><td colspan=\"1\"><span style=\"font-size:10px;\">" + dr["NatureOfGoods"].ToString() + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["AWBSector"].ToString() + "<span></td><td colspan=\"1\"><span style=\"font-size:10px;\"></span></td><td colspan=\"1\"><span style=\"font-size:10px;\">" + dr["Priority"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\"></span></td></tr>");
                                            //    j++;
                                            //}
                                            //else
                                            //{
                                            if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ClientEnvironment"].ToString().ToLower().Trim() == "th"))
                                            {
                                                tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ><span style=\"font-size:14px;\">" + dr["AWBNo"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:14px;\">" + dr["RPTPIECES"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:14px;\">" + dr["PlannedGrossWeight"] + "</span></td>" + "</td><td colspan=\"1\" ><span style=\"font-size:14px;\">" + dr["PlannedVolumeWeight"] + "</span></td>" + "</td><td colspan=\"1\"><span style=\"font-size:14px;\">" + dr["NatureOfGoods"].ToString() + "</span></td><td colspan=\"1\" ><span style=\"font-size:14px;\">" + dr["AWBSectorAirport"].ToString() + "<span></td><td colspan=\"2\"><span style=\"font-size:14px;\"></span></td><td colspan=\"1\" ><span style=\"font-size:14px;\"></span></td></tr>");
                                            }
                                            else
                                            {
                                                tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["AWBNo"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["RPTPIECES"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["PlannedGrossWeight"] + "</span></td>" + "</td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["PlannedVolumeWeight"] + "</span></td>" + "</td><td colspan=\"1\"><span style=\"font-size:10px;\">" + dr["NatureOfGoods"].ToString() + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\">" + dr["AWBSector"].ToString() + "<span></td><td colspan=\"1\"><span style=\"font-size:10px;\"></span></td><td colspan=\"1\"><span style=\"font-size:10px;\">" + dr["Priority"] + "</span></td><td colspan=\"1\" ><span style=\"font-size:10px;\"></span></td></tr>");
                                    ...
                                    if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ClientEnvironment"].ToString().ToLower().Trim() == "th"))
                                    {
                                        tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:14px;white-space:nowrap;\" ><b>" + pieces.ToString() + "</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:14px;white-space:nowrap;\" ><b>" + Weight.ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:14px;white-space:nowrap;\" ><b>" + Volume.ToString() + " MC</b></span></td>&nbsp;<td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"2\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\" ></td>" : "") + "<td colspan=\"1\" >&nbsp;</td></tr>");
                                    }
                                    else
                                    {
                                        tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + pieces.ToString() + "</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + Weight.ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + Volume.ToString() + " MC</b></span></td>&nbsp;<td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td>" + (((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ICMSEnvironment"].ToString().ToLower().Trim() == "jt" ? "<td colspan=\"1\" ></td>" : "") + "<td colspan=\"1\" >&nbsp;</td></tr>");
                            ...
                            if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ClientEnvironment"].ToString().ToLower().Trim() == "th"))
                            {
                                tbl.Append("<tr align=\"left\" ><td  colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\" ><b>Total:</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\"><span style=\"font-size:16px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedPieces"].ToString() + " Pcs</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedGrossWeight"].ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedVolumeWeight"].ToString() + " MC</b></span></td><td colspan=\"4\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:16px;white-space:nowrap;\" ><b>Total No. of DOCs :" + ds.Tables[2].Rows[0]["AWBCount"].ToString() + "</b></span></td></tr>");
                            }
                            else
                            {
                                tbl.Append("<tr align=\"left\" ><td  colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>Total:</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedPieces"].ToString() + " Pcs</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedGrossWeight"].ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + ds.Tables[2].Rows[0]["TotalPlannedVolumeWeight"].ToString() + " MC</b></span></td><td colspan=\"4\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\" ><span style=\"font-size:12px;white-space:nowrap;\" ><b>Total No. of DOCs :" + ds.Tables[2].Rows[0]["AWBCount"].ToString() + "</b></span></td></tr>");
                            ...
                            foreach (DataRow dr1 in dtDistinctDestinationCity.Rows)
                            {
                                ...
                                if (ds.Tables[1].Rows[0]["airlinename"].ToString().ToLower() == ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["FC_AirlineName"].ToString().ToLower().Trim() && dr1[0].ToString().ToLower() == ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["FC_AllowedCity"].ToString().ToLower().Trim())
                                {
                                    ...
                                    //tbl.Append("<tr align=\"right\"><td align=\"top\" width=\"10px\">Note:</td><td colspan=\"10\">NOTE:DME <br/>There are no goods on board of the aircraft the import of which to the Customs Union zone prohibited or restricted such as pharmaceuticals consisting of narcotic drugs and potent agents; psychotropic & toxic substances; weapon & ammunition.</td></tr> ");
                                    tbl.Append("<tr style=\"font-weight: bold;\" ><td valign=\"top\" >Note:</td><td colspan=\"11\" align=\"left\" >NOTE:DME <br/>There are no goods on board of the aircraft the import of which to the Customs Union zone prohibited or restricted such as pharmaceuticals consisting of narcotic drugs and potent agents; psychotropic & toxic substances; weapon & ammunition</td></tr>");
                        ...
                        {
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\">&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            if (ds != null && ds.Tables[1].Rows.Count > 0) { }
                            else { tbl.Append("<tr><td align=\"center\" colspan=\"11\" style=\"font-size:30px;color:red\">NIL MANIFEST&nbsp;</td></tr>"); }
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"11\" style=\"font: bold;border: solid;border-width: 2px 0; border-bottom: none;'\">&nbsp;</td></tr>");
                        ...
                        if ((((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).SysSetting["ClientEnvironment"].ToString().ToLower().Trim() == "th"))
                        {
                            //  tbl.Append("<footer><table width='100%'><tr><td colspan=\"5\" style=\"border-right: none;\"><b>Prepared by : " + ds.Tables[1].Rows[0]["UserName"].ToString() + "</b></td><td colspan=\"7\" align=\"right\" style=\"border-left: none;\"><b>Print Time:  " + System.DateTime.UtcNow + "</b></td></tr></table></footer>");
                            tbl.Append("<footer style='position: fixed;bottom: 0;'><table width=\"100%\"><tr><td  style=\"border-right: none;width:80%;\"><b>Prepared by : " + ds.Tables[1].Rows[0]["UserName"].ToString() + "</b></td><td  align=\"right\" style=\"border-left: none;width:20%\"><b>Print Time:  " + ds.Tables[1].Rows[0]["CurrentTime"].ToString() + "</b></td></tr></table></footer>");
                        }
                    }
                    return tbl.ToString();
                }
        ...
        public DataSourceResult GetManifestULDGridData(String FlightSNo, String ProcessStatus, string CurrentProcessSNo, int skip, int take, int page, int pageSize, List<SoftwareFactory.Data.GridSort> sort, SoftwareFactory.Data.GridFilter filter)
        {
            try
            {
                string sorts = GridSort.ProcessSorting(sort);
                ...
                new SqlParameter("@FlightSNo", FlightSNo),
        ...
        public DataSourceResult GetSOFlightULDGridData(String FlightSNo, int skip, int take, int page, int pageSize, List<SoftwareFactory.Data.GridSort> sort, SoftwareFactory.Data.GridFilter filter)
        {
            try
            {
                ...
                string filters = GridFilter.ProcessFilters<ManifestULD>(filter);
                SqlParameter[] Parameters = { new SqlParameter("@PageNo", page), new SqlParameter("@PageSize", pageSize), new SqlParameter("@WhereCondition", filters), new SqlParameter("@OrderBy", sorts), new SqlParameter("@FlightSNo", FlightSNo), new SqlParameter("@LoggedInAirport", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).AirportSNo) };
                ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, ProcName, Parameters);
        ...
        public DataSourceResult GetMULDShipmentGridData(string FlightSNo, string ProcessStatus, string CurrentProcessSNo, int skip, int take, int page, int pageSize, List<SoftwareFactory.Data.GridSort> sort, SoftwareFactory.Data.GridFilter filter)
        {
            try
            {
                string sorts = GridSort.ProcessSorting(sort);
                ...
                ProcName = "GetMULDShipmentChild";

                string filters = GridFilter.ProcessFilters<ManifestShipment>(filter);

                //SqlParameter[] Parameters = { new SqlParameter("@PageNo", page), new SqlParameter("@PageSize", pageSize), new SqlParameter("@WhereCondition", filters), new SqlParameter("@OrderBy", sorts), new SqlParameter("@Type", FlightNo), new SqlParameter("@ULDName", FlightStatus) };
                //SqlParameter[] Parameters = { new SqlParameter("@PageNo", page), new SqlParameter("@PageSize", pageSize), new SqlParameter("@WhereCondition", filters), new SqlParameter("@OrderBy", sorts), new SqlParameter("@ULDStockSNo", ULDStockSNo), new SqlParameter("@DailyFlightSNo", FlightSNo) };
                SqlParameter[] Parameters = { new SqlParameter("@PageNo", page), new SqlParameter("@PageSize", pageSize), new SqlParameter("@WhereCondition", filters), new SqlParameter("@OrderBy", sorts), new SqlParameter("@DailyFlightSNo", FlightSNo), new SqlParameter("@ProcessStatus", ProcessStatus), new SqlParameter("@CurrentProcessSNo", CurrentProcessSNo) };
                ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, ProcName, Parameters);
        ...
        public DataSourceResult GetOSCULDLyingShipGridData(string DestinationCity, string CarrierCode, string FlightRoute, string OffloadType, string AWBNo, int skip, int take, int page, int pageSize, List<SoftwareFactory.Data.GridSort> sort, SoftwareFactory.Data.GridFilter filter)
        {
            try
            {
                ...
                {
                    // AWBOffPoint = e["AWBOffPoint"].ToString(),
                    AWBOffPointId = Convert.ToString(e["AWBOffPointId"]),
                    ULDStockSNo = Convert.ToInt32(e["ULDStockSNo"]),
                    ChargeCSS = Convert.ToString(e["ChargeCSS"]),
                    CTMSNo = Convert.ToInt32(e["CTMSNo"]),
                    IsCTM = Convert.ToBoolean(e["IsCTM"]),
        ...
        public string GetHDQRemarks(string DFGroupSNo, int AWBSNo)
        {
            SqlParameter[] Parameters = { new SqlParameter("@DFGroupSNo", DFGroupSNo), new SqlParameter("@AWBSNo", AWBSNo) };
            DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "GetHDQRemarks", Parameters);
            ds.Dispose();
            return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);
        }
        ...
        public string UpdateNotocStatus(string GroupFlightSNo)
        {
            SqlParameter[] Parameters = { new SqlParameter("@GroupFlightSNo", GroupFlightSNo) };
            DataSet ds = new DataSet();
            try
            {
                ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, "UpdateNotocStatus", Parameters);
                return ds.Tables[ds.Tables.Count - 1].Rows[0][0].ToString();
            }
            catch (Exception ex)//(Exception ex)
            {
        ...
        public string PrintManifestReport(string DailyFlightSNo, string LogedInAirport, string Type = "N", string IsCart = "0")
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo), new SqlParameter("@LogedInAirport", LogedInAirport), new SqlParameter("@Type", Type), new SqlParameter("@IsCart", IsCart) };
        ...
        public string GetCartManifestPrint(string DailyFlightSNo,string LogedInAirport, string IsCart)
        {

            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo), new SqlParameter("@LogedInAirport", LogedInAirport), new SqlParameter("@IsCart", IsCart) };
                DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "ManifestReport", Parameters);
        ...
        //adding QRTShipment service

        public string QRTShipmentInfo(string GroupFlightSNo)
        {
            SqlParameter[] Parameters = { new SqlParameter("@GroupFlightSNo", GroupFlightSNo), new SqlParameter("@LoginAirportSNo", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).AirportSNo.ToString()), new SqlParameter("@UpdatedBy", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).UserSNo.ToString()) };
            DataSet ds = new DataSet();
            try
            {
                ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, "FC_QRTShipment", Parameters);
                //return ds.Tables[ds.Tables.Count - 1].Rows[0][0].ToString();
                return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);
            }
        ...
        //save for QRT Shipment

        public string QRTShipmentSave(List<QRTShipmentobj> QRTShipmentobj, string GroupFlightSNo)
        {
            DataTable dtQRTShipment = CollectionHelper.ConvertTo(QRTShipmentobj, "");
            BaseBusiness baseBusiness = new BaseBusiness();
            SqlParameter paramQRTShipment = new SqlParameter();
            paramQRTShipment.ParameterName = "@QRTShipment";
            paramQRTShipment.SqlDbType = System.Data.SqlDbType.Structured;
            paramQRTShipment.Value = dtQRTShipment;

            SqlParameter[] Parameters = { paramQRTShipment, new SqlParameter("@GroupFlightSNo", GroupFlightSNo), new SqlParameter("@UpdatedBy", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).UserSNo.ToString()) };
            try
            {
                var res = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, "saveFCQRTShipment", Parameters);
                return "";
            }
            catch (Exception ex)//(Exception ex)
            {
        ...
        public string getLIVersion(int DailyFlightSNo, int LiVersion)
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo), new SqlParameter("@LiVersion", LiVersion) };
                DataSet ds = new DataSet();
                ds = SqlHelper.ExecuteDataset(ReadConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "getLIVersion", Parameters);
                ds.Dispose();
                return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);
            }
            catch (Exception ex)//(Exception ex)
        ...
        public string getLatestLIVersion(Int32 DailyFlightSNo)
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo) };
                DataSet ds = new DataSet();
                ds = SqlHelper.ExecuteDataset(ReadConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "getLatestLIVersion", Parameters);
                ds.Dispose();
                return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);
            }
            catch (Exception ex)//(Exception ex)
        ...
        public string getLIRemarks(int DailyFlightSNo, string GroupFlightSNo, int RemarkType)
        {
            try
            {
                ...
                DataSet ds = SqlHelper.ExecuteDataset(ReadConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "getLIRemarks", Parameters);
                ds.Dispose();
                return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);
            }
            catch (Exception ex)//(Exception ex)
        ...
        public string SaveLIRemarks(int DailyFlightSNo, string GroupFlightSNo, int RemarkType, string Remarks)
        {
            try
            {
                SqlParameter[] Parameters = {
                ...
                DataSet ds = SqlHelper.ExecuteDataset(ReadConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "saveLIRemarks", Parameters);
                ds.Dispose();
                return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);
            }
            catch (Exception ex)//(Exception ex)
        ...
        public string SaveAndDownloadCustomFile(string FlightNo, string FlightDate, string FlightOriginSNo, string FlightDestinationSNo, string NoOfTransaction, string IsFlightStatus, string CreatedBy)
        {
            ...
            try
            {
                ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, "spSave_COGACustomFlightDetails", Parameters);
            }
            catch (Exception ex)//(Exception ex)
            {
                throw ex;
        ...
        public string UpdateAircraftRegistrationNo(string GroupFlightSNo, string RegistrationNo)
        {
            try
            {
                SqlParameter[] Parameters = {new SqlParameter("@GroupFlightSNo", GroupFlightSNo),
                ...
                DataSet ds = SqlHelper.ExecuteDataset(ReadConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "spUpdateAircraftRegistrationNo", Parameters);
                ds.Dispose();
                // return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);
                return ds.Tables[ds.Tables.Count - 1].Rows[0][0].ToString();
            }
        ...
        public void GetAWBLabelPrint(Int64 AWBSNo)
        {
            try
            {
                SqlParameter[] Parameters = {new SqlParameter("@AWBSNo", AWBSNo),
                ...
                DataSet ds = SqlHelper.ExecuteDataset(ReadConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "GetAWBLabelPrintData", Parameters);
                ds.Dispose();
                MakeLableFromFile(ds.Tables[0], "AWBLabelPrint");
                //return ds.Tables[ds.Tables.Count - 1].Rows[0][0].ToString();
            }
            catch (Exception ex)//(Exception ex)
            {
        ...
        public StringBuilder MakeLableFromFile(DataTable dt, string prnfileName)
        {
            StringBuilder strLabel = new StringBuilder();
            try
            {
                string path = string.Empty, readText = string.Empty;
                path = System.Web.HttpContext.Current.Server.MapPath("~/LabelPrint\\AWBLabelPrint.prn");
                readText = File.ReadAllText(path, System.Text.Encoding.Default);
                readText = readText.Replace("@AirlineName@", Convert.ToString(dt.Rows[0]["AirlineName"]));
                readText = readText.Replace("@AWBNo@", Convert.ToString(dt.Rows[0]["AWBNo"]));
                readText = readText.Replace("@OriginAirportCode@", Convert.ToString(dt.Rows[0]["OriginAirportCode"]));
                readText = readText.Replace("@DestinationAirportCode@", Convert.ToString(dt.Rows[0]["DestinationAirportCode"]));
                readText = readText.Replace("@TotalGrossWeight@", Convert.ToString(dt.Rows[0]["TotalGrossWeight"]));
                readText = readText.Replace("@WeightPerPieces@", Convert.ToString(dt.Rows[0]["WeightPerPieces"]));
                readText = readText.Replace("@NoOfPieces@", Convert.ToString(dt.Rows[0]["NoOfPieces"]));
                readText = readText.Replace("@FlightNoFlightDate@", Convert.ToString(dt.Rows[0]["FlightNoFlightDate"]));
                readText = readText.Replace("@BarCodeData@", Convert.ToString(dt.Rows[0]["BarCodeData"]));
                readText = readText.Replace("@QRCodeData@", Convert.ToString(dt.Rows[0]["QRCodeData"]));
                strLabel.Append(readText);
        ...
        public string SaveEPouchDetail(string GroupFlightSNo, List<FlightEPouchDetails> FlightEPouchDetails)
        {
            DataTable dtFlightEPouchDetails = CollectionHelper.ConvertTo(FlightEPouchDetails, "");
            SqlParameter paramFlightEPouchDetails = new SqlParameter();
            paramFlightEPouchDetails.ParameterName = "@FlightEPouchDetail";
            paramFlightEPouchDetails.SqlDbType = System.Data.SqlDbType.Structured;
            paramFlightEPouchDetails.Value = dtFlightEPouchDetails;
            DataSet ds = new DataSet();
            SqlParameter[] Parameters = {
                                            new SqlParameter("@GroupFlightSNo", GroupFlightSNo),
                                            paramFlightEPouchDetails,
                                            new SqlParameter("@UpdatedBy", ((CargoFlash.Cargo.Model.UserLogin)(System.Web.HttpContext.Current.Session["UserDetail"])).UserSNo.ToString())
                                        };
            try
            {
                ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, "SaveFlightEPouchDetails", Parameters);
                DeleteSelectedFiles();
                return ds.Tables[ds.Tables.Count - 1].Rows[0][0].ToString();
            }
            //catch(Exception ex)// (Exception ex)
        ...
        //public KeyValuePair<string, List<FlightEPouch>> GetRecordAtFlightEPouch(string SNO, int pageNo, int pageSize, string whereCondition, CreateFlightEPouchWhereCondition model, string sort)
        //{
        //    try
        //    {
        //        SqlParameter[] Parameters = { new SqlParameter("@GroupFlightSNo", model.GroupFlightSNo), new SqlParameter("@PageNo", pageNo), new SqlParameter("@PageSize", pageSize), new SqlParameter("@WhereCondition", ""), new SqlParameter("@OrderBy", sort) };
        ...
        //        var FlightEPouchList = ds.Tables[0].AsEnumerable().Select(e => new FlightEPouch
        //        {
        //            SNo = Convert.ToInt32(e["SNo"]),
        //            DocName = (e["DocName"].ToString()),
        //            AltDocName = (e["AltDocName"].ToString()),

        //        });
        //        if (ds.Tables[0].Rows.Count == 0)
        //        {
        //            return new KeyValuePair<string, List<FlightEPouch>>("", FlightEPouchList.AsQueryable().ToList());
        //        }
        //        else
        //        {


        //            return new KeyValuePair<string, List<FlightEPouch>>(ds.Tables[1].Rows[0][0].ToString(), FlightEPouchList.AsQueryable().ToList());
        //        }
        //    }
        //    catch (Exception ex)//
        //    {
        ...
        //Added by Karan for Save offloaded uld or cart process----------------------------------/////////////////////////
        public string SaveLIOffloadedULD(List<ProcessedOffLoadedULD> ProcessedULDInfo)
        {
            try
            {
                ...
                ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, "SaveFCOffloadshipmentShipment", Parameters);//SaveBuildUpShipmentDetails
                var msg = ds.Tables[ds.Tables.Count - 1].Rows[0][0].ToString();
        ...
        //added by ankit 
        public string AWBList(int DailyFlightSNo, string Process)
        {
            DataSet ds = new DataSet();
            SqlParameter[] Parameters = {
            ...
            ds = CargoFlash.SoftwareFactory.Data.SqlHelper.ExecuteDataset(CargoFlash.SoftwareFactory.Data.DMLConnectionString.WebConfigConnectionString, System.Data.CommandType.StoredProcedure, "spAWBList", Parameters);

            return CargoFlash.Cargo.Business.Common.CompleteDStoJSON(ds);

        }

        // Add by Sushant Kumar Nayak desc : this function for only hhtManifest Print 
        public Stream GetHHTManifestReport(string DailyFlightSNo,string LogedInAirport ,string ICMSEnvironment, string ClientEnvironment, string FC_AirlineName, string FC_AllowedCity, string IsManifestFooterForAirAsia, string NewManifestPrint, string Type = "N", string IsCart = "0")
        {
            try
            {
                SqlParameter[] Parameters = { new SqlParameter("@DailyFlightSNo", DailyFlightSNo), new SqlParameter("@LogedInAirport", LogedInAirport), new SqlParameter("@Type", Type), new SqlParameter("@IsCart", IsCart) };
                DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "ManifestReport", Parameters);
                if (NewManifestPrint.ToUpper().Trim() == "TRUE")
                {
                    byte[] resultBytes = Encoding.UTF8.GetBytes(GetHHTManifestReportHTMLGA(ds, Type, ICMSEnvironment.ToLower().Trim(), ClientEnvironment.ToLower().Trim(), FC_AirlineName.ToLower().Trim(), FC_AllowedCity.ToLower().Trim()));
                    WebOperationContext.Current.OutgoingResponse.ContentType = "text/html";
                    return new MemoryStream(resultBytes);
                }
                else
                {
                    byte[] resultBytes = Encoding.UTF8.GetBytes(GetHHTManifestReportHTML(ds, Type, ICMSEnvironment.ToLower().Trim(), ClientEnvironment.ToLower().Trim(), FC_AirlineName.ToLower().Trim(), FC_AllowedCity.ToLower().Trim(), IsManifestFooterForAirAsia.ToLower().Trim()));
                    WebOperationContext.Current.OutgoingResponse.ContentType = "text/html";
                    return new MemoryStream(resultBytes);
                }
        ...
        public string GetHHTManifestReportHTMLGA(DataSet ds, string Type, string ICMSEnvironment, string ClientEnvironment, string FC_AirlineName, string FC_AllowedCity)
        {
            try
            {
                StringBuilder tbl = new StringBuilder();
                ...
                else
                {
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            if ((ClientEnvironment == "th"))
                            {
                                tbl.Append("<tr align=\"center\">  <td colspan=\"" + (ICMSEnvironment == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; border-bottom: none;'\" width=\"300px\"></td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; border-bottom: none; vertical-align: bottom; align: center;'\" colspan=\"1\"><div style=\"white-space:nowrap;\"><h2>Air Cargo - Manifest</h2><h3>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h3></div> </td><td align=\"right\" vertical-align=\"top\" margin-bottom = \"25px\"  colspan=\"" + (ICMSEnvironment == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; border-bottom: none;'\"><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='80px' onError='this.onerror=null;this.src=\"../Logo/aa.jpg\";'/></div> </td></tr> ");
                                tbl.Append("<tr align=\"center\">  <td  colspan=\"" + (ICMSEnvironment == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\" width=\"300px\"></td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;  vertical-align: bottom; align: center;'\" colspan=\"1\"> </td><td align=\"right\" style=\"font: bold; border: solid; border-width: 2px 0; border-top: none; vertical-align: bottom;white-space:nowrap;'\" colspan=\"1\" >Generated Date:" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td></tr> ");
                            }
                            else
                            {
                                tbl.Append("<tr align=\"center\">  <td colspan=\"" + (ICMSEnvironment == "jt" ? "3" : "1") + "\" style=\"font: bold;border: solid;border-width: 2px 0; border-top: none;'\"><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='80px' onError='this.onerror=null;this.src=\"../Logo/aa.jpg\";'/></div> </td><td style=\"font: bold;border: solid;border-width: 2px 0; border-top: none; vertical-align: bottom; align: center;'\" colspan=\"1\"><div style=\"white-space:nowrap;\"><h2>Air Cargo - Manifest(ALL)</h2><h3>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h3></div> </td><td style=\"font: bold; border: solid; border-width: 2px 0; border-top: none; vertical-align: bottom;white-space:nowrap;'\" colspan=\"1\" >Generated Date:" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td></tr> ");
                            }
                        ...
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow drDistinctULD in dtDistinctULD.Rows)
                            {
                                ...
                                if (drRpt.Length > 0)
                                {
                                    ...
                                    if ((ClientEnvironment == "th"))
                                    {
                                        tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:14px;white-space:nowrap;\" ><b>" + pieces.ToString() + "</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:14px;white-space:nowrap;\" ><b>" + Weight.ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:14px;white-space:nowrap;\" ><b>" + Volume.ToString() + " MC</b></span></td>&nbsp;<td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"2\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td>" + (ICMSEnvironment == "jt" ? "<td colspan=\"1\" ></td>" : "") + "<td colspan=\"1\" >&nbsp;</td></tr>");
                                    }
                                    else
                                    {
                                        tbl.Append("<tr align=\"left\"  ><td colspan=\"1\" ></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + pieces.ToString() + "</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + Weight.ToString() + " K</b></span></td><td colspan=\"1\" style=\"font: bold;border: solid;border-width: 1px 0; border-bottom: none;'\"><span style=\"font-size:12px;white-space:nowrap;\" ><b>" + Volume.ToString() + " MC</b></span></td>&nbsp;<td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" >&nbsp;</td>" + (ICMSEnvironment == "jt" ? "<td colspan=\"1\" ></td>" : "") + "<td colspan=\"1\" >&nbsp;</td></tr>");
                                    }
                            ...
                            foreach (DataRow dr1 in dtDistinctDestinationCity.Rows)
                            {
                                ...
                                if (ds.Tables[1].Rows[0]["airlinename"].ToString().ToLower() == FC_AirlineName && dr1[0].ToString().ToLower() == FC_AllowedCity)
        ...
        public string GetHHTManifestReportHTML(DataSet ds, string Type, string ICMSEnvironment, string ClientEnvironment, string FC_AirlineName, string FC_AllowedCity, string IsManifestFooterForAirAsia)
        {
            try
            {
                StringBuilder tbl = new StringBuilder();
                ...
                else if (Type == "G")
                {
                    ...
                    {
                        tbl.Append("<table id=\"tblReport\" align=\"center\" style=\"border: 1px solid black;'\" width=\"99%\" cellpadding=\"0\" cellspacing=\"0\">");
                        tbl.Append("<tr align=\"center\"><td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" ><h2>DELEVERY CARGO/BAGGAGE</h2> </td></tr> ");
                        tbl.Append("<tr align=\"center\"><td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" >&nbsp;</td></tr> ");
                        tbl.Append("<tr align=\"center\"><td align=\"left\">&nbsp;</td><td align=\"left\">From:</td><td align=\"left\" >" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td align=\"left\" >Time:</td><td align=\"left\" > 10:10:10</td><td align=\"left\">TO</td><td align=\"left\" >" + ds.Tables[0].Rows[0]["FlightDestination"].ToString() + "</td><td align=\"left\">ARR</td><td align=\"left\" >----LT</td></tr>");
                        tbl.Append("<tr align=\"center\"><td align=\"left\">&nbsp;</td><td align=\"left\">PK-G:</td><td align=\"left\" >HA</td><td align=\"left\" >Airline</td><td align=\"left\" > " + ds.Tables[0].Rows[0]["airlinename"].ToString() + "</td><td align=\"left\">ETD</td><td align=\"left\" >" + ds.Tables[0].Rows[0]["ETD"].ToString() + "</td><td align=\"left\">ATA</td><td align=\"left\" >" + ds.Tables[0].Rows[0]["ATA"].ToString() + "</td></tr>");
                        tbl.Append("<tr align=\"center\"><td class=\"grdTableHeader\">No</td><td colspan=\"2\" class=\"grdTableHeader\"> ULD SERIAL NO</td><td colspan=\"2\" class=\"grdTableHeader\">DESTINATION</td><td colspan=\"2\" class=\"grdTableHeader\">CATEGORY</td><td colspan=\"2\" class=\"grdTableHeader\">WEIGHT</td></tr>");
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                ...
                else
                {
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            tbl.Append("<tr align=\"center\">  <td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" ><div><img src='../BLOBUploadAndDownload/DownloadFromBlob/?filenameOrUrl=" + ds.Tables[0].Rows[0]["AirlineLogo"].ToString() + "' width='300px' height='90px' onError='this.onerror=null;this.src=\"../Logo/GaurdaCMS Logo.jpg\";'/><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "CARGO MANIFEST" : "") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></div> </td></tr> ");
                            tbl.Append("<tr align=\"center\">  <td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" ><div><h2>" + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "ICAO ANNEX 9 APPENDIX 3" : "CARGO MANIFEST") + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == true ? "-TRUCKING" : "") + "</h2></div> </td></tr> ");
                        ...
                        tbl.Append("<tr align=\"center\"><td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" style=\"font: bold;'\" >&nbsp;</td></tr> ");
                        tbl.Append("<tr align=\"left\"><td colspan=\"2\" align=\"left\">Owner or Operator :</td><td colspan=\"" + (ICMSEnvironment == "jt" ? "4" : "3") + "\" align=\"left\" >" + ds.Tables[0].Rows[0]["airlinename"].ToString() + "</td></tr> ");

                        tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Lading" : "Loading") + " </td><td colspan=\"" + (ICMSEnvironment == "jt" ? "4" : "3") + "\" align=\"left\" >" + ds.Tables[0].Rows[0]["FlightOrigin"].ToString() + "</td><td colspan=\"2\" align=\"left\" >Flight / Date:</td><td align=\"left\" colspan=\"3\" >" + ds.Tables[0].Rows[0]["FlightNo"].ToString() + "/" + Convert.ToDateTime(ds.Tables[0].Rows[0]["FlightDate"]).ToString("dd-MMM-yyyy") + "</td><td colspan=\"6\" >&nbsp;</td></tr>");

                        tbl.Append("<tr align=\"center\"><td colspan=\"2\" align=\"left\">Point Of " + (ds.Tables[0].Rows[0]["AirlineParameterValue"].ToString().ToUpper() == "YES" ? "Unlading" : "Unloading") + " </td><td colspan=\"" + (ICMSEnvironment == "jt" ? "4" : "3") + "\" align=\"left\" >" + ds.Tables[0].Rows[0]["FlightDestination"].ToString() + "</td>" + (Convert.ToBoolean(ds.Tables[0].Rows[0]["IsRFS"]) == false ? "<td colspan=\"2\" align=\"left\" >A/C Reg:</td><td align=\"left\" colspan=\"3\" >" + ds.Tables[0].Rows[0]["RegistrationNo"].ToString() + "</td><td colspan=\"6\" >&nbsp;</td>" : "</td><td colspan=\"8\" >&nbsp;</td>") + "</tr>");

                        tbl.Append("<tr align=\"center\" style=\"height:50px;border: 1px solid black;'\"><td colspan=\"" + (ICMSEnvironment == "jt" ? "6" : "5") + "\" style=\"border: 1px solid black;'\" >Pallet/ULD No</br>Local Transit</td><td colspan=\"6\"  style=\"border: 1px solid black;\">For use by owner/operator</td></tr>");
                        tbl.Append("<tr align=\"center\"><td colspan=\"1\" class=\"grdTableHeader\">No</td><td colspan=\"1\" class=\"grdTableHeader\"> Air Waybill and part No</td><td colspan=\"1\" class=\"grdTableHeader\">No of Pieces</td><td colspan=\"1\" class=\"grdTableHeader\">Description</td><td colspan=\"1\" class=\"grdTableHeader\">SHC</td><td colspan=\"1\" class=\"grdTableHeader\">Status</td><td colspan=\"1\" class=\"grdTableHeader\">Gross Weight</td><td colspan=\"1\" class=\"grdTableHeader\">ORI/DES</td><td colspan=\"1\" class=\"grdTableHeader\">Priority</td><td colspan=\"1\" class=\"grdTableHeader\">Remarks</td>" + (ICMSEnvironment == "jt" ? "<td colspan=\"1\" class=\"grdTableHeader\">Connecting Flight</td>" : "") + "<td colspan=\"1\" class=\"grdTableHeader\">Office Use</td></tr>");
                        if (ds != null && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow drDistinctULD in dtDistinctULD.Rows)
                            {
                                ...
                                if (drRpt.Length > 0)
                                {
                                    ...
                                    tbl.Append("<tr align=\"left\" class=\"grdTableRow\"><td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >" + drDistinctULD["ULDNo"] + "</td></tr>");
                                    if (drLocal.Length > 0)
                                    {
                                        int j = 1;
                                        foreach (DataRow dr in drLocal)
                                        {
                                            ...
                                            tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + j.ToString() + "</td><td colspan=\"1\" >" + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSectorAirport"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" >" + dr["Remarks"] + "</td>" + (ICMSEnvironment == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "<td colspan=\"1\"></td></tr>");
                                            j++;
                                    ...
                                    if (drTrans.Length > 0)
                                    {
                                        ...
                                        foreach (DataRow dr in drTrans)
                                        {
                                            ...
                                            tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" style=\"width:20px;\" >" + k.ToString() + "</td><td colspan=\"1\" > " + dr["AWBNo"] + "</td><td colspan=\"1\" >" + dr["RPTPIECES"] + "</td><td colspan=\"1\" >" + dr["NatureOfGoods"] + "</td>" + "</td><td colspan=\"1\" >" + dr["SPHC"] + "</td>" + "</td><td colspan=\"1\" >" + dr["AdviceStatusCode"].ToString() + "</td><td colspan=\"1\">" + dr["PlannedGrossWeight"].ToString() + "</td><td colspan=\"1\" >" + dr["AWBSectorAirport"] + "</td><td colspan=\"1\" >" + dr["Priority"] + "</td><td colspan=\"1\" ></td>" + (ICMSEnvironment == "jt" ? "<td colspan=\"1\">" + dr["ConnectingFlight"] + "</td>" : "") + "</td><td colspan=\"1\"></td></tr>");
                                            k++;
                                            //}
                                        }
                                    }
                                    tbl.Append("<tr align=\"center\"  class=\"grdTableRow\"><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\" ><b>Total</b></td><td colspan=\"1\" ><b>" + pieces.ToString() + "</b></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\"></td>&nbsp;<td colspan=\"1\" >&nbsp;</td><td colspan=\"1\"><b>" + Weight.ToString() + "</b></td><td colspan=\"1\" >&nbsp;</td><td colspan=\"1\">&nbsp;</td><td colspan=\"1\">&nbsp;</td>" + (ICMSEnvironment == "jt" ? "<td colspan=\"1\"></td>" : "") + "<td colspan=\"1\">&nbsp;</td></tr>");
                            ...
                            foreach (DataRow dr1 in dtDistinctDestinationCity.Rows)
                            {
                                ...
                                if (ds.Tables[1].Rows[0]["airlinename"].ToString().ToLower() == FC_AirlineName && dr1[0].ToString().ToLower() == FC_AllowedCity)
                                {
                                    tbl.Append("<tr style=\"font-weight: bold;\" ><td valign=\"top\" >Note:</td><td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" align=\"left\" >NOTE:DME <br/>There are no goods on board of the aircraft the import of which to the Customs Union zone prohibited or restricted such as pharmaceuticals consisting of narcotic drugs and potent agents; psychotropic & toxic substances; weapon & ammunition</td></tr>");
                        ...
                        {
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            if (ds != null && ds.Tables[1].Rows.Count > 0) { }
                            else { tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" style=\"font-size:30px;color:red\">NIL MANIFEST&nbsp;</td></tr>"); }
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                            tbl.Append("<tr><td align=\"center\" colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" >&nbsp;</td></tr>");
                        ...
                        if (IsManifestFooterForAirAsia == "true")
                        {
                            if (ds != null && ds.Tables[1].Rows.Count > 0)
                                tbl.Append("<tr  class=\"grdTableRow\"><td colspan=\"5\" style=\"border-right: none;\"><b>Prepared by : " + ds.Tables[1].Rows[0]["UserName"].ToString() + "</b></td><td colspan=\"7\" align=\"right\" style=\"border-left: none;\"><b>Page______________________ of Page _______________________________ </b></td></tr>");
                            else
                        ...
                        tbl.Append("<tr align=\"left\"  class=\"grdTableRow\"><td colspan=\"" + (ICMSEnvironment == "jt" ? "12" : "11") + "\" ><b> Remarks : </b><b>" + ds.Tables[0].Rows[0]["Remarks"] + "</b></td></tr>");
                        if ((ICMSEnvironment == "jt"))
                        {
                            tbl.Append("<tr align=\"left\"  class=\"grdTableRow\"><td colspan=\"12\" ><b> LMC Remarks : </b></td></tr>");
                        }
                        tbl.Append("</table>");
        ...
        public string GetExpectedLoadDetails(string GroupFlightSNo)
        {
            ...
            try
            {
                ...
                DataSet ds = SqlHelper.ExecuteDataset(DMLConnectionString.WebConfigConnectionString, CommandType.StoredProcedure, "sp_GetExpectedLoadDetails", Parameters);
