...
namespace CargoFlash.Cargo.DataService.Shipment
{
	...
	*/
    ...
    public interface IReservationBookingService
    {
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string CheckEmbargoParamOnOD(int DailFlightSNo, int AgentSNo, int ProductSNo, int CommoditySNo, int ItineraryPieces, string ItineraryGrossWeight, string ItineraryVolumeWeight, int PaymentType, string SPHC, int IsAWBWise, int OriginAirportSNo, int DestinationAirportSNo, string AWBGrossWeight, int AWBPieces, string AWBPrefix);

        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/CheckEmbargoAll", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string CheckEmbargoAll(Int64 POMailSNo, Int64 AWBSNo, Int64 BookingSNo, Int64 BookingRefNo, ReservationInformation ReservationInformation, List<ReservationItineraryInformation> ReservationItineraryInformation);
        ...
        string SaveChargeDeclarationsRateData(Int64 AWBSNo, Int64 BookingSNo, Int64 BookingRefNo, ReservationChargeDeclarations ReservationChargeDeclarations, int TransactionType, decimal TransactionAmount, string TransactionNo);
		...
		[OperationContract]
		[WebInvoke(Method = "POST", UriTemplate = "deleteCustomsOCIInformationTab?recid={RecordID}", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
		List<string> deleteCustomsOCIInformationTab(string recordID);
        ...
        string SaveNotifyData(Int32 AWBSNo, CustomNotifyDetails NotifyModel, CustomNominyDetails NominyModel, string ReferenceNumber, Int32 AwbReferenceBookingSNo, string HandlingInformation);
        ...
        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/GetApprovalRateInformation", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string GetApprovalRateInformation(ApprovalRateInformation SpotRate);
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        KeyValuePair<string, List<GetMarineInsuranceData>> GetInsuranceRecord(string recid, int pageNo, int pageSize, AWBSNoRequest model, string sort);



        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/createUpdateInsurance", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        List<string> createUpdateInsurance(string strData);


        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "deleteInsurance?recid={RecordID}", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        List<string> deleteInsurance(string recordID);

        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string BindInsuranceCategory(int CommoditySNo);

        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string DownloadExcel(string OriginCity, string DestinationCity, string FlightNo, string FlightDate, string AWBPrefix, string AWBNo, string LoggedInCity, string ReferenceNo);

        [OperationContract]
        [WebInvoke(UriTemplate = "DownloadData", ResponseFormat = WebMessageFormat.Json)]
        List<ReservationGridData> DownloadData(GetReservationGridData model);

        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string CheckSurpassedBCTTime(Int64 AWBSNo);

        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/createUpdateDueCarrierOtherChargeTab", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        List<string> createUpdateDueCarrierOtherChargeTab(string strData);

        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "deleteDueCarrierOtherChargeTab?recid={RecordID}", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        List<string> deleteDueCarrierOtherChargeTab(string recordID);
        ...
        string SplitShipmentAllowed(int OriginCitySNo, int DestinationCitySNo, int AccountSNo);

        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/SaveHandlingInformation", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string SaveHandlingInformation(Int32 AWBSNo, string HandlingInfo, string ReferenceNumber, Int32 AwbReferenceBookingSNo);

        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string CheckPirntTime(int AWBSNo, int IsLabel);

        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string GetPTIData(Int64 AWBSNo);

        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/SavePITDatails", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string SavePITDatails(Int64 AWBSNo, string OtherIdentity, int Pieces, decimal GrossWeight, string EOC);
        [OperationContract]
        [WebInvoke(Method = "POST", BodyStyle = WebMessageBodyStyle.WrappedRequest, RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        // Changes by Vipin Kumar
        //string ReservationBookingGetAWBPrintData(string AwbNo);
        string ReservationBookingGetPTIPrintData(int? AwbNo);
		...
		[OperationContract]
		[WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
		string GetTermsandcondtion(Int64 AWBOriginSNo, Int64 AWBDestinationSNo);

        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string GetAirlineParameterValue(string Airlinesno, string Airlineparameter);

        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string CheckTaxId(string TaxId, string UserType, Int32 CountrySno, Int32 CustomerSno);
        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/SaveBillingAddressData", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string SaveBillingAddressData(Int32 AWBSNo, CustomBillingDetails BillingAddressModel, string ReferenceNumber, Int32 AwbReferenceBookingSNo);
        [OperationContract]
        [WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest, ResponseFormat = WebMessageFormat.Json, RequestFormat = WebMessageFormat.Json)]
        string BillingDetails(Int64 BookingRefNo, Int32 AWBSNo);
